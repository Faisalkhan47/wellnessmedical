...
export default function Photorejuvenation() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Photorejuvenation</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Photorejuvenation sometimes referred to as a photo facial, is a fast, non-invasive skin treatment that employs high-intensity pulses of broadband light to effectively treat skin discoloration and photoaging at the cellular level. Photorejuvenation uses light and laser therapy to rejuvenate the skin and give it an overall smoother and younger appearance. There are two types of broadband light used in photorejuvenation procedures: IPL and LED. Both types penetrate deep within the skin to stimulate dormant skin cells while encouraging new collagen and elastin to develop.
                    </p>
                </Stack>
