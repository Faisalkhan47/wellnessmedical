...
export default function EisenmengersSyndromeTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Eisenmenger's Syndrome Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Eisenmenger syndrome is a long-term complication of an unrepaired heart defect that someone was born with. The congenital heart defects related to Eisenmenger syndrome cause blood to circulate in your heart and lungs. At the point when blood doesn't stream regularly, the blood vessels in your lungs become stiff and narrow, expanding the pressing factor in your lungs' arteries. This totally destroys the blood vessels in your lungs. In the event that the Eisenmenger syndrome condition develops then, it requires cautious clinical observing. Drugs can further develop side effects and prognoses.
                    </p>
                </Stack>
