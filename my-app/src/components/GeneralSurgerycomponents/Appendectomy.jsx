...
export default function Appendectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Appendectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An appendectomy is the surgical removal of the appendix. It’s a common emergency surgical operation that’s executed to deal with appendicitis, an inflammatory circumstance of the appendix. It’s important to search for a remedy right away in case you’re having signs of appendicitis. While the circumstance goes untreated, the appendix can burst (perforated appendix) and release microorganisms and other harmful substances into the abdominal hollow space. This can be existence-threatening and will cause an extended health facility stay. Appendectomy is the usual remedy for appendicitis. It’s critical to take away the appendix right away, earlier than the appendix can rupture. As soon as an appendectomy is executed, most people recover quickly and without complications.
                    </p>
                </Stack>
