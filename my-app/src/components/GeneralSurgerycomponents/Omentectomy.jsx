...
export default function Omentectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Omentectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An omentectomy is a surgical procedure designed to dispose of the omentum, which is a skinny fold of stomach tissue that encases the belly, big gut, and different abdominal organs. This fatty lining consists of lymph nodes, lymph vessels, nerves, and blood vessels. in the course of ovarian most cancers remedy, and omentectomy may be carried out along with a hysterectomy to get rid of the uterus.
                    </p>
                </Stack>
