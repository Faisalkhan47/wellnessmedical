...
export default function UmbilicalHerniaRepair() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Umbilical Hernia Repair</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An umbilical hernia occurs when part of your gut bulges through the opening on your stomach muscle groups near your belly button (navel). Umbilical hernias are common and generally harmless. Umbilical hernias are most common in infants, however, they could have an effect on adults as well. In a toddler, an umbilical hernia can be especially evident when the little one cries, causing the belly button to protrude. That is a conventional signal of an umbilical hernia.
                    </p>
                </Stack>
