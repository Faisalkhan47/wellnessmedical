...
export default function Gastrectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Gastrectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Gastrectomy is the removal of part or all of the stomach. There are three predominant types of gastrectomy: A partial gastrectomy is the removal of a part of the stomach. The decrease half is usually removed. A complete gastrectomy is the removal of the whole belly. A sleeve gastrectomy is the removal of the left facet of the belly. this is generally accomplished as part of a surgical procedure for weight loss. Disposing of your stomach doesn’t take away your ability to digest beverages and foods. However, you can want to make numerous way of life changes after the method.
                    </p>
                </Stack>
