            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Mastectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Mastectomy is a surgical treatment to remove all breast tissue from a breast as a way to treat or save breast cancer. For those with early-stage breast cancer, a mastectomy may be one remedy alternative. Breast-maintaining surgery (lumpectomy), in which best the tumor is removed from the breast, can be another alternative. More modern mastectomy strategies can maintain breast skin and permit for a greater herbal breast appearance following the method. This is also known as skin-sparing mastectomy. Surgery to repair form on your breast referred to as breast reconstruction can be accomplished in the equal time as your mastectomy or all through a second operation at a later date.
                    </p>
                </Stack>
