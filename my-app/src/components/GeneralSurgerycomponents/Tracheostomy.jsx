            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Tracheostomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A tracheostomy is a gap created at the front of the neck so a tube can be inserted into the windpipe (trachea) to help you breathe. If necessary, the tube may be related to oxygen delivery and a respiratory gadget called a ventilator. The tube also can be used to remove any fluid that is built up in the throat and windpipe.
                    </p>
                </Stack>
