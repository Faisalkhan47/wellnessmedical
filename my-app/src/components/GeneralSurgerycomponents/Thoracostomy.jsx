...
export default function Thoracostomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Thoracostomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A thoracotomy is a surgical procedure wherein a reduction is made among the ribs to see and attain the lungs or different organs in the chest or thorax. usually, a thoracotomy is executed at the right or left side of the chest. An incision on the front of the chest through the breast bone can also be used but is uncommon. A thoracotomy is carried out for diagnosis or treatment of disease and permits medical doctors to visualize, biopsy, or do away with a tissue as wanted.
                    </p>
                </Stack>
