...
export default function StereotacticRadiosurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Stereotactic Radiosurgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Stereotactic radiosurgery (SRS) uses many exactly focused radiation beams to treat tumors and different issues within the mind, neck, lungs, liver, backbone, and different parts of the body. It isn't always a surgical operation within the traditional sense because there's no incision. As an alternative, stereotactic radiosurgery makes use of 3-D imaging to goal excessive doses of radiation to the affected location with minimal effect on the surrounding wholesome tissue. Like other varieties of radiation, stereotactic radiosurgery works with the aid of unfavorable the DNA of the centered cells. The affected cells then lose the ability to breed, which causes tumors to shrink
                    </p>
                </Stack>
