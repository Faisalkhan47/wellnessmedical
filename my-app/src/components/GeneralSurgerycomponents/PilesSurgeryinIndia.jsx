...
export default function PilesSurgeryinIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Piles Surgery in India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Hemorrhoids, sometimes referred to as piles, are enlarged veins in the rectum or anus. They are a prevalent ailment that many people experience at some point in their life and can manifest either inside or publicly. Numerous things, including straining during bowel motions, persistent constipation or diarrhea, pregnancy, obesity, a sedentary lifestyle, and extended sitting or standing, can result in hemorrhoids.
                    </p>
                </Stack>
