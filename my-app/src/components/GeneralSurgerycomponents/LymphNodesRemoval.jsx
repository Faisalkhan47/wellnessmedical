...
export default function LymphNodesRemoval() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Lymph Nodes Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Lymph node removal is a surgical operation to take out one or more of your lymph nodes. Your physician may additionally endorse you have got this manner if you’ve been diagnosed with cancers. There are two fundamental reasons for doing away with lymph nodes. When you have cancer, one or more lymph nodes may be eliminated to test whether or not it has developed. Knowing this facilitates your doctor planning a pleasant treatment for you. If assessments have proven that cancer has reached your lymph nodes, you may have them taken out to get rid of cancer. This enables you to lessen the danger of your cancers coming back.
                    </p>
                </Stack>
