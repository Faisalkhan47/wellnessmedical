...
export default function Laparotomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Laparotomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Laparotomy is a surgical incision into the abdominal cavity. A laparotomy is performed to examine the abdominal organs and aid diagnosis of any problems. Possible complications include infection and the formation of scar tissue within the abdominal cavity. A common reason for a laparotomy is to investigate abdominal pain, but the procedure may be required for a broad range of indications. The abdominal organs include the digestive tract (such as the stomach, liver, and intestines) and the organs of excretion (such as the kidneys and bladder). Your surgeon may need to operate to find out the exact cause of your complaint. For example, they may need to pinpoint the cause of internal bleeding in the digestive tract or find out where your bowel may be perforated (burst), before treatment can commence.
                    </p>
                </Stack>
