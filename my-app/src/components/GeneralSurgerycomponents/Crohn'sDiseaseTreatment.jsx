...
export default function CrohnsDiseaseTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Nephrectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Nephrectomy is a surgical procedure to dispose of all or part of a kidney: Radical (whole) nephrectomy. During a thorough nephrectomy, the urologic general practitioner eliminates the complete kidney and often a few extra systems, including a part of the tube that connects the kidney to the bladder (ureter), or other adjacent structures consisting of the adrenal gland or lymph nodes. Partial nephrectomy. In a partial nephrectomy, also referred to as a kidney-sparing (nephron-sparing) surgical operation, the health care provider removes diseased tissue from a kidney and leaves wholesome tissue in place. Most usually a nephrectomy is finished to treat kidney cancer or to eliminate a noncancerous (benign) tumor. In some instances, a nephrectomy is finished to cope with a diseased or significantly damaged kidney.
                    </p>
                </Stack>
