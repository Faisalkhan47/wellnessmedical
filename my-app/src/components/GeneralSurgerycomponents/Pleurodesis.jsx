...
export default function Pleurodesis() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Pleurodesis</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Pleurodesis is a process that is sometimes executed to alleviate pleural effusions (construct-up of fluid between the membranes surrounding the lungs) that recur because of lung cancer and other situations. Pleurodesis is an intervention that is designed to get the two layers of the lung's lining (the pleura) to paste together. This obliterates the space among the layers (the pleural cavity) in order that fluid (water, blood, or pus) can now not build up between the layers.
                    </p>
                </Stack>
