...
export default function AnalFistulaSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Anal Fistula Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An anal fistula is a small tunnel that connects an infected gland inside the anus to an opening on the skin around the anus. Symptoms include pain and swelling around the anus. Diagnosis and treatment are discussed. An anal fistula is a small tunnel that connects an abscess, an infected cavity in the anus, to an opening on the skin around the anus. The anus is the external opening through which feces are expelled from the body. Just inside the anus are a number of small glands that make mucus. Occasionally, these glands get clogged and can become infected, leading to an abscess. About half of these abscesses may develop into a fistula.
                    </p>
                </Stack>
