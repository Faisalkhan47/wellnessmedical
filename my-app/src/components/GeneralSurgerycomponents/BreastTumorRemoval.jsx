...
export default function BreastTumorRemoval() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Breast Tumor Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Lumpectomy is a surgical treatment to take away cancer or other abnormal tissue from your breast. For the duration of a lumpectomy process, the health practitioner eliminates cancer or other ordinary tissue and a small quantity of the healthy tissue that surrounds it. This ensures that every one of the abnormal tissue is removed Lumpectomy is likewise referred to as breast-conserving surgical operation or extensive nearby excision due to the fact only a part of the breast is eliminated. A lumpectomy is a remedy option for early-level breast cancer. Now and again lumpectomy is used to rule out a cancer diagnosis. When a lumpectomy surgical procedure is finished to do away with cancer, it normally is observed through radiation remedy to the breast to reduce the probabilities of most cancers returning.
                    </p>
                </Stack>
