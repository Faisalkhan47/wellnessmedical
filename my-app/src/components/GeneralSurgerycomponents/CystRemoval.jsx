...
export default function CystRemoval() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Cyst Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Cystic fibrosis (CF) is an inherited disorder that causes severe harm to the lungs, digestive system, and different organs inside the body. Cystic fibrosis affects the cells that produce mucus, sweat, and digestive juices. These secreted fluids are commonly thin and slippery. But in people with CF, a faulty gene causes the secretions to become sticky and thick. Rather than performing as lubricants, the secretions plug up tubes, ducts, and passageways, particularly in the lungs and pancreas.
                    </p>
                </Stack>
