...
export default function LymphNodeBiopsy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Lymph Node Biopsy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A lymph node biopsy is the elimination of lymphatic tissue for examination under a microscope. The lymph nodes are small glands that make white blood cells (lymphocytes), which fight contamination. Lymph nodes may additionally trap the germs which are inflicting an infection. Most cancers can unfold to lymph nodes
                    </p>
                </Stack>
