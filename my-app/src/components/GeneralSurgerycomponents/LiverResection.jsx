...
export default function LiverResection() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Liver Resection</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Liver resection is the surgical removal of a part of the liver. This operation is normally carried out to put off various types of liver tumors which might be positioned within the resected part of the liver. The intention of liver resection is to completely cast off the tumor and the right surrounding liver tissue without leaving any tumor behind.
                    </p>
                </Stack>
