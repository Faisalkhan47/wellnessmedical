            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Lipoma Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A lipoma is around or oval-formed lump of tissue that grows just beneath the skin. It’s a product of fat, actions easily when you contact it, and doesn’t normally purpose pain. Lipomas can seem everywhere in the body, but they’re most common at the back, trunk (torso), palms, shoulders, and neck. Lipomas are benign gentle tissue tumors. They develop slowly and are not cancerous. most lipomas don’t want treatment. If a lipoma is bothering you, your healthcare issuer can take away it with an outpatient system.
                    </p>
                </Stack>
