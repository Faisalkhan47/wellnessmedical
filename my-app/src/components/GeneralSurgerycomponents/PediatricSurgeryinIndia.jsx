...
export default function PediatricSurgeryinIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Pediatric surgery in India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Infants, kids, and teenagers are the primary patients of pediatric surgery, a specialist area of surgery. It entails identifying surgical issues in young patients, often up to the age of 18, and managing them before to, during, and after surgery. The specific anatomical, physiological, and emotional characteristics of pediatric patients are handled by pediatric surgeons who have received specialized training. For children who need surgical interventions, they collaborate closely with physicians, pediatric anesthesiologists, and other medical specialists.
                    </p>
                </Stack>
