            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Splenectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Splenectomy is a surgery to dispose of your spleen. The spleen is an organ that sits below your rib cage at the upper left facet of your stomach. It helps fight contamination and filters unneeded material, consisting of vintage or damaged blood cells, out of your blood. The most not unusual reason for splenectomy is to treat a ruptured spleen, that's frequently resulting from a belly injury. Splenectomy can be used to deal with different situations, along with an enlarged spleen that is causing discomfort (splenomegaly), a few blood disorders, sure cancers, contamination, and noncancerous cysts or tumors. Splenectomy is maximum usually executed by the use of a tiny video digicam and unique surgical equipment (laparoscopic splenectomy). With this form of surgery, you will be able to go away from the sanatorium the identical day and recover absolutely in weeks.
                    </p>
                </Stack>
