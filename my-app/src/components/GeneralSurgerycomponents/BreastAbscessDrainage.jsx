...
export default function BreastAbscessDrainage() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Breast Abscess Drainage</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A breast abscess is a painful, pus-crammed lump below the over-the-counter skin of over breast. Breast abscesses can be a complication source of mastitis, that's an infection of the breast. Those lumps are more common amongst ladies who are lactating
                    </p>
                </Stack>
