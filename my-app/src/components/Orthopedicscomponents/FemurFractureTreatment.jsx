...
export default function FemurFractureTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Femur Fracture Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The femur, often known as the thigh bone, is the biggest and most powerful bone in your body. It takes a long time for the femur to mend when it breaks. Because the femur is one of the key bones required to walk, breaking it can make routine chores much more difficult.
                    </p>
                </Stack>
