...
export default function OsteomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Osteoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An Osteoma is a benign bone tumor that usually forms on the skull. On the basis of where they are developing, they may cause issues like a headache or infection of the sinus. Osteomas tend to form mainly on the skull, however, they’re also often found on the long bones of your body like the shin bone or femur.
                    </p>
                </Stack>
