...
export default function JumpersKneeTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Jumper's Knee Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Patellar inflammation is an injury to the connective tissue connecting your kneecap (patella) to your leg bone. The jumper’s knee connective tissue works with the muscles at the front of your thigh to increase your knee so you'll kick, run and jump. Also called jumper's knee, Patellar inflammation is commonest in athletes whose sports involve frequent jumping like basketball and volleyball. However, even folks that do not participate in jumping sports will get jumpers’ knee inflammation. For most folks, treatment of jumpers’ knee inflammation begins with physiotherapy to stretch and strengthen the muscles around the knee.
                    </p>
                </Stack>
