...
export default function CongenitalHipDislocationTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Congenital Hip Dislocation Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Congenital hip dislocation (CHD) occurs when a child is born with an unstable hip. It’s caused by abnormal formation of the hip joint during the early stages of fetal development. Another name for this condition is “developmental dysplasia of the hip.” This instability worsens as your child grows. The ball-and-socket joint in the child’s hip may sometimes dislocate. This means that the ball will slip out of the socket with movement. The joint may sometimes completely dislocate. According to American Family Physicians, one out of every 1,000 infants is born with a dislocated hip.
                    </p>
                </Stack>
