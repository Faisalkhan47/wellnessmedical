...
export default function RotatorCuffSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Rotator Cuff Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Surgery to repair a torn complex body part or a rotator cuff surgery most frequently involves re-attaching the ligament to the pinnacle of the arm bone (upper arm bone). However, a partial tear may have solely a trimming or smoothing procedure known as a surgical operation. A whole tear is repaired by sewing the ligament back to its original website on the arm bone.
                    </p>
                </Stack>
