...
export default function PediatricOrthopedicsTreatmentinIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Pediatric Orthopedics Treatment in India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Musculoskeletal issues in children from infancy through puberty are recognized, treated, and managed in the discipline of pediatric orthopedics. This page focuses on the treatment of kids who have problems with their bones, joints, muscles, ligam.
                    </p>
                </Stack>
