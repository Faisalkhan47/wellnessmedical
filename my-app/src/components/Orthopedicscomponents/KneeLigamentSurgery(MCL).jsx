...
export default function KneeLigamentSurgeryMCL() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Ganglion Cyst Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A ganglion cyst is a fluid-filled non-cancerous lump that usually develops in the wrist or hand. But some occur in the ankles or feet. When a ganglion cyst presses on a nerve it can be painful. And depending on its location, a ganglion cyst may restrict movement. Some cysts do not need treatment, but others must be surgically removed. During a ganglion cyst removal, a doctor removes the cyst capsule or stalk to completely remove the cyst. Even with surgery, a ganglion cyst may reoccur.
                    </p>
                </Stack>
