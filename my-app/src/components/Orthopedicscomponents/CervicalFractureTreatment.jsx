...
export default function CervicalFractureTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Cervical Fracture Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A broken neck is defined as a fracture or breaks in one of the cervical vertebrae. Cervical fractures are most commonly caused by high-energy trauma, such as car accidents or falls. Ground-level falls, such as falling off a chair, can result in a neck fracture in the elderly. Athletes are also vulnerable.
                    </p>
                </Stack>
