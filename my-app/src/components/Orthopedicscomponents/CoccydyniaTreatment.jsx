...
export default function CoccydyniaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Coccydynia Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Inflammation of the coccydynia (coccyx or bony space placed deep between the buttocks on top of the anus) is remarked as coccydynia. Coccydynia is related to pain and tenderness at the tip of the coccydynia between the buttocks. Sitting typically worsens coccydynia pain.
                    </p>
                </Stack>
