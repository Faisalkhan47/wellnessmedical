...
export default function UlnarNerveDecompression() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Ulnar Nerve Decompression</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Ulnar nerve decompression is a surgical procedure designed to explore the region around the elbow through which the ulnar nerve passes. The ulnar nerve is responsible for the “funny bone” phenomenon when you hit your elbow.
                    </p>
                </Stack>
