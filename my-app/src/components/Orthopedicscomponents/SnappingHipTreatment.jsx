...
export default function SnappingHipTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Snapping Hip Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Hip impingement happens once the ball and socket of the cotyloid joint do not match along properly. The restricted motion damages animal tissue and may cause pain and inflammatory disease in young adults. In some cases, the ball is just too ill-shapen to suit properly into the socket. Sometimes, the outside fringe of the socket extends to the purpose that it covers an excessive amount of the ball. Hip impingement can also be caused by a mixture of those 2 issues. Most people with hip impingement expertise pain within the groin space throughout or once flexing the hip, as once running, jumping, or sitting for an extended time. You will even have a problem flexing your hip on the far side at a right angle. Surgery is also needed to stop any hip injury.
                    </p>
                </Stack>
