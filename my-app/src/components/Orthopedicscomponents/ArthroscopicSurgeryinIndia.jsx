...
export default function ArthroscopicSurgeryinIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Arthroscopic Surgery in India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Through the use of an arthroscope, medical professionals can view, identify, and treat issues within a joint. It entails employing an arthroscope, a compact, flexible equipment with a light source and a camera. In most cases, a buttonhole-sized incision is used to implant the arthroscope into the joint.
                    </p>
                </Stack>
