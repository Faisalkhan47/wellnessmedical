...
export default function KneecapStabilization() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Kneecap Stabilization</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Knee pain may be a common criticism that affects folks of all ages. Knee pain is also the result of an injury, like a damaged ligament or torn animal tissue. Medical conditions — as well as inflammatory disease, arthritis, and infections, can also cause knee pain. Many types of minor knee pain respond well to self-care measures. Physiotherapy and knee braces can also relieve pain. In some cases, however, your knee could need surgical repair.
                    </p>
                </Stack>
