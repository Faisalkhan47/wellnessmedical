...
export default function ChondromaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Chondroma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Chondromas are very rare, benign tumors made of cartilage. They usually grow slowly and develop in the sinuses and the bones of the skull. They can also show up in the small bones of the hands, feet, upper arms, thighs, and ribs. If they form in the marrow cavity of bones, they are called enchondromas. If they form on the bone’s surface, they’re called periosteal chondromas.
                    </p>
                </Stack>
