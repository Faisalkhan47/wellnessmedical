...
export default function DislocatedHipTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Dislocated Hip Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A traumatic hip dislocation occurs when the head of the femur (femur) is pushed out of the socket of the hipbone (pelvis). Dislocation of the hip usually requires a great deal of force. Car accidents and falls from height are common causes, and as a result, other injuries such as fractures often accompany dislocations. Hip dislocation is a serious medical emergency. . Immediate treatment is required.
                    </p>
                </Stack>
