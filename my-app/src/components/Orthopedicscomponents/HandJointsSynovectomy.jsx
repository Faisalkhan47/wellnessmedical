...
export default function HandJointsSynovectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hand Joints Synovectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Arthritis is inflammation of the joints. There are many types. The most common type of arthritis is osteoarthritis, or degenerative arthritis. A synovectomy is the removal of the synovial lining. Excellent results with low or no recurrences. This is because the local environment changes from an enclosed space to a healthy fat decompression area. However, joint synovectomy is the only procedure available to prolong function (and reduce pain) in the patient's own joint for 'X' periods, and this is dependent on the course of the systemic disease.
                    </p>
                </Stack>
