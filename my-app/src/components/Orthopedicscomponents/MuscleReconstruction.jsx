...
export default function MuscleReconstruction() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Muscle Reconstruction</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The abdomen is comprised of various layers of tissue, fat, and muscle that protect the organs within the abdominal cavity including the stomach, the kidneys, and the small intestine. The muscles of the abdominal wall stabilize the torso and aid in vital functions such as respiration and urination. Sometimes, the abdominal wall can become weakened due to the formation of complex hernias and the return of a previously repaired hernia. In these cases, the tissues of the abdominal wall need to be restructured. Abdominal wall reconstruction is a surgical procedure used to restore the structural and functional integrity of the abdominal muscles.
                    </p>
                </Stack>
