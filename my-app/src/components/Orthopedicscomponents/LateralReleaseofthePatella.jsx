...
export default function LateralReleaseofthePatella() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Lateral Release of the Patella</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Lateral unleash is a minimally invasive surgery accustomed to correcting excessive sesamoid bone tilt. It involves cutting through a good retinaculum so the kneecap will slip properly into its groove, restoring its traditional alignment.
                    </p>
                </Stack>
