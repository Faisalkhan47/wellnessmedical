...
export default function MeniscusSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Meniscus Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Meniscus surgery is the surgical removal of all or a part of a torn meniscus. A meniscus tear may be a common knee injury. Surgeons perform meniscectomies with the help of surgical choices that support the meniscus's ability to heal yet as your age, health, and activity level.
                    </p>
                </Stack>
