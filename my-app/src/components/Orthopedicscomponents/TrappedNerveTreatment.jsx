...
export default function TrappedNerveTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Trapped Nerve Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A traped nerve is a condition in which there is too much pressure on the nerve from surrounding tissues such as muscle, cartilage, tendons, and bone. It disrupts nerve function, causing pain and tingling along with numbness and weakness. With rest and other conservative treatments, most people recover from nerve compression within days or weeks. Surgery may be needed to relieve the pain of a compressed nerve.
                    </p>
                </Stack>
