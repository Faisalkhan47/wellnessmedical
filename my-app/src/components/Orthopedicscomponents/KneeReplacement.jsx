            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Knee Replacement</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Knee replacement surgery otherwise called knee arthroplasty can assist with relieve pain and reestablish work in seriously unhealthy knee joints. The technique includes removing harmed bone and cartilage from your thighbone, shinbone, and kneecap and replacing it with an artificial joint (prosthesis) made of metal alloys, high-grade plastics, and polymers.
                    </p>
                </Stack>
