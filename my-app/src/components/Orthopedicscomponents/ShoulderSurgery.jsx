...
export default function ShoulderSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Shoulder Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Shoulder surgery is used to heal a joint that has been injured, deteriorated, or infected. It's a therapy for a number of disorders and ailments that affect the shoulder joint. Rotator cuff tears, shoulder dislocations, and shoulder separations are all prevalent. Shoulder surgery may be able to help an injured shoulder joint regain pain-free range of motion and complete function.
                    </p>
                </Stack>
