...
export default function BunionSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Bunion Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Bunion surgery is completed to cut back the pain and properly set the deformity caused by puffiness. A puffiness (hallux valgus) is an enlargement of the bone or tissue around a joint at the bottom of the large toe or the base of the short toe.
                    </p>
                </Stack>
