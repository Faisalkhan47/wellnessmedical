...
export default function ShoulderCapsularRelease() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Shoulder Capsular Release</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A shoulder release is a surgical procedure performed to release a stiff and stiff shoulder capsule, a condition called frozen shoulder or adhesive capsulitis. This procedure is usually performed arthroscopically through a keyhole-sized incision.
                    </p>
                </Stack>
