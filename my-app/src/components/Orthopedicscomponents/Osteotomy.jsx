...
export default function Osteotomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    An osteotomy is any surgery that cuts and reshapes your bones. You may need this type of procedure to repair a damaged joint. It’s also used to shorten or lengthen a deformed bone that doesn’t line up with a joint as it should. You don’t need to be very sick or old to have an osteotomy. Many young, healthy people have had this surgery as a way to postpone hip or knee replacement for many years.
                    </p>
                </Stack>
