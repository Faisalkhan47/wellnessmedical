...
export default function MeniscusTransplant() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Meniscus Transplant</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A cartilage transplant may be surgery to exchange broken or missing cartilage. The cartilage may be a C-shaped piece of animal tissue that cushions and protects the knee. Recovery time is sometimes a few months.
                    </p>
                </Stack>
