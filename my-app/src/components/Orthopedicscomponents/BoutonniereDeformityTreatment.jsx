...
export default function BoutonniereDeformityTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Pes Anserine Bursitis Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A bursa is a thin sac found between bones and soft tissues in and around joints. It contains a small amount of fluid. Its function is to provide cushioning and protection to the joint. It prevents chaffing of the joints. Inflammation and irritation in the bursa are known as bursitis. The pes anserine bursa is located in the middle of the knee joint. It lies between the shinbone (tibia) and 3 tendons that attach the hamstring muscles to the shinbone. The swelling of this bursa is called pes anserine bursitis.
                    </p>
                </Stack>
