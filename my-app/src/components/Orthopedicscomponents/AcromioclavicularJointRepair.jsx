...
export default function AcromioclavicularJointRepair() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Acromioclavicular Joint Repair</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Surgery for an AC joint injury aims to alleviate pain and restore operation by removing the broken finish of the collarbone bone. The additional severe sub-types of shoulder separation typically need surgery for the powerful displacement of the collarbone inflicting pain and pressure on the tight cowl muscle.
                    </p>
                </Stack>
