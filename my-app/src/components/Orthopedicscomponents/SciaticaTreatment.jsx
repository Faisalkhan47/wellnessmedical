...
export default function SciaticaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Sciatica Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Irritation, inflammation, pinching, or compression of a nerve in the lower back causes sciatica pain. A herniated or slipped disk puts pressure on the nerve root, which is the most prevalent cause. With time and self-care procedures, most patients with sciatica get well on their own.
                    </p>
                </Stack>
