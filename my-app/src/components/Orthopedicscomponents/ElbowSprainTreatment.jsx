...
export default function ElbowSprainTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Elbow Sprain Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A sprain is an injury that is caused around a joint to the ligaments. Ligaments are junctions between two bones. If you have sprained an elbow, it means you have pulled or torn one or more elements of the joint in your elbow.
                    </p>
                </Stack>
