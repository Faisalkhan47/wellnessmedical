...
export default function LittleLeagueElbowTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Little League Elbow Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Little league elbow is a common problem among adolescent baseball players. It is an injury to the growth plate's inner part of the elbow. It occurs as a result of repetitive throwing motions. The motions create stress or overload injury to the medial part of your elbow. At the time of throwing, a vast amount of tension is put on the inner elbow structures that can cause injury to your growth plate. If this ailment is left untreated, it can become severe, causing ligaments and tendon tears. In addition, tearing may cause tiny bone fragments to break off and travel to other areas of the elbow joint, disrupting normal bone growth, and resulting in deformity. If you’re suffering from this, you may report a gradual increase in medial elbow pain and stiffness. This is more common while throwing. As this condition will increase, you will often experience a decrease in throwing velocity and its effectiveness.
                    </p>
                </Stack>
