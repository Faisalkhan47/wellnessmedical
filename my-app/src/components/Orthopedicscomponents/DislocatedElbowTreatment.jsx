...
export default function DislocatedElbowTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Dislocated Elbow Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A dislocated elbow occurs when the bones that make up the joint are forced out of arrangement— typically when you dock on an outstretched hand during a recession. The elbow is the second most commonly dislocated joint after the shoulder in adults. It is also the most commonly dislocated joint in children. Toddlers may encounter a dislocated elbow, sometimes known as a nursemaid's elbow if they are lifted or swung by their forearms.
                    </p>
                </Stack>
