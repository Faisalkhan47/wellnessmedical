...
export default function PagetsDiseaseTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Paget's Disease Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    It is a disease of bone that conflicts with your body's normal recycling method, in which new bone tissue slowly replaces old bone tissue. Over time, bones can become fragile and lose shape. The pelvis, skull, spine, and legs are most commonly affected. The risk of Paget's disease of bone grows with age and if family affiliates have the disorder. However, for reasons unknown to doctors, the disease has become less prevalent over the past numerous years and is less critical when it does develop.
                    </p>
                </Stack>
