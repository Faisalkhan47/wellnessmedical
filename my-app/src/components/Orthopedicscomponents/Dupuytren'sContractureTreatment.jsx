...
export default function DupuytrensContractureTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Dupuytren's Contracture Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Dupuytren's muscle contraction (also known as Dupuytren's disease) is an abnormal thickening of the skin within the palm of your hand at the bottom of your fingers. This thickened space could turn out to be a tough lump or thick band. Over time, it will cause one or many fingers to twist (contract) or pull sideways or in toward your palm. The ring and tiny fingers are most typically affected. In several cases, it affects each hand. Rarely, feet may additionally be involved.
                    </p>
                </Stack>
