...
export default function JointReplacementSurgeryInIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Joint Replacement Surgery In India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Joint replacement surgery or arthroplasty is an orthopedic surgical procedure where an arthritic or dysfunctional joint surface is replaced with an orthopedic prosthesis. Joint replacement is considered a treatment when less-invasive therapies do not alleviate severe joint pain or dysfunction. The artificial joint (prosthesis) can be metal, ceramic, or heavy-duty plastic—the new joint looks like the natural joint and moves similarly. The prosthesis is designed to replicate the movement of a typical, healthy joint. Joint replacement surgery is the last option, considered when there is no relief from pain from less invasive therapies like medication or physical therapy. Surgeons can replace joints in any part of your body, but the most common arthroplasty types are hip and knee replacement surgeries. The success rate of joint replacement in India is between 90-95%.
                    </p>
                </Stack>
