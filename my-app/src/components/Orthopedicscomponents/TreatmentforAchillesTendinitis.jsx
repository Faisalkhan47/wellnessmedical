...
export default function TreatmentforAchillesTendinitis() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Treatment for Achilles Tendinitis</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Achilles tendonitis is an injury that affects the back of your lower leg or calf. It mainly occurs in runners or people playing recreational sports. The Achilles tendon is a strong fibrous cord that connects the muscles in the back of your calf to your heel bone. Although the Achilles tendon can withstand great stresses from running and jumping, it is vulnerable to injury. If you overstretch your Achilles tendon, it can tear (itis) completely or just partially. If you have Achilles tendonitis, you might hear a pop, followed by an immediate sharp pain in the back of your ankle and lower leg that is likely to affect your ability to walk properly. Surgery is often performed to repair the itis. For many people, however, nonsurgical treatment works just as well.
                    </p>
                </Stack>
