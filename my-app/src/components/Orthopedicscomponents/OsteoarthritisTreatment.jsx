...
export default function OsteoarthritisTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Osteoarthritis Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Osteoarthritis is the most typical style of inflammatory disease, touching various individuals worldwide. It happens once the protecting animal tissue that cushions the ends of the bones wears down over time.
                    </p>
                </Stack>
