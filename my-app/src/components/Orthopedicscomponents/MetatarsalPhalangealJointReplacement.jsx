...
export default function MetatarsalPhalangealJointReplacement() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Metatarsal Phalangeal Joint Replacement</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The MTP joint replacement is performed to treat arthritis of the big toe. During this procedure, the bone on either side of the joint is partially removed and replaced with plastic, metal, or a combination of both. The MTP joint replacement can retain motion and lessen pain. This treatment is not as widely discussed as compared with the replacement of joints of the knee, elbow, or hip. Toe replacement can provide desperately needed relief to patients with severe kind of osteoarthritis of the first metatarsophalangeal joint. Typically prescribed to people dealing with rheumatoid arthritis or osteoarthritis.
                    </p>
                </Stack>
