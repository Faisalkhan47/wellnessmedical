...
export default function KneeSprainTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Knee Sprain Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A knee sprain refers to torn or overstretched ligaments, the tissues that hold bones along. If you've got a sprained knee, the structures among the joints that connect the thigh bone to the shinbone are skinned. A knee sprain is painful and may produce alternative issues over time, as well as an inflammatory disease.
                    </p>
                </Stack>
