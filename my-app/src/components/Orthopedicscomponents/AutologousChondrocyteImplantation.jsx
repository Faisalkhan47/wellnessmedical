...
export default function AutologousChondrocyteImplantation() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Autologous Chondrocyte Implantation</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Autologous chondrocyte implantation (ACI) is a new, advanced procedure used to treat complete unstable stiffness (down to the bones) and articular cartilage deformity in the knee. Approved by the Food and Drug Administration for cartilage defects found at the end of the female bone (thigh). ACI is also designed for paralysis of the patella (knee cap) over other body parts. Autologous chondrocyte implantation is a two-stage operation.
                    </p>
                </Stack>
