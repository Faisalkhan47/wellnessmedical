...
export default function ClubfootTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Clubfoot Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Club foot (also called talipes) is where a baby is born with a foot or feet that turn in and under. Early treatment should correct it. Club foot happens because the Achilles tendon (the large tendon at the back of the ankle) is too short. Club foot can affect 1 or both feet. It's not painful for babies, but it can become painful and make it difficult to walk if it's not treated. Clubfoot can be mild or severe. About half of children with clubfoot have it on both feet. If your child has clubfoot, it will make it harder to walk normally, so doctors generally recommend treating it soon after birth.
                    </p>
                </Stack>
