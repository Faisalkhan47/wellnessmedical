...
export default function RicketsTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Rickets Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Rickets is caused by a calcium and vitamin D deficiency, it's usually treated by increasing an intake of calcium and vitamin D.
                    </p>
                </Stack>
