...
export default function Trochleoplasty() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Trochleoplasty is a surgical procedure that creates a groove in the trochlea to prevent recurrent patella dislocations, and the associated pain and disability. The procedure will be performed under a general anesthetic. A surgical cut, known as an incision, of about 10cm in length will be made in the front of your knee to expose your knee joint. A thin flap of the cartilage in your knee joint will be lifted away to expose the bone beneath it. This area of bone will then be reshaped to create a new groove. The flap of cartilage will then be laid back down. The cartilage is usually malleable enough that it conforms to the shape of the new groove that was created. The flap will then be fixed in place with some dissolvable suture tape. The wound is then stitched up.
                    </p>
                </Stack>
