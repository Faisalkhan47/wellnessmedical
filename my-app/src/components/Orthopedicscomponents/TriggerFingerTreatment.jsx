...
export default function TriggerFingerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Trigger Finger Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A trigger finger is an ailment in which one of your fingers gets stuck in a bent position. Your finger may bend or straighten with a snap like a trigger being pulled and released. Trigger finger is also known as stenosing tenosynovitis. It occurs when inflammation narrows the space within the sheath that surrounds the tendon in the affected finger. If the trigger finger is severe, your finger may become locked in a bent position. People whose work or hobbies require repetitive gripping actions are at higher risk of developing trigger fingers. The condition is also more common in women and anyone with diabetes. Treatment of trigger finger varies depending on the severity.
                    </p>
                </Stack>
