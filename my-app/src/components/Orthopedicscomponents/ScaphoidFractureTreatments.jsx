...
export default function ScaphoidFractureTreatments() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Scaphoid Fracture Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A bone fracture is a break within the continuity of a bone. A significant proportion of bone fractures occur due to high-force impact or stress. However, a fracture can also be the result of some medical conditions that weaken the bones. These embody pathology and a few sorts of cancer. The medical term for these may be a pathological fracture.
                    </p>
                </Stack>
