...
export default function OsteogenesisImperfectaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>
                    Osteogenesis Imperfecta (OI) Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Osteogenesis imperfecta is a group of genetic disorders that affect the bones. The term "osteogenesis imperfecta" means incomplete bone formation. People with this condition have bones that break easily, usually due to minor trauma or for no apparent reason. Most fractures are common, and in the worst cases, even before birth. Critical conditions can only involve a few fractures in a person's lifetime. There are at least 19 known types of osteogenesis imperfecta, type I using XIX type. Several species are distinguished by their signs and symbols, although their features are intertwined. Increasingly, genetic causes are used to describe rare species of osteogenesis imperfecta. Type I is a milder form of osteogenesis imperfecta. Type II is more severe. Other strains of the condition, including type III and IV, have signs and symptoms that fall somewhere between these two strengths. Some forms of osteogenesis imperfecta are more severe, causing frequent bone fractures at birth and with little or no trauma.
                    </p>
                </Stack>
