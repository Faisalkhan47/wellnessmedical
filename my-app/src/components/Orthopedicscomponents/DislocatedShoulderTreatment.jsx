...
export default function DislocatedShoulderTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Dislocated Shoulder Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Shoulder stabilization surgery is done to improve the stability and function of the shoulder joint and prevent recurrent dislocations. It can be performed arthroscopically, depending on your particular situation, with much smaller incisions.
                    </p>
                </Stack>
