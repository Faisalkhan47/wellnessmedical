...
export default function TraumaticOrthopedicSurgeryinIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Traumatic Orthopedic Surgery in India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Orthopedic trauma refers to an injury to the musculoskeletal system, especially the bones, joints, muscles, ligaments and tendons. These accidents falls, sports-related occurrences, or other traumatic events frequently result in these injuries.
                    </p>
                </Stack>
