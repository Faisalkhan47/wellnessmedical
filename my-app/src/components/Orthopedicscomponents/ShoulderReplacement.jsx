            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Shoulder Replacement</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Shoulder replacement, conjointly called total shoulder surgery, is the removal of parts of the enarthrodial joint that are replaced with artificial implants to scale back pain and restore varied rotation and quality. It's roaring for treating the severe pain and stiffness caused by end-stage inflammatory disease.
                    </p>
                </Stack>
