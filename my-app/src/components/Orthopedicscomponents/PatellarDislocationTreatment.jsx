...
export default function PatellarDislocationTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Patellar Dislocation Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    When the patella (kneecap) that rests over the front of the knee breaks out of its groove at the end of the thigh bone (femur) and comes to rest on the outside of the knee joint, it is called a dislocated kneecap. The supporting ligaments and tendons may be stretched or torn as a result. When you bend or straighten your leg, the kneecap normally glides smoothly along a groove in the joint, but if the kneecap is dislocated, you may be unable to bend or straighten your leg.
                    </p>
                </Stack>
