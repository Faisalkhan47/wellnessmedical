...
export default function OsteomalaciaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Osteomalacia Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Osteomalacia means "soft bones". Osteomalacia is a condition in which bones become weak and prone to fracture. It is a disease of decreased mineralization that causes bone to break down faster than it can form new bone.It is a condition that occurs in adults. In children, low levels of vitamin D can cause rickets.
                    </p>
                </Stack>
