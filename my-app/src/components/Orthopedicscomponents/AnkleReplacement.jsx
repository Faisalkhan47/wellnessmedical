...
export default function AnkleReplacement() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Ankle Replacement</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Ankle replacement is the replacement of a damaged ankle joint with an artificial implant. The ankle joint or tibiotalar joint is where your tibia rests on top of a bone of your foot, the talus. Arthritis can affect this joint and other joints in the foot.
                    </p>
                </Stack>
