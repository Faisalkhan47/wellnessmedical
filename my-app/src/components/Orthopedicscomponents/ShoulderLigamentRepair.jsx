...
export default function ShoulderLigamentRepair() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Shoulder Ligament Repair</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A shoulder surgical procedure is a surgery that uses a little camera referred to as an endoscope to look at or repair the tissues within or around your spheroid joint. The endoscope is inserted through a tiny low cut (incision) in your skin.
                    </p>
                </Stack>
