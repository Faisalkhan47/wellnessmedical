...
export default function SynoviumRemoval() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Synovium surgery is completed to get rid of inflamed joint tissue (synovium), inflicting unacceptable pain or limiting your ability to operate or your variety of motion. Ligaments and alternative structures are also touched aside to access and take away the inflamed joint lining. The procedure is also done with the help of arthroscopy.
                    </p>
                </Stack>
