...
export default function ShoulderImpingementSyndromeTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Shoulder Impingement Syndrome Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Shoulder impingement may be a common reason for shoulder pain. It’s conjointly called impingement syndrome or swimmer’s shoulder since it’s common in swimmers. It’s conjointly common in alternative athletes who use their shoulders tons, like baseball or basketball players. Your body structure may be a cluster of muscles and tendons that attach your higher os longum to your shoulder. They assist you to carry and rotating your arm. The body structure sits below the highest of the shoulder, which is named the outgrowth. If you've got shoulder impingement, your body structure catches or rubs against the outgrowth. after you carry your arm, the house (bursa) between the body structure and outgrowth narrows, which will increase pressure. Excessive pressure irritates the body structure, resulting in impingement.
                    </p>
                </Stack>
