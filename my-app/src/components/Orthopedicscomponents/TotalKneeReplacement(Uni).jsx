...
export default function TotalKneeReplacementUni() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Total Knee Replacement (Uni)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Knee replacement surgery involves replacing damaged bone and cartilage caused by osteoarthritis with metal and plastic components. If only a specific portion of the knee requires resurfacing, this is known as unicompartmental knee replacement or partial knee replacement. It is a practical replacement to total knee replacement for patients whose osteoarthritis is confined to a single area of the knee.
                    </p>
                </Stack>
