...
export default function HipPainTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hip Pain Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The coxa will stand up to perennial motion and a good quantity of damage and tear. This ball-and-socket joint the body’s largest fits along during an approach that enables fluid movement. Whenever you employ the hip (for example, by going for a run), a cushion of animal tissue helps forestall friction because the hip bone moves in its socket.
                    </p>
                </Stack>
