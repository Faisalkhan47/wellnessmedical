...
export default function CompartmentSyndromeTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Compartment Syndrome Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A compartment syndrome occurs when there is excess pressure built up in an enclosed muscle inside the body. It is usually a result of bleeding or inflammation post-injury. Compartment syndrome normally occurs from swelling or bleeding after an injury. The dangerously high pressure in compartment syndrome impedes the flow of blood to and from the affected tissues. It can be an emergency, requiring surgery to prevent permanent injury. Groups of organs or muscles are organized into areas called compartments. Strong webs of connective tissue called fascia to form the walls of these compartments.
                    </p>
                </Stack>
