...
export default function AnkleFusionSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Ankle Fusion Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An ankle fusion is a type of surgery to assemble a joint in one ankle. Also known as ankle arthrodesis. Surgery is usually performed to treat arthritis in the ankle.
                    </p>
                </Stack>
