...
export default function AbscessDebridement() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Abscess Debridement</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A procedure referred to as Abscess surgical process is one among many treatments that will fight bone or joint infection. Usually, an abscess surgical process procedure is performed within the hospital room. Another method referred to as Incision & emptying is done to treat the symptoms.
                    </p>
                </Stack>
