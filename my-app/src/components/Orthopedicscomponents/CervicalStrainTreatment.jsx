...
export default function CervicalStrainTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Hand surgery is a broad term that covers many different types of procedures. Plastic surgeons who perform hand surgery seek to restore hand and finger function. But hand surgeons also try to make the hand look as normal as possible, as well. Hand reconstructive surgery may be done for many reasons.
                    </p>
                </Stack>
