...
export default function UnilateralHipReplacement() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Unilateral Hip Replacement</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Total hip arthroplasty, also known as unilateral hip replacement, is a process that involves implanting an artificial device into the broken or injured hip joint. In a unilateral hip replacement, the head of the femur and acetabulum are routinely replaced on just one side of the hip joint.
                    </p>
                </Stack>
