...
export default function OsteomyelitisTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Osteomyelitis Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Osteomyelitis is an infection of the bone. Infection can reach the bone by traveling through the bloodstream or by spreading from nearby tissues. Infection can also start in the bone itself when an injury exposes the bone to bacteria. Smokers and people with chronic diseases such as diabetes and kidney failure are at increased risk of developing osteomyelitis. Diabetics can develop osteomyelitis in their feet if they have foot ulcers. Once considered incurable, osteomyelitis is now successfully treated. Most people need surgery to remove pieces of dead bone. Strong intravenous antibiotics are usually required after surgery.
                    </p>
                </Stack>
