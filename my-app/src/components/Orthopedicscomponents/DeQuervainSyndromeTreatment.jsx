...
export default function DeQuervainSyndromeTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Knee Fracture Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The kneecap (the patella) is a triangular bone at the front of the knee. Several tendons and ligaments connect to the kneecap, including ones attached to the upper leg (femur) and lower leg (tibia) bones. Though the kneecap is not needed for walking or bending your leg, it makes your muscles more efficient and absorbs much of the stress between the upper and lower portions of the leg. Climbing stairs and squatting can put up to seven times your normal body weight on the kneecap and the joint behind it. Kneecap fractures account for about 1 percent of all skeletal injuries. The kneecap can fracture in many ways: partially or completely, into a few or into many pieces. Sometimes when the kneecap is fractured, the ligaments or tendons attached to it can be sprained or torn.
                    </p>
                </Stack>
