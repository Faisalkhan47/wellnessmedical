...
export default function AnkleFractureTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Ankle Fracture Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Ankle injuries are among the foremost typical bone and joint injuries. Often, the degree of pain, the shortcoming to run, or concern that a bone could also be broken is what may cause you to hunt for care in an emergency scenario. For the foremost half, your concern is that the same because the doctor's: Is there a broken bone? It's usually impossible to diagnose a fracture (broken bone) instead of a sprain, a dislocation, or sinew injury while not X-rays of the ankle.
                    </p>
                </Stack>
