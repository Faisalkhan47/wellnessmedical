            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Total Knee Replacement (Bilateral)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Bilateral Total Knee Replacement is primarily performed to alleviate severe arthritis that causes pain and stiffness in both knees, hindering daily activities and severely affecting one's quality of life. Pain is aggravated by weight-bearing activities, including standing and walking. As arthritis is a progressive condition, it typically deteriorates over time.
                    </p>
                </Stack>
