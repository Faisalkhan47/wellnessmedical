...
export default function ShoulderArthroplasty() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Shoulder Arthroplasty</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Shoulder arthroplasty is the most typical style of inflammatory disease, moving lots of folks worldwide. It happens once the protecting gristle that cushions the ends of the bones wears down over time. Although degenerative joint disease will injure any joint, the disorder most typically affects joints in your hands, knees, hips, and spine. Osteoarthritis symptoms will typically be managed, though the injury to joints cannot be reversed. Staying active, maintaining a healthy weight, and receiving sure treatments would slow the progression of the unwellness and facilitate improved pain and joint performance.
                    </p>
                </Stack>
