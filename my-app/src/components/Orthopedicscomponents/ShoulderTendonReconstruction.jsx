...
export default function ShoulderTendonReconstruction() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Shoulder Tendon Reconstruction</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The shoulder is complicated, composed of the bone, and scapula, and has sacrificed stability for quality, which makes it vulnerable and at risk of injury, pathology, and instability. The foremost common indication for a surgical operation is pain that has not responded well to conservative management or a severe fracture. Relying upon the mechanism of pathology or injury, a shoulder surgical operation will either be a partial or total replacement.
                    </p>
                </Stack>
