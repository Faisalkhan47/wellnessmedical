...
export default function TreatmentforOsgoodSchlatterDisease() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Treatment for Osgood-Schlatter Disease</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Osgood-Schlatter sickness may be a common reason for knee pain in growing youngsters and young teenagers. It's characterized by inflammation within the space slightly below the knee. This space is wherever the ligament from the kneecap attaches to the tibia (tibia). The condition most frequently develops throughout growth spurts. During the expansion spurts of adolescence, bound muscles and tendons grow quickly and not continually at a constant rate. With physical activity, variations within the size and strength of the extensor muscle will place additional stress on the expansion plate close to the highest of the tibia. The expansion plate is weaker and additionally liable to injury than different elements of the bone. As a result, it will become irritating through physical stress and overuse. The irritation may result in a very painful lump below the kneecap. This can be the most significant of Osgood-Schlatter's sickness.
                    </p>
                </Stack>
