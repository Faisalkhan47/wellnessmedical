...
export default function BakersCystTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Baker's Cyst Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A Baker's cyst is a fluid-filled cyst that makes a bulge and causes a feeling of tightness behind your knee. The pain can get worse when you fully flex or extend your knee or when you're active. A Baker's cyst is also called a popliteal cyst. It is usually the result of a problem with your knee joint, such as arthritis or a cartilage tear. Both conditions can cause your knee to produce too much fluid, which can lead to a Baker's cyst.
                    </p>
                </Stack>
