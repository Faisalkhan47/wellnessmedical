...
export default function BowLegsTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Bow Legs Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Bowleg deformation is an incorrect arrangement around the knee that can harm people of all ages. The disease is also known by various other popular names and medical terms, including bow leg, bandy-leg, bowleg syndrome, bowed legs, varus deformity, genu varum, and tibia vara. It is a condition in which your legs appear bent outward (or bowed) even when you align the ankles together. It is very common in babies due to their posture in the womb. However, when a child has bowlegs at the age of three or above, medical treatment should be considered at once.
                    </p>
                </Stack>
