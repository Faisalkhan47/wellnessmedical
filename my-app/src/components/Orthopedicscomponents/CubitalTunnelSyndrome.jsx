...
export default function CubitalTunnelSyndrome() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Cubital Tunnel Syndrome</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Cubital tunnel syndrome could be a downside with the nerve that passes through the within of the elbow. It causes pain that feels plenty, just like the pain you feel after you hit the "funny bone" in your elbow.
                    </p>
                </Stack>
