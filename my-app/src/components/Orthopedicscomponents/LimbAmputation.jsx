...
export default function LimbAmputation() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Limb Amputation</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Amputation pain is pain that feels like it's coming from a body part that's no longer there. Doctors once believed this post-amputation phenomenon was a psychological problem, but experts now recognize that these real sensations originate in the spinal cord and brain. Most people who've had a limb removed report that it sometimes feels as if the amputated limb is still there. This painless phenomenon, known as amputation limb sensation, isn't the same as amputation pain. For some people, amputation pain gets better over time without treatment. For others, managing amputation pain can be challenging. You and your doctor can work together to treat amputation pain effectively with medication or other therapies.
                    </p>
                </Stack>
