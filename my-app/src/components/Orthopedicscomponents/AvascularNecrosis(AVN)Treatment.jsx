...
export default function AvascularNecrosisTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Avascular Necrosis (AVN) Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Avascular mortification is the death of bone tissue because of an absence of blood provide. Conjointly known as osteonecrosis, it will cause small breaks within the bone and, therefore the bone's ultimate collapse. A broken bone or separated joint will interrupt the blood flow to a neighborhood of bone. Avascular mortification is additionally related to the prolonged use of high-dose steroid medications and excessive alcohol intake. Anyone may be affected. However, the condition is commonest in individuals between thirty and fifty.
                    </p>
                </Stack>
