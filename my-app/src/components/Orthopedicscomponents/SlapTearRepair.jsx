...
export default function SlapTearRepair() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Slap Tear Repair</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A SLAP tear occurs in the top (superior), the front (anterior), and back (posterior) of the point where the biceps tendon attaches to the labrum. The term SLAP is an acronym for Superior Labrum Anterior and Posterior. The labrum is a ring of strong, fibrous tissue or linear cartilage and supports the ball and socket of the shoulder joint. The shoulder joint’s humeral head, or ball, is much larger than the glenoid socket. This creates instability in the joints. The surrounding labrum acts as a bump to provide extra stability and attaches to vital veins. The biceps tendon also attaches to the top of the labrum.
                    </p>
                </Stack>
