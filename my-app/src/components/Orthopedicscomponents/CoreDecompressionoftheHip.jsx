...
export default function CoreDecompressionoftheHip() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Core Decompression of the Hip</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Core decompression is a surgical procedure that involves the piercing of a dead bone near the joint. This reduces stress, allows more blood to flow, and slows down or stops the destruction of bones and/or joints. Core decompression is usually performed to treat osteonecrosis. Stanford Orthopedic Surgeons offer advanced methods of spinal degeneration and cell/bone grafting-techniques, which can benefit people with stage 1 and stage 2 osteonecrosis. Core decompression is effective in 50-90% of patients. Its success depends on the number and location of bone loss in the joint area, how much the joint usually carry, and other factors. Before the procedure is performed, your care team will perform an MRI of the affected member using advanced imaging techniques available at Stanford. This helps identify areas of dead bone that need to be removed. Removal of a dead bone promotes healthy bone production and the development of new blood vessels.
                    </p>
                </Stack>
