...
export default function KneeArthroplasty() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Knee Arthroplasty</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Knee arthroplasty, additionally known as knee surgical procedure or total knee replacement, is an operation to resurface a knee broken by inflammatory disease. Metal and plastic components cap the ends of the bones that bind the knee joint, together with the kneecap.
                    </p>
                </Stack>
