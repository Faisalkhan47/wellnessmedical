...
export default function KirschnerWireRemoval() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Kirschner Wire Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Kirschner wires are straight, stiff wires that are seldom required to repair a fracture. They are commonly called ‘K-wires’ or ‘Pins’. If you have a fracture that requires surgery, you may need K-wires to help hold the bones in place until they are healed. These wires are most commonly used for supracondylar (elbow) or wrist injuries. Depending on the location and severity of the fracture, sometimes multiple K-wires are needed. K-wires are only temporarily needed – once the bones have healed, the wires are removed during an outpatient appointment.
                    </p>
                </Stack>
