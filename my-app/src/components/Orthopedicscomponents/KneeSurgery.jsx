...
export default function KneeSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Knee Surger</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Knee replacement also referred to as knee surgery or total knee replacement, could resurface a knee broken by inflammatory disease. Metal and plastic elements measure and cap the ends of the bones that bind the hinge joint in conjunction with the kneecap.
                    </p>
                </Stack>
