...
export default function WristInstabilityTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Wrist Instability Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Carpal instabilities diagnosed at intervals four to six weeks of the injury are treated by arthroscopic analysis and either closed reduction and arthroscopically target-hunting promise or open ligament repair. Injuries diagnosed between half-dozen weeks and half-dozen months are treated by open ligament repair and ligament augmentation.
                    </p>
                </Stack>
