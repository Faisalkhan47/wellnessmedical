...
export default function OsteoporosisTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Osteoporosis Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Osteoporosis weakens bones, making people more vulnerable to fractures that occur suddenly and unexpectedly. The condition frequently advances without causing any signs or pain, and it is only discovered when bones shatter. There are things you can do to avoid this condition, and there are therapies available.
                    </p>
                </Stack>
