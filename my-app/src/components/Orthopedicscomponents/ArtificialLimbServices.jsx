...
export default function ArtificialLimbServices() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Artificial limb Services</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Artificial limbs also known as prostheses or prosthetic limbs are mechanical replacements for missing limbs in the legs or arms. When people have the misfortune of losing their arms or legs due to disease, injury, or birth defects, artificial limbs help them to get back to their normal functioning to a certain degree.
                    </p>
                </Stack>
