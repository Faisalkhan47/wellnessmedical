...
export default function OsteochondrosisTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Osteochondrosis Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Osteochondrosis is a disorder of families. It affects the growth of bone in children and adolescents. It is often caused by a disruption in the blood flow of joints. It can also occur in adults, however, it is most likely to affect teenagers, whose bones are still growing. There are a number of ailments that fall under the category of osteochondrosis. They affect different parts of one’s body. They’re typically grouped into one of three categories based on where they occur. They can be articular, physical, or nonarticular.
                    </p>
                </Stack>
