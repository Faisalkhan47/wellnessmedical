...
export default function ElbowPainTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Elbow Pain Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Elbow pain is a condition that causes aches where the tendons of your forearm muscles attach to the bony bump on the inside of your elbow. The pain might spread into your forearm and wrist. It is similar to a tennis elbow or golfer’s elbow, which occurs on the outside of the elbow. It's not limited to golfers. Tennis players and others who repeatedly use their wrists or clench their fingers also can develop this condition. The pain in an elbow doesn't have to keep you off the course or away from your favorite activities. Rest and appropriate treatment can get you back into the swing of things.
                    </p>
                </Stack>
