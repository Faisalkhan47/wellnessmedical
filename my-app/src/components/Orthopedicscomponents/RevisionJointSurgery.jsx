...
export default function RevisionJointSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Revision Joint Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A revision joint replacement means surgery should be done to switch a worn-out joint replacement. Conjointly known as revision surgery, revision joint replacement is usually a lot more complex than the initial joint replacement, and therefore the revision surgery could have less foreseeable results.
                    </p>
                </Stack>
