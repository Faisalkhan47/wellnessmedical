...
export default function BoneFractureTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Bone Fracture Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A bone fracture is a break in the continuity of a bone. A significant percentage of bone fractures occur because of high force impact or stress. However, a fracture may also be the result of some medical conditions that weaken the bones. These include osteoporosis and some types of cancer. The medical term for these is a pathological fracture. In this article, we detail the different types of bone fractures, their various causes, and the treatments available. A bone fracture is a full or partial break in the continuity of bone tissue. Fractures can occur in any bone in the body.
                    </p>
                </Stack>
