...
export default function AnkleArthroscopy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Ankle Arthroscopy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Ankle arthroscopy is a minimally invasive surgical procedure that orthopedic surgeons use to treat predicaments in the ankle joint. Ankle arthroscopy uses a thin fiber-optic camera (arthroscope) that can amplify and convey images of the ankle to a video screen. Ankle arthroscopies can reduce ankle pain and enhance overall function.
                    </p>
                </Stack>
