...
export default function MedialPatellofemoralLigamentSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Joint Injection</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Joint injections, or aspiration (removing fluid from the joint), are often done in a doctor's office or hospital using a cold spray or other local anesthetic. After thoroughly cleansing the skin surface, the needle is inserted directly into the joint. At this point, synovial fluid can be removed (aspirated) and used for appropriate laboratory tests, or steroids can be injected into the joint. Steroids treat joint inflammation and reduce swelling and pain.
                    </p>
                </Stack>
