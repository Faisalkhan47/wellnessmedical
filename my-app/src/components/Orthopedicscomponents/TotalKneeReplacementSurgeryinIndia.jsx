...
export default function TotalKneeReplacementSurgeryinIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Total Knee Replacement Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Total knee arthroplasty also known as total knee replacement surgery in which they use an artificial implant to replace a worn-out or damaged knee joint. People who suffer knee problems such as osteoarthritis, rheumatoid arthritis, or post-traumatic arthritis should have surgery since it is difficult for them to live, their knees hurt a lot, and they are limited in how much they can move.
                    </p>
                </Stack>
