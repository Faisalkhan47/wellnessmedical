...
export default function ElbowArthroscopy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Elbow Arthroscopy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Arthroscopy is a minimally invasive surgical procedure used by orthopedic surgeons to visualize, diagnose and treat problems inside the joint. Injury, overuse, and age-related wear and tear are responsible for most elbow problems. Elbow arthroscopy may relieve the painful symptoms of many problems that damage the cartilage surfaces and other soft tissues surrounding the joint.
                    </p>
                </Stack>
