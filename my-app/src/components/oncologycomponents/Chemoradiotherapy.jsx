...
export default function Chemoradiotherapy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Chemoradiotherapy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Chemoradiotherapy (CRT) refers to the combined administration of both chemotherapy and radiotherapy as an anticancer treatment. Over the years, CRT has become an established treatment for a diverse range of locally advanced solid tumors. The rationale for CRT is based on the two concepts of spatial cooperation and in-field cooperation, whereby the end goal is to achieve synergistic antitumor effects from the combination of both treatment modalities. CRT offers notable patient survival benefits and local disease control without significant long-term toxicities. Although the enhancement of cytotoxic effects inevitably increases damage to normal tissues as well as tumor cells, if the damage to normal tissue is lesser than that to tumor cells, CRT is still deemed beneficial.
                    </p>
                </Stack>
