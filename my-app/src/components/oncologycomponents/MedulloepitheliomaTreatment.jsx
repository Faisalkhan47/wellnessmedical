...
export default function MedulloepitheliomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Medulloepithelioma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Medulloepitheliomas are thought to arise from neuroepithelial cells. They commonly arise from within the non-pigmented ciliary epithelium. A distinct microstructural appearance comprising pseudostratified primitive neuroepithelial cells surrounded by a hyaluronic acid-rich stroma is seen.. According to the Zimmerman classification, medulloepithelioma can be histopathologically classified into teratoid and non-teratoid types, and each of these can be further sub-classified into benign or malignant types.
                    </p>
                </Stack>
