...
export default function EpendymoblastomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Ependymoblastoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Ependymoblastoma, also known as childhood ependymoma, is a type of brain tumor that occurs during early childhood. This type of brain tumor is highly malignant and is usually diagnosed in infants or very young children. Ependymoblastoma is a rare and devastating primitive neuroectodermal tumor with ependymal differentiation. This tumor occurs very early in life and shows rapid growth and diffuse infiltration through the leptomeningeal space. This neoplasm is characterized by uniform neuroepithelial cells, multilayered ependymal rosettes, perivascular pseudorosettes, and numerous mitotic.
                    </p>
                </Stack>
