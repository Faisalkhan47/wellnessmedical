...
export default function CentralNervousSystemLymphomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Central Nervous System (CNS) Lymphoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Central nervous system lymphoma is a rare non-Hodgkin lymphoma in which malignant (cancer) cells form lymph tissue form in the brain and/or spinal cord (primary CNS) or spread from other parts of the body to the brain and/or spinal cord (secondary CNS). Because the eye is so close to the brain, primary CNS lymphoma can also start in the eye (called ocular lymphoma). Cancer can also involve the spinal fluid that bathes the spinal cord and brain. This is called leptomeningeal lymphoma. Both primary and secondary CNS lymphomas are rare diseases. The cancer is a form of extranodal, high-grade non-Hodgkin B-cell lymphoma. Most forms of CNS lymphoma (about 90 percent) are diffuse large B-cell lymphomas; the remaining ten percent are poorly characterized low-grade lymphomas, Burkitt lymphomas, and T-cell lymphomas.
                    </p>
                </Stack>
