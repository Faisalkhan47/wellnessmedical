...
export default function MultipleMyelomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Multiple Myeloma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Multiple myeloma is cancer that forms in a type of white blood cell called a plasma cell. Healthy plasma cells help you battle diseases by making antibodies that perceive and assault germs. In multiple myeloma, cancerous plasma cells gather in the bone marrow and group out solid platelets. Maybe than produce accommodating antibodies, the cancer cells produce strange proteins that can cause complications.
                    </p>
                </Stack>
