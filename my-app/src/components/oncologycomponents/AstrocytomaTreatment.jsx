...
export default function AstrocytomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Astrocytoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Astrocytoma is a sort of cancer that can frame in the brain or spinal cord. Astrocytoma starts in cells considered astrocytes that help nerve cells. Astrocytoma signs and side effects rely upon the area of your tumor. Astrocytomas that happen in the brain can cause seizures, headaches, and nausea. Astrocytomas that happen in the spinal cord can cause weakness and disability in the space influenced by the developing tumor. An astrocytoma can be a lethargic developing growth, or it very well may be a forceful disease that develops rapidly.
                    </p>
                </Stack>
