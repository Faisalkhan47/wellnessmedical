...
export default function MedulloblastomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Medulloblastoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Medulloblastoma is the most widely recognized dangerous cerebrum cancer in youngsters. Medulloblastomas by definition happen in the cerebellum, which is the piece of the brain situated at the foundation of the skull, simply over the brainstem. The cerebellum is associated with many capacities including coordination of deliberate developments (e.g., walking, fine motor skills) and controlling equilibrium and posture. Medulloblastomas emerge from crude, lacking cells in the mind. Most medulloblastomas happen in babies and kids. Less ordinarily, these cancers can create in grown-ups also. Indications related to a medulloblastoma remember headaches in the morning that improve as the day goes on, repetitive heaving, and trouble strolling and balancing. Medulloblastomas can spread to different spaces of the focal sensory system. The specific reason for medulloblastoma is obscure.
                    </p>
                </Stack>
