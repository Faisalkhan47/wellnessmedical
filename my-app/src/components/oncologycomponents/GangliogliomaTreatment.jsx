...
export default function GangliogliomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Ganglioglioma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Ganglioglioma is a very rare type of glioma brain tumor that contains a mixture of neuronal and glial cells, and hence is part of a group of tumors classified as mixed neuronal-glial tumors. Neuronal cells are those that form the neurons in the brain, which primarily carry information. Glial cells are those that form the structure of the brain and interact closely with the neurons, nourishing them and helping them to function correctly. It usually occurs in the part of the brain that controls motor, sensory and higher mental function, called the cerebrum, but can occur in any part of the brain or spinal cord.
                    </p>
                </Stack>
