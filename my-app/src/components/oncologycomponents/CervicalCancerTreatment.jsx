            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Cervical Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Cervical cancer is a type of cancer that occurs in the cells of the cervix the lower part of the uterus that connects to the vagina. Different strains of the human papillomavirus (HPV), a sexually transmitted infection, assume a part in causing most cervical cancer. When presented to HPV, the body's immune system commonly keeps the infection from doing hurt. In a small level of individuals, however, the infection gets by for quite a long time, adding to the interaction that makes some cervical cells become cancer cells. You can diminish your danger of creating cervical cancer by having screening tests and getting an immunization that secures against HPV disease.
                    </p>
                </Stack>
