...
export default function HeadandNeckCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Head and Neck Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Head and Neck cancers can affect the nasal passages, sinuses, mouth, throat, larynx (voice box), swallowing passages, salivary glands, and thyroid gland. Skin cancers growths that create on the scalp, face, or neck likewise might be viewed as head and neck cancers. A significant number of these cancers are receptive to treatment. These tumors can start any place in the head and neck area. Treatment choices depend on where a head and neck disease begins (for example tongue vs throat) in light of the fact that every tumor site reacts to treatment type in an unexpected way.
                    </p>
                </Stack>
