...
export default function RegionalChemotherapy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Regional Chemotherapy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Regional chemotherapy is a method of drug delivery to a tumor-bearing area through a small catheter placed in the artery supporting the tumor. This is typically performed without operation in the radiology department. By this strategy, we can convey a high dose of chemotherapy to the tumor-bearing region. At the time provincial chemotherapy is finished by putting a catheter in the artery carrying blood to the tumor and then attaching the catheter to a pump placed under the skin (like a pacemaker) to persistently convey chemotherapy to the tumor.
                    </p>
                </Stack>
