...
export default function PrimaryBoneCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Primary Bone Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Bone cancer can begin in any bone in the body, but it most commonly affects the pelvis or the long bones in the arms and legs. Bone cancer is uncommon, making up under 1% of all diseases. Indeed, noncancerous bone tumors are substantially more typical than cancerous ones. The term "bone cancer" doesn't include cancers that begin elsewhere in the body and spread (metastasize) to the bone. Instead, those cancers are named for where they began, such as breast cancer that has metastasized to the bone. The term "bone cancer" does exclude diseases that start somewhere else in the body and spread (metastasize) deep down. All things being equal, those cancers are named for where they started, for example, breast cancer that has metastasized to the bone.
                    </p>
                </Stack>
