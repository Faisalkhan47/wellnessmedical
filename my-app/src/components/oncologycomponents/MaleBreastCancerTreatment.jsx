...
export default function MaleBreastCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Male Breast Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Breast cancer occurs mainly in women, but men can get it, too. Many people do not realize that men have breast tissue and that they can develop breast cancer. Cells in almost any piece of the body can become cancer and can spread to other areas. Breast cancer growth begins when cells in the breast start to outgrow control. These cells ordinarily structure a tumor that can frequently be seen on an x-ray or felt as a lump. The tumor is malignant (cancer) if the cells can develop into encompassing tissues or spread (metastasize) to far-off spaces of the body.
                    </p>
                </Stack>
