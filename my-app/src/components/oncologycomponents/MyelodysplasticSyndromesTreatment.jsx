...
export default function MyelodysplasticSyndromesTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Myelodysplastic Syndromes Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Myelodysplastic conditions are a group of issues brought about by blood cells that are inadequately framed or don't work as expected. Myelodysplastic syndromes come about because of something wrong in the light material inside your bones where blood cells are made (bone marrow). The board of myelodysplastic syndromes is regularly expected to slow the infection, ease manifestations, and prevent complications. Normal measures incorporate blood transfusions and drugs to boost blood cell production. In specific circumstances, a bone marrow transplant, otherwise called a stem cell transplant, might be prescribed to supplant your bone marrow with sound bone marrow from a donor.
                    </p>
                </Stack>
