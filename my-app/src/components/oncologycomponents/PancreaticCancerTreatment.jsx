...
export default function PancreaticCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Pancreatic Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Pancreatic cancer begins in the tissues of your pancreas an organ in your abdomen that lies behind the lower part of your stomach. Your pancreas discharges enzymes that guide digestion and produce hormones that assist with dealing with your blood sugar. A few kinds of development can happen in the pancreas, including cancerous and noncancerous tumors. The most well-known kind of cancer is that structures in the pancreas start in the cells that line the conduits that do stomach-related proteins of the pancreas (pancreatic ductal adenocarcinoma).
                    </p>
                </Stack>
