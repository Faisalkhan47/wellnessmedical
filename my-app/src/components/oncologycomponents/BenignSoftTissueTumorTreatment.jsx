...
export default function BenignSoftTissueTumorTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Benign Soft Tissue Tumor Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Benign tumors of soft tissue are more common than benign tumors of bone. They can occur at almost any site, both within and between muscles, ligaments, nerves, and blood vessels. These tumors vary widely in appearance and behavior. Some tumors can be quite aggressive. Invasion of nearby tissues increases the chance of incomplete excision and the possibility that the tumor will come back. Your surgeon may use specialized techniques and even radiation therapy to reduce the risk of recurrence.
                    </p>
                </Stack>
