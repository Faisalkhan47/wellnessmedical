...
export default function AcuteLeukemiaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Acute Leukemia Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The main treatment for acute lymphocytic leukemia (ALL) in adults is typically long-term chemotherapy (chemo). Lately, specialists have started to utilize more escalated chemo regimens, which has prompted more reactions to treatment.
                    </p>
                </Stack>
