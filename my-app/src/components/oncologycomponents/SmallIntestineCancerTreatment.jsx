...
export default function SmallIntestineCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Small Intestine Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Small intestine cancer starts when cells in the small intestine start to grow out of control. The small intestine is important for the gastrointestinal tract, otherwise called the digestive tract. The GI tract processes food for energy and frees your assortment of strong waste. However, the small intestine makes up the biggest piece of the GI tract, small intestine cancers are considerably less normal than most different kinds of GI cancers.
                    </p>
                </Stack>
