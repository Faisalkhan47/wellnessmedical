...
export default function EpendymomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Ependymoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An ependymoma is an uncommon kind of essential brain or spinal cord tumor. Ependymomas are found all through the central nervous system in the supratentorial (top of the head), back fossa (back of the head), and spinal compartments. These cancers influence the two children and adults. They are thought to create from specific cells that are regularly full-grown into ependymal cells. Ependymal cells line the ventricles (fluid-filled spaces in the brain) and the focal waterway of the spinal string. Once in a while, ependymoma tumor cells can spread in the liquid that encompasses the mind and spinal cord.
                    </p>
                </Stack>
