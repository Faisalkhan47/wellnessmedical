            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Chemotherapy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The word chemotherapy is used to treat various types of cancer. If a person is suffering from cancer then most of the doctors are suggested to the patients for the chemotherapy. This therapy works by keeping the cancer cells from dividing, growing, and making more cells. It is a chemical drug therapy to destroy rapidly growing cells in the body. The cancer treatment is performed by the oncologist and they have enough experience on how to deal with patients.
                    </p>
                </Stack>
