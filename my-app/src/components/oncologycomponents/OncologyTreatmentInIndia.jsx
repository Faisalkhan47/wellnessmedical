...
export default function OncologyTreatmentInIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Oncology Treatment In India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A specialized field of medicine called oncology deals with the early detection, diagnosis, and treatment of cancer. It is a technical field focused on understanding and managing various types of cancer affecting different body organs and systems.
                    </p>
                </Stack>
