...
export default function ThyroidCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Kidney Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Kidney cancer is cancer that begins in the kidneys. Your kidneys are two bean-shaped organs, each about the size of your fist. They're situated behind your abdominal organs, with one kidney on each side of your spine. In grown-ups, renal cell carcinoma is the most widely recognized sort of kidney cancer. Other more uncommon kinds of kidney cancer can occur. Little youngsters are bound to foster a sort of kidney cancer called Wilms' tumor. The rate of kidney cancer is by all accounts expanding. One justification for this might be the way that imaging strategies like computerized tomography (CT) filters are being utilized all the more regularly.
                    </p>
                </Stack>
