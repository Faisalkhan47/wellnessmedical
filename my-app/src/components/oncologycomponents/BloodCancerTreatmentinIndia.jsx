...
export default function BloodCancerTreatmentinIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Blood Cancer Treatment in India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Blood cancer is the term used to describe cancers that affect the blood, bone marrow, and lymphatic system. Blood cancer can develop when the body produces red blood cells, white blood cells, or platelets abnormally or unusually. The cancer typically originates in the bone marrow, which is responsible for the production of blood. This type of cancer disrupts the normal functioning, growth, and development of blood cells, which can lead to a decrease in healthy blood cells and a weakened ability to fight infections.
                    </p>
                </Stack>
