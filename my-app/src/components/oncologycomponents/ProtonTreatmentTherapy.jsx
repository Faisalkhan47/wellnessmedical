...
export default function ProtonTreatmentTherapy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Proton Treatment Therapy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Proton therapy is a type of radiation therapy a treatment that uses high-energy beams to treat tumors. Radiation treatment utilizing X-beams has for quite some time been utilized to treat diseases and noncancerous (amiable) tumors. Proton treatment is a more current kind of radiation treatment that utilizes energy from emphatically charged particles called protons. Proton treatment has shown guarantee in treating a few sorts of diseases. Studies have proposed that proton treatment may cause less incidental effects than conventional radiation since specialists can more readily control where the proton radiates store their energy. Yet, not many investigations have straightforwardly looked at proton treatment radiation and X-beam radiation, so it's not satisfactory whether proton treatment is more viable in drawing out lives.
                    </p>
                </Stack>
