...
export default function PediatricOncologyTreatmentinIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Pediatric Oncology Treatment in India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A medical specialty called pediatric oncology is dedicated to detecting, treating, and managing cancer in kids and teenagers. It focuses primarily on cancers that afflict people from birth until they are 18 years old. Pediatric oncologists are medical professionals who focus on offering complete treatment to young cancer patients.
                    </p>
                </Stack>
