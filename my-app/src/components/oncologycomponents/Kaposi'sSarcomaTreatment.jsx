...
export default function KaposisSarcomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Kaposi's Sarcoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Kaposi's sarcoma is a type of cancer that forms in the lining of blood and lymph vessels. The tumors (lesions) of Kaposi's sarcoma commonly show up as painless purplish spots on the legs, feet, or face. Lesions can likewise show up in the genital region, mouth, or lymph nodes. In serious Kaposi lesions, might grow in the digestive tract and lungs. The basic reason for Kaposi's sarcoma is contamination with an infection called human herpesvirus 8 (HHV-8). In solid individuals, HHV-8 disease typically causes no manifestations in light of the fact that the safe framework monitors it. In individuals with weakened immune systems, in any case, HHV-8 can possibly trigger Kaposi's sarcoma.
                    </p>
                </Stack>
