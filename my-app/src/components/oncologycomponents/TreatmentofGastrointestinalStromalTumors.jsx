...
export default function TreatmentofGastrointestinalStromalTumors() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Gastrointestinal Stromal Tumors Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Gastrointestinal stromal growths (GISTs) are delicate tissue sarcomas that can be situated in any part of the digestive system. Their most normal destinations are the stomach and small intestine. GISTs start in particular nerve cells situated in the dividers of your digestive system. These cells are essential for the autonomic nervous system. A particular change in the DNA of one of these cells, which controls such digestive processes as the movement of food through the intestines, gives rise to a GIST. Little GISTs might cause no manifestations, and they might develop at such a leisurely pace that they have no genuine impacts. Individuals with bigger GISTs for the most part look for clinical consideration when they vomit blood or pass blood in their stool because of fast-draining from the tumor.
                    </p>
                </Stack>
