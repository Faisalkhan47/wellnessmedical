...
export default function SoftTissueSarcomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Soft Tissue Sarcoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Soft tissue sarcoma is a rare type of cancer that begins in the tissues that connect, support, and surround other body structures. This includes muscle, fat, blood vessels, nerves, tendons, and the lining of your joints. More than 50 subtypes of soft tissue sarcoma exist. A few sorts are bound to influence youngsters, while others influence generally grown-ups. These tumors can be hard to analyze on the grounds that they might be confused with numerous different kinds of development. It can occur anywhere in your body, but the most common types occur in the arms and legs, and in the abdomen.
                    </p>
                </Stack>
