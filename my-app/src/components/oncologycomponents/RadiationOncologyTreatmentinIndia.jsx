...
export default function RadiationOncologyTreatmentinIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Radiation Oncology Treatment in India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Radiation oncology also known as radiation therapy or radiotherapy is a branch of medicine that mainly focuses on using ionizing radiation to treat cancer. Along with surgery and chemotherapy, it is one of the main cancer therapies. Radiation oncologists are medical professionals that focus on treating cancer patients using radiation therapy.
                    </p>
                </Stack>
