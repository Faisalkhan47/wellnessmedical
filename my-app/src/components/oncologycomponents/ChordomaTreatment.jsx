...
export default function ChordomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Chordoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Chordoma is an uncommon kind of bone cancer that happens frequently in the bones of the spine or the skull. It frequently shapes where the skull sits on the spine (skull base) or at the lower part of the spine (sacrum). Chordoma starts in cells that were once made up of an assortment of cells in the creating incipient organism that proceed to turn into the circles of the spine. The majority of these cells disappear when you're conceived or before long. Be that as it may, now and again a couple of these cells remain, and, rarely, they can become cancerous. Chordoma happens regularly in grown-ups somewhere in adults between 40 and 60. However, it can occur at whatever stage in life.
                    </p>
                </Stack>
