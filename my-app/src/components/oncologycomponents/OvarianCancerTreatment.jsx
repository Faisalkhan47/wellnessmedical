            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Ovarian Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Ovarian cancer is a type of cancer that begins in the ovaries. The ovaries each about the size of an almond produce eggs (ova) just as the hormones estrogen and progesterone. It frequently goes undetected until it has spread inside the pelvis and abdomen. At this late stage, ovarian cancer growth is harder to treat. in which the disease is restricted to the ovary the beginning phase of ovarian cancer, is more likely to be treated successfully.
                    </p>
                </Stack>
