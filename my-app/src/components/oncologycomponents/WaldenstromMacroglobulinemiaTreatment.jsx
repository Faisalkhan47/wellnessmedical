...
export default function WaldenstromMacroglobulinemiaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Waldenstrom Macroglobulinemia Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Waldenstrom macroglobulinemia is an uncommon kind of cancer that starts in white blood cells. On the off chance that you have Waldenstrom macroglobulinemia, your bone marrow creates a large number of unusual white blood cells that group out healthy blood cells. The abnormal white blood cells produce a protein that collects in the blood, disables dissemination, and causes inconveniences. It is viewed as a sort of non-Hodgkin's lymphoma. It's occasionally called lymphoplasmacytic lymphoma.
                    </p>
                </Stack>
