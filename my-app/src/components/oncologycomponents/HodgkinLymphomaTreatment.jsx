...
export default function HodgkinLymphomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hodgkin Lymphoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Hodgkin's lymphoma formerly known as Hodgkin's disease is a cancer of the lymphatic system, which is part of your immune system. It might influence individuals of all ages yet is generally normal in individuals somewhere in people between 20 and 40 years of age and those more than 55. In Hodgkin's lymphoma, cells in the lymphatic system develop abnormally and may spread past it. Hodgkin's lymphoma is one of two normal kinds of cancers growths of the lymphatic framework. The other sort, non-Hodgkin's lymphoma, is undeniably more normal.
                    </p>
                </Stack>
