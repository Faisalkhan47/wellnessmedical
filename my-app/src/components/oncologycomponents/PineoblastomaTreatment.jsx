...
export default function PineoblastomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Pineoblastoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The pineal gland is a small organ located somewhere inside the brain that secretes a hormone called melatonin, which controls rest. One sort of tumor that beginnings in this gland are called pineoblastoma. Pineoblastoma is more forceful than different sorts of pineal gland tumors. Its quick development generally causes cerebrospinal liquid (CSF) to develop in the brain. This condition is called hydrocephalus.
                    </p>
                </Stack>
