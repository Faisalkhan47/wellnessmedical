...
export default function PancoastTumorTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Pancoast Tumor Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A generally remarkable kind of non-small cell lung cancer, Pancoast tumors typically create in the upper portion (superior sulcus) of a lung. Because of their area in the pulmonary apex of the chest which is encircled by basic constructions, for example, blood vessels, the brachial plexus and different nerves, the spine, the ribs, and the covering of the chest cavity - Pancoast tumors can be trying to treat. Be that as it may, through propels in careful strategies and radiation therapy, patient results and personal satisfaction are constantly improving.
                    </p>
                </Stack>
