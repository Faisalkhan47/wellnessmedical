...
export default function NeuroblastomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Neuroblastoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Neuroblastoma is cancer that develops from immature nerve cells found in several areas of the body. It most ordinarily arises in and around the adrenal glands, which have comparative starting points to nerve cells and sit on the kidneys. Although, neuroblastoma can grow in different areas of the abdomen and in the chest, neck, and close to the spine, where gatherings of nerve cells exist. Neuroblastoma most ordinarily influences youngsters age 5 or more youthful, however, it might rarely develop in older children. A few types of neuroblastoma disappear all alone, while others might require multiple treatments.
                    </p>
                </Stack>
