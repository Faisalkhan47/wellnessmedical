...
export default function MeningiomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Meningioma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A meningioma is a tumor that emerges from the meninges the layers that encompass your mind and spinal cord. However, not, in fact, a brain tumor, it is remembered for this classification since it might pack or press the nearby brain, nerves, and vessels. Meningioma is the most widely recognized sort of tumor that structures the head. Most meningiomas become gradually, frequently over numerous years without causing symptoms. However, now and again, their impacts on adjacent brain tissue, nerves, or vessels may cause serious disability.
                    </p>
                </Stack>
