...
export default function MohsSkinCancerSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Mohs Skin Cancer Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Mohs surgery is a precise surgical technique used to treat skin cancer. During Mohs medical procedure, thin layers of cancer-containing skin are logically eliminated and analyzed until just cancer-free tissue remains. The Mohs medical procedure is otherwise called Mohs micrographic medical procedure. The objective of Mohs's medical procedure is to eliminate however much of the skin cancer as could be expected while harming encompassing healthy tissue. The Mohs medical procedure is normally done on an outpatient premise utilizing a local anesthetic. The Mohs medical procedure is an improvement to the standard medical procedure which includes eliminating apparent cancer and a little edge of encompassing sound tissue at the same time.
                    </p>
                </Stack>
