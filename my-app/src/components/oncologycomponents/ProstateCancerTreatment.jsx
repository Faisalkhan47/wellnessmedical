...
export default function ProstateCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Prostate Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Prostate cancer is cancer that occurs in the prostate. The prostate is a small walnut-shaped gland in males that produces the seminal fluid that nourishes and transports sperm. Prostate malignancy is quite possibly the most widely recognized kind of disease. Numerous prostate tumors develop gradually and are restricted to the prostate organ, where they may not cause genuine mischief. Be that as it may, while a few kinds of prostate disease develop gradually and may require insignificant or even no treatment, different sorts are forceful and can spread rapidly. Prostate malignant growth that is distinguished early when it's actually restricted to the prostate organ has the best chance for successful treatment.
                    </p>
                </Stack>
