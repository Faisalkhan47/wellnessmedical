...
export default function AllogeneicBoneMarrowTransplant() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Allogeneic Bone Marrow Transplant (BMT)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The process of bone marrow transplant (BMT) is a specialized therapy that aims to treat patients with certain diseases, including cancers. It involves extracting stem cells from the bone marrow, filtering them, and reinfusing them back into either the donor (patient) or another person. The primary objective of BMT is to introduce healthy bone marrow cells into a patient following the elimination of their unhealthy bone marrow, which contains abnormal cells.
                    </p>
                </Stack>
