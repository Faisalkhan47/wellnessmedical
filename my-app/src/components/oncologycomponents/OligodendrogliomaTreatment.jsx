...
export default function OligodendrogliomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Oligodendroglioma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Oligodendroglioma is a growth that can happen in the mind or spinal cord. Oligodendroglioma structures from oligodendrocytes cells in the cerebrum and spinal cord that produce a substance that secures nerve cells. Oligodendrogliomas create from glial cells called oligodendrocytes. These cells make a fatty white substance (myelin) that covers the nerves. Myelin helps signals (motivations) to go along the nerves all the more rapidly.
                    </p>
                </Stack>
