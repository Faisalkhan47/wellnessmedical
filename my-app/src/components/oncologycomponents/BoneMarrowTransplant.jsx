            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Bone Marrow Transplant</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Bone marrow transplant is performed by the most qualified and experienced doctors and they know how to perform a successful surgery. In this procedure, a doctor will replace the damaged or diseased bone marrow with a healthy one, it can also come from a donor. This treatment will cure many diseases including acute leukemia, myelodysplastic syndromes, aplastic anemia, and some types of bone cancers. The main purpose of a bone marrow transplant is to make enough white blood cells, platelets, or red blood cells to avoid infections, bleeding disorders, or anemia. The most effective chemotherapy and radiation treatments are available but the best treatment is an in-office surgery. The surgery involves surgical removal of cancer; chemotherapy or radiation treatment; or stem cell transplant.
                    </p>
                </Stack>
