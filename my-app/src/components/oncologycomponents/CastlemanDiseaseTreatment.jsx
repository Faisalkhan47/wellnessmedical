...
export default function CastlemanDiseaseTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Castleman Disease Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Castleman disease is a group of uncommon problems portrayed by lymph node expansion, specific microscopic changes to the lymph nodes, and a wide scope of manifestations and research center discoveries. The lymph nodes, and the cells that live in them (lymphocytes), are a fundamental piece of our immune system that assists us with battling attacking creatures. For some mysterious reason, these lymph nodes go through certain changes that outcome in the overproduction of lymphocytes and other inflammatory compounds.
                    </p>
                </Stack>
