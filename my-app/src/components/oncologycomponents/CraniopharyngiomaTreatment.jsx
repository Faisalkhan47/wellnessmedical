...
export default function CraniopharyngiomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Craniopharyngioma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Craniopharyngioma is an uncommon sort of noncancerous brain tumor. Craniopharyngioma starts close to the brain's pituitary organ, which secretes hormones that control many body capacities. As a craniopharyngioma gradually develops, it can influence the capacity of the pituitary organ and other close-by structures in the brain. It can happen at whatever stage in life. However, it happens frequently in kids and more seasoned grown-ups.
                    </p>
                </Stack>
