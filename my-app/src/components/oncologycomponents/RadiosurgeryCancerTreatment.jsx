...
export default function RadiosurgeryCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Radiosurgery Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Radiosurgery, also called stereotactic radiosurgery, is a very precise form of therapeutic radiology. Despite the fact that it is called surgery, radiosurgery doesn't include genuine medical procedures. All things considered, extremely engaged light emissions (gamma rays, X-rays, or protons) are utilized to treat cancerous tissues without a careful incision or opening. Radiosurgery is classified "medical procedure" since it is a 1-session radiation therapy that makes a comparable outcome as a genuine surgery.
                    </p>
                </Stack>
