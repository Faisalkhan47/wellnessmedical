...
export default function EndometrialCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Endometrial Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Endometrial cancer is a type of cancer that begins in the uterus. The uterus is the hollow, pear-shaped pelvic organ where fetal development occurs. Endometrial cancer starts in the layer of cells that structure the covering (endometrium) of the uterus. Endometrial cancer is also called uterine cancer. Different types of cancer can frame in the uterus, including uterine sarcoma, however, they are substantially less normal than endometrial cancer. It is normally identified at a beginning phase since it every now and again delivers unusual vaginal bleeding. In the event that endometrial cancer is found early, eliminating the uterus carefully frequently fixes endometrial cancer.
                    </p>
                </Stack>
