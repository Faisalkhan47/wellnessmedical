...
export default function GallbladderCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Gallbladder Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Gallbladder cancer is an abnormal growth of cells that begins in the gallbladder. Your gallbladder is a small, pear-shaped organ on the right side of your abdomen, just beneath your liver. The gallbladder stores bile, a stomach-related liquid created by your liver. It is phenomenal. At the point when gallbladder cancer is found at its earliest stages, the possibility for a fix is good. Yet, most gallbladder cancers are found at a late stage when the forecast is frequently exceptionally poor.
                    </p>
                </Stack>
