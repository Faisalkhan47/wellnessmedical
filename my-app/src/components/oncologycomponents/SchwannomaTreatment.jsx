...
export default function SchwannomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Schwannoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A schwannoma is a tumor that creates from the Schwann cells in the fringe sensory system or cranial nerves. Schwann cells help the conduction of nerve-driving forces. This sort of tumor is normally harmless. Schwannomas are now and again called neurilemomas, neurolemma, or neuromas. In the event that a schwannoma is malignant (cancer), it could be alluded to as a delicate tissue sarcoma. Schwannomas can be found in the sheath that covers the nerves. They are found in the fringe sensory system, cranial nerves, or the base of a nerve and not in the mind or spinal cord.
                    </p>
                </Stack>
