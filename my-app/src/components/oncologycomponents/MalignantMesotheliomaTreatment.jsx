...
export default function MalignantMesotheliomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Malignant Mesothelioma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Malignant mesothelioma is cancer that beginnings in cells in the linings of specific pieces of the body, most normally the linings of the chest or abdomen (belly). A layer of particular cells called mesothelial cells lines within your chest, your abdomen, and the space around your heart. These cells likewise cover the external surface of the vast majority of your inner organs. The covering shaped by these phones is known as the mesothelium. A layer of particular cells called mesothelial cells lines within your chest, your abdomen, and the space around your heart. These cells additionally cover the external surface of a large portion of your inside organs. The coating shaped by these phones is known as mesothelium.
                    </p>
                </Stack>
