...
export default function VulvarCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Vulvar Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The vulva is the skin and fatty tissue between the upper thighs of women. It extends from the area of the anus to about an inch below the pubic hairline. Cancer of the vulva regularly influences the two skin folds (or lips) around the vagina, known as the labia. Vulvar cancer isn't extremely normal. Although, it is intense in light of the fact that it is cancer. It can influence a woman’s sexual functioning. It can make sex painful and difficult. Whenever discovered early, vulvar cancer has a high fix rate and the treatment options involve less surgery.
                    </p>
                </Stack>
