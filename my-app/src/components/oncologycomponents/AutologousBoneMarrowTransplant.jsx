...
export default function AutologousBoneMarrowTransplant() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Autologous Bone Marrow Transplant</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An autologous bone marrow transplant involves gathering healthy stem cells from a patient's bone marrow before treatment preserving them and then reintroducing them to the patient after treatment. This procedure is used to replace the patient's stem cells that were eliminated by radiation or intensive chemotherapy.
                    </p>
                </Stack>
