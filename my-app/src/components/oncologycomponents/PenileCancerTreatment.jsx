...
export default function PenileCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Penile Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Penile cancer starts in or on the penis. Cancer starts when cells begin to grow out of control. Cells in nearly any piece of the body can become cancer and can spread to different pieces of the body. To study how malignant growths start and spread. The main roles of the penis are to carry urine out of the body and sperm into the female's vagina. There are 3 tubes inside the penis. One is known as the urethra. It's empty and brings pee from the bladder through the penis to the outside. The other 2 tubes are known as the corpora cavernosa. These are delicate, spongy tubes that load up with blood to make the penis firm during an erection.
                    </p>
                </Stack>
