...
export default function PlasmacytomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Plasmacytoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Plasmacytoma refers to a tumor consisting of abnormal plasma cells that grow within the soft tissue or bony skeleton. It can be present as a discreet solitary mass of abnormal plasma cells, in which case it is termed a “solitary” plasmacytoma or it can be present as part of myeloma. The prognosis and treatment of solitary plasmacytomas are very different from myeloma. Plasma cells are a type of white blood cell that develops from mature B-lymphocytes in the bone marrow. They play an important role in protecting the body against infection and disease by producing proteins called immunoglobulins (Ig), also known as antibodies.
                    </p>
                </Stack>
