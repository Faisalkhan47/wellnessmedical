...
export default function OralCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Oral Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Oral cavity cancer starts in the mouth. It might also be called oral cancer. Oropharyngeal cancer starts in the middle part of the throat just behind the oral cavity which can be seen when the mouth is open. The oral cavity incorporates the lips, within the coating of the lips and cheeks (buccal mucosa), the teeth, the gums, the front 66% of the tongue, the floor of the mouth underneath the tongue, the hard top of the mouth (hard sense of taste) and the region behind the astuteness teeth (called the retromolar trigone). The oropharynx is the centerpiece of the throat simply behind the oral cavity. It very well may be seen when your mouth is totally open. It incorporates the base of the tongue (the back third of the tongue), the soft palate (the back part of the top of the mouth), the tonsils, and the side and back walls of the throat.
                    </p>
                </Stack>
