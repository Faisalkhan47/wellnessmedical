...
export default function ChronicMyelogenousLeukemiaTreatmentinIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Chronic Myelogenous Leukemia Treatment in India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The bone marrow and blood are both affected by chronic myeloid leukemia, also known as chronic myelogenous leukemia. It is characterized by the uncontrolled growth of abnormal white blood cells in the bone marrow, which gradually infiltrate the blood.
                    </p>
                </Stack>
