            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Cancer Treatment in India encompasses methods like chemotherapy, radiation therapy, medication therapy, and surgery to cure, treat, control, or reduce cancer symptoms. With the help of chemotherapy, radiation, and surgery, Cancer Treatment can kill the cancer cells in a specific body area. Cancer Treatment can also control cancer spread or cause damage to the cancerous cells and prevent them from returning.
                    </p>
                </Stack>
