...
export default function ColorectalCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Colorectal Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Colorectal cancer, also called large bowel cancer, is the term used to describe malignant tumors found in the colon and rectum. The colon and rectum are part of the large intestine of the digestive system, usually referred to as the gastrointestinal tract. Typically, the colon is the upper 5 or 6 feet of the large intestine, and the rectum is the lower 5 to 7 inches located above the anal canal. Understanding colorectal cancer, it helps to know the normal structure and function of the colon and rectum. The colon and rectum make up the large intestine (or large bowel), which is part of the digestive system, also called the gastrointestinal (GI) system (see illustration below).
                    </p>
                </Stack>
