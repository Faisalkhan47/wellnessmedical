...
export default function TreatmentforParaneoplasticSyndromes() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Treatment for Paraneoplastic Syndromes</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A paraneoplastic syndrome is a set of signs and symptoms that occur in people with a cancerous tumor. They develop when a malignant tumor releases a substance (hormone/protein) that affects a certain body system or when the body’s immune system releases a substance (antibody) meant to kill the tumor but also damages healthy body cells (autoimmune response). Depending on which part of the body these substances affect, they can damage brain and muscle functions. In many cases, if the symptoms are recognized as paraneoplastic syndrome early, it can help the doctor find malignant (cancerous) tumors in an early stage when they are most treatable.
                    </p>
                </Stack>
