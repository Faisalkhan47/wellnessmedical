...
export default function NasopharyngealCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Nasopharyngeal Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Nasopharyngeal carcinoma is cancer that happens in the nasopharynx, which is situated behind your nose or the rear of your throat. Nasopharyngeal carcinoma is hard to identify early. That is most likely in light of the fact that the nasopharynx isn't difficult to analyze and indications of nasopharyngeal carcinoma mimic those of other, more normal conditions. The nasopharynx is the upper piece of the throat (pharynx) that lies behind the nose. It's a case-like chamber about 1½ inches on each edge. It lies simply over the delicate piece of the top of the mouth (delicate sense of taste) and simply toward the rear of the nasal passages. The nasopharynx fills in as a way for air to go from the nose to the throat (and afterward on to the lungs).
                    </p>
                </Stack>
