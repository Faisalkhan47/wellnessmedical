...
export default function ColonCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Colon Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Colon cancer is a type of cancer that begins in the large intestine (colon). The colon is the final part of the digestive tract. It ordinarily influences more established grown-ups. However, it can occur at whatever stage in life. It generally starts as little, noncancerous (considerate) bunches of cells considered polyps that structure within the colon. Over the long run, a portion of these polyps can become colon malignant growths. Polyps might be little and produce scarcely any, side effects. Therefore, specialists prescribe customary screening tests to assist with forestalling colon malignant growth by distinguishing and eliminating polyps before they transform into disease. In the event that colon malignancy creates, numerous therapies are accessible to assist with controlling it, including a medical procedure, radiation treatment, and medication therapies, like chemotherapy, designated treatment, and immunotherapy.
                    </p>
                </Stack>
