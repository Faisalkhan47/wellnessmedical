...
export default function GermCellTumorTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Germ Cell Tumor (GCT) Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Germ cell tumors are thought to develop from primordial germ cells. These are a type of stem cell in an embryo that has begun to form into either sperm or eggs and will develop further after the child has been born and then reached puberty. These cells can start to grow in an abnormal way, giving rise to germ cell tumors that usually occur in the testis or ovary, referred to as ‘gonadal’ germ cell tumors. Unfortunately, rather than gathering in the testicle or ovary as they should do, some germ cells can be left behind in other parts of the body, such as the mediastinum (chest), retroperitoneum (abdomen) and the central nervous system or CNS (brain or spinal cord). Therefore germ cell tumors can also occur at these sites and are referred to as ‘extragonadal’ (meaning outside of testes or ovaries) germ cell tumors.
                    </p>
                </Stack>
