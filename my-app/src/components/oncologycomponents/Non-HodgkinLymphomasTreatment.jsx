...
export default function NonHodgkinLymphomasTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Non-Hodgkin Lymphomas Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Cancer starts when cells begin to grow out of control. Cells in nearly any part of the body can become cancer and can spread to other areas. Non-Hodgkin lymphoma (otherwise called non-Hodgkin's lymphoma, NHL, or once in a while lymphoma) is cancer that begins in white blood cells called lymphocytes, which are an important part of the body’s immune system. NHL is a term that is utilized for a wide range of lymphoma that all offer a portion of similar attributes. There is another principle kind of lymphoma, called Hodgkin lymphoma, which is treated differently. NHL regularly influences grown-ups, yet kids can get it as well. NHL for the most part begins in lymph nodes or other lymph tissue. However, it can in some cases influence the skin.
                    </p>
                </Stack>
