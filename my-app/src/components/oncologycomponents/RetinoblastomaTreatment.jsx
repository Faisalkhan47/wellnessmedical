...
export default function RetinoblastomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Retinoblastoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Retinoblastoma is a cancer that beginnings in the retina, the exceptional back piece of the eye. It is the most normal kind of eye cancer in kids. Infrequently, youngsters can have different sorts of eye cancer, for example, medulloepithelioma, which is depicted momentarily beneath, or visual (eye) melanoma. The eyes begin to foster well before birth. During the beginning phases of advancement, the eyes have cells called retinoblasts, which increase to make new cells that fill the retina. At one point, these cells quit duplicating and become experienced retinal cells. Rarely, something turns out badly with this cycle. Rather than developing, some retinoblasts keep on outgrowing control, framing cancer known as retinoblastoma.
                    </p>
                </Stack>
