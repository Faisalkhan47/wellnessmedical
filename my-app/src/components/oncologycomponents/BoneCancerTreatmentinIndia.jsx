...
export default function BoneCancerTreatmentinIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Bone Cancer Treatment in India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The formation of tumors or malignant lumps inside the bones is referred to as bone cancer and is caused by the aberrant and unchecked proliferation of cells in the bone tissue. Two types of bone cancer are primary bone cancer, which starts inside the bone and secondary bone cancer, which spreads to the bones from other parts of the body.
                    </p>
                </Stack>
