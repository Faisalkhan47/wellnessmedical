...
export default function SickleCellTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Sickle Cell Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                        There is no cure for sickle cell disease, but there are treatments that can help manage the disease and its complications. Treatments include:
                        Bone marrow transplants
                        Also known as stem cell transplants, this procedure replaces unhealthy bone marrow cells with healthy ones from a donor. It's only appropriate for some patients with severe sickle cell disease and a closely matched donor.
                        Blood transfusions
                        Red blood cell transfusions can treat serious anemia complications, and can also be used before surgery.
                        Medications
                        Pain relievers, hydroxyurea (Hydrea), and other medications can help relieve pain and prevent complications.
                        L-glutamine
                        This supplement can help reduce damage to red blood cells.
                        Phosphodiesterase type 5 (PDE5) inhibitors
                        These agents can treat pulmonary hypertension and priapism associated with sickle cell disease.
                        Gene therapy
                        Casgevy is a gene therapy that uses CRISPR technology to boost levels of fetal hemoglobin.
                    </p>
                </Stack>
