...
export default function AngiosarcomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Angiosarcoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Angiosarcoma is a rare type of cancer that forms in the lining of the blood vessels and lymph vessels. Your lymph vessels, which are part of your immune system, collect bacteria, viruses, and waste products from your body and dispose of them. Angiosarcoma can occur anywhere in your body, but it most often occurs in the skin on your head and neck. Rarely, angiosarcoma may form in the skin on other parts of your body, such as the breast. Or it may form in deeper tissue, such as the liver and the heart. Angiosarcoma can occur in areas previously treated with radiation therapy.
                    </p>
                </Stack>
