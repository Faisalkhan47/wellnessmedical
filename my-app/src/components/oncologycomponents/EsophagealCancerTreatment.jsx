...
export default function EsophagealCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Esophageal Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Esophageal cancer is cancer that occurs in the esophagus a long, hollow tube that runs from your throat to your stomach. Your esophagus helps move the food you swallow from the back of your throat to your stomach to be digested. Esophageal cancer normally starts in the cells that the inside of the esophagus. Esophageal cancer can happen anyplace along the esophagus. A greater number of men than females get esophageal cancer. Esophageal cancer is the 6th most common cause of cancer deaths worldwide. Rate rates fluctuate inside various geographic areas. In some regions, higher paces of esophageal cancer might be ascribed to tobacco and alcohol use or specific healthful propensities and weight.
                    </p>
                </Stack>
