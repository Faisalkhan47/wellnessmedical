...
export default function GestationalTrophoblasticDiseaseTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Gestational Trophoblastic Disease (GTD) Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Gestational trophoblastic disease (GTD) is a term that refers to a group of rare tumors that occur in early pregnancy. After conception, a woman’s body prepares for pregnancy by surrounding the newly fertilized egg or embryo with a layer of cells called the trophoblast. The trophoblast helps the embryo implant itself into the uterine wall. These cells also form a large part of the tissue that makes up the placenta the organ that supplies nutrients to a developing fetus. In GTD, there are abnormal changes in the trophoblast cells that cause tumors to develop.
                    </p>
                </Stack>
