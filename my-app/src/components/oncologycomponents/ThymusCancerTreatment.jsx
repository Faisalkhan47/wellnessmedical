...
export default function ThymusCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Thymus Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Thymoma is a tumor of the thymus gland or thymic tissue—a small organ located in the upper portion of your chest (also called mediastinum), extending from the base of the throat to the front of the heart. The thymus gland is important for your immune system and secretes chemicals that empower T-cells (infection battling cells) to work against sickness causing organisms. Thymomas are malignant tumors that emerge in the thymus gland, commonly in the front mediastinum. However, considered threatening, most thymomas develop gradually and will in general spread just locally, by seeding cells into encompassing tissues and spaces like the pleural space (the space encompassing every lung).
                    </p>
                </Stack>
