...
export default function OsteosarcomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Osteosarcoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Osteosarcoma is a type of bone cancer that usually develops in the osteoblast cells that form bone. It happens most often in children, adolescents, and young adults. Osteosarcoma most commonly happens in the long bones around the knee. Other sites for osteosarcoma include the upper leg, or thighbone, the lower leg, the upper arm bone, or any bone in the body, including those in the pelvis, shoulder, and skull. Osteosarcoma may grow into nearby tissues, such as tendons or muscles. It may also spread, or metastasize, through the bloodstream to other organs or bones in the body.
                    </p>
                </Stack>
