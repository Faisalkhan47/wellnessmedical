...
export default function VaginalCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Vaginal Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Vaginal cancer is rare cancer that occurs in the vagina the muscular tube that connects the uterus with the outer genitals. Vaginal cancer usually happens in the cells that line the outside of your vagina, which is in some cases called the birth canal. While a few sorts of cancer can spread to your vagina from different spots in your body, cancer that starts in your vagina is uncommon.
                    </p>
                </Stack>
