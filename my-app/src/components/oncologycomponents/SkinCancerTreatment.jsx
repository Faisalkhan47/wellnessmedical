...
export default function SkinCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Skin Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Skin cancer is the abnormal growth of skin cells most often develops on skin exposed to the sun. But this common form of cancer can also occur on areas of your skin not ordinarily exposed to sunlight. There are three significant kinds of skin disease basal cell carcinoma, squamous cell carcinoma, and melanoma. You can diminish your danger of skin malignant growth by restricting or staying away from openness to ultraviolet (UV) radiation. Checking your skin for suspicious changes can assist with recognizing skin malignant growth at its soonest organizes. Early detection of skin cancer gives you the greatest chance for successful skin cancer treatment.
                    </p>
                </Stack>
