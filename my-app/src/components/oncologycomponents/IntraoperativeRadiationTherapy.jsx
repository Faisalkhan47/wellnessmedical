...
export default function IntraoperativeRadiationTherapy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Intraoperative Radiation Therapy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Intraoperative radiation therapy (IORT) is an intensive radiation treatment that's administered during surgery. IORT allows direct radiation to the target area while sparing normal surrounding tissue. IORT is used to treat cancers that are difficult to remove during surgery and when there is a concern that microscopic amounts of cancer may remain. The type of IORT most commonly used at Mayo Clinic is also called intraoperative electron radiation therapy. IORT is often combined with conventional radiation therapy, which is usually administered before surgery.
                    </p>
                </Stack>
