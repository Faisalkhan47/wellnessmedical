            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Radiotherapy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Radiation therapy uses high-energy particles or waves, such as x-rays, gamma rays, electron beams, or protons, to destroy or damage cancer cells. Your cells regularly develop and gap to frame new cells. However, malignancy cells develop and partition quicker than most typical cells. Radiation works by making little breaks in the DNA inside cells. These breaks hold malignancy cells back from developing and isolating and cause them to kick the bucket. Close by typical cells can likewise be influenced by radiation, yet most recuperate and return to working the manner in which they ought to. While chemotherapy and different therapies that are taken by mouth or infusion ordinarily uncover the entire body to disease battling drugs, radiation treatment is typically a nearby therapy.
                    </p>
                </Stack>
