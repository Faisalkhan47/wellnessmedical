...
export default function RhabdomyosarcomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Rhabdomyosarcoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Rhabdomyosarcoma (RMS) is a rare type of cancer that forms in soft tissue specifically skeletal muscle tissue or sometimes hollow organs such as the bladder or uterus. RMS can happen at whatever stage in life, yet it frequently influences kids. The outlook and treatment choices rely upon the sort of rhabdomyosarcoma, where it begins, tumor size, and regardless of whether cancer has spread. Treatment is normally finished with a mix of a medical procedure, chemotherapy, and radiation therapy.
                    </p>
                </Stack>
