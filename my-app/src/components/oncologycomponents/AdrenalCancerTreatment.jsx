...
export default function AdrenalCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Adrenal Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Adrenal cancer is a rare cancer that begins in one or both of the small, triangular glands (adrenal glands) located on top of your kidneys. Adrenal glands produce hormones that offer directions to for all intents and purposes each organ and tissue in your body. It is additionally called adrenocortical cancer, and it can happen at whatever stage in life. In any case, it's well on the way to affect children younger than 5 and adults in their 40s and 50s.
                    </p>
                </Stack>
