...
export default function ParanasalSinusandNasalCavityCancerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Paranasal Sinus and Nasal Cavity Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Nasal cavity and paranasal sinus cancers are kinds of head and neck cancers. Head and neck cancers can have a wide range of names relying on where the cancer begins. Cancer begins when cells in the body start to outgrow control. Nasal cavity cancers start in the opening behind the nose Paranasal sinus cancers start noticeable all around occupied spaces in the skull around or close to the nose The two sorts are covered here on the grounds that these 2 constructions are near one another. The nose opens into the nasal cavity. This cavity is a space that runs along with the highest point of the top of the mouth (the sense of taste, what isolates your nose from your mouth) and afterward turns somewhat descending to join the nasopharynx (the upper piece of the throat). Sinuses are little air-occupied spaces in the bones that are associated with the nasal cavity. They are called paranasal on the grounds that they are around the nose.
                    </p>
                </Stack>
