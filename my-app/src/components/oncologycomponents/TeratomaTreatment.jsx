...
export default function TeratomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Teratoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A teratoma is a sort of cancer that contains at least one of the three layers of cells found in a developing baby (embryo). These cells are called germ cells. A teratoma is one kind of germ cell cancer. The mediastinum is situated inside the front of the chest in the space that separates the lungs. The heart, large blood vessels, windpipe, thymus gland, and esophagus are found there.
                    </p>
                </Stack>
