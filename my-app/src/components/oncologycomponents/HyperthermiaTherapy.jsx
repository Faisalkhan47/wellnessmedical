...
export default function HyperthermiaTherapy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hyperthermia Therapy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Hyperthermia is usually understood to mean a higher than normal body temperature. Hyperthermia is often caused by illnesses such as fever and heat stroke. However, hyperthermia can also refer to heat treatment, which is the carefully controlled use of heat for medical purposes. Here we focus on how heat is used to treat cancer. When cells in the body are exposed to temperatures higher than normal, changes occur within the cells. These changes make the cells more likely to be affected by other treatments such as radiotherapy and chemotherapy. Very high temperatures can kill cancer cells completely (thermal ablation), but they can also damage or kill normal cells and tissue. Must be carefully supervised and controlled by a physician.
                    </p>
                </Stack>
