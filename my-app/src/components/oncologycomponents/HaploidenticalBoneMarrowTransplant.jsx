...
export default function HaploidenticalBoneMarrowTransplant() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Haploidentical Bone Marrow Transplant</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A haploidentical transplant is a form of allogeneic transplant that involves utilizing blood-forming cells from a half-matched donor to replace unhealthy ones. Typically, the donor is a family member. When seeking an allogeneic transplant, medical professionals determine your HLA( human leukocyte antigen ) type by testing your blood. HLA is a protein or marker present in most cells of your body. Medical professionals search for a donor or umbilical cord blood that is a close match to your HLA. However, if a close HLA match cannot be found, a haploidentical transplant may be considered. In this type of allogeneic transplant, the donor matches precisely half of your HLA.
                    </p>
                </Stack>
