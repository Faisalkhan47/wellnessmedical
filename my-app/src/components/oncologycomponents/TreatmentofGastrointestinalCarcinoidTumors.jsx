...
export default function TreatmentofGastrointestinalCarcinoidTumors() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Gastrointestinal Carcinoid Tumors</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A gastrointestinal (GI) carcinoid tumor also referred to as a gastrointestinal endocrine tumor is a kind of cancer that develops in the covering of the gastrointestinal (digestive) tract. Part of the body's digestive system, the gastrointestinal plot digests food sources and retains supplements prior to passing waste material out of the body. GI carcinoid tumors structure when neuroendocrine cells, which assist with controlling digestive juices and the muscles that work with absorption, develop and partition wildly. These tumors might be found in numerous components of the gastrointestinal tract, including the stomach, informative supplement, small intestine and rectum.
                    </p>
                </Stack>
