...
export default function SurgicalOncologyTreatmentinIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Surgical Oncology Treatment in India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A specialist area of medicine called surgical oncology is dedicated to the surgical treatment of cancer. It involves the diagnosis, staging, and treatment of various types of cancer through surgical procedures. Surgical oncologists are surgeons who have received additional training and expertise in the surgical management of cancer.
                    </p>
                </Stack>
