            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Breast Cancer Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    In the modern world, a variety of treatments exist for breast cancer, and the most important thing, treatment is available for every stage of cancer. In most cases, a patient needs a combination of two or more treatments. When doctors check your past medical reports and then they will suggest some tests and after the diagnosis of cancer, the doctor will determine what is the stage of breast cancer. And then they will decide which treatment or surgery is required for the patient like family history, genetic mutation status, age, and other factors. Breast cancer affects women's health all over the world.
                    </p>
                </Stack>
