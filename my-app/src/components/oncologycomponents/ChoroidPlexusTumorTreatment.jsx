...
export default function ChoroidPlexusTumorTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Choroid Plexus Tumor Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A choroid plexus carcinoma is a rare cancerous (malignant) brain tumor that occurs mainly in children. A choroid plexus carcinoma begins near the brain tissue that secretes cerebrospinal fluid. A noncancerous tumor of this area is called a choroid plexus papilloma. As the tumor grows, it can affect the function of nearby structures in the brain, causing excess fluid in the brain (hydrocephalus), irritability, nausea or vomiting, and headaches. Treatment and chance of recovery (prognosis) depend on the tumor's size, location, whether it has spread, and your child's age and general health.
                    </p>
                </Stack>
