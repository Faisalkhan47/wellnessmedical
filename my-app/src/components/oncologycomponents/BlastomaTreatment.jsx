...
export default function BlastomaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Blastoma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    All cells have a day-to-day existence cycle. They exist for a specific measure of time, and afterward, they pass on. The body's cells are continually re-establishing themselves. Cancer cells are ones that don't die in the bucket at the regular time in their life cycle. All things being equal, they develop wildly, spreading and causing tissue harm. Blastoma is a cancer that affects a type of stem cell known as a precursor cell in a fetus. A precursor cell is one that can become any type of body cell. A developing baby that is not yet born has more precursor cells than an adult because the body is still forming. For this reason, blastoma is most common in children.
                    </p>
                </Stack>
