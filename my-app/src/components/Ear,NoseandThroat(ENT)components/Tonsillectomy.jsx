...
export default function Tonsillectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Tonsillectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Tonsillectomy is the term for the removal of tonsils. The procedure is done to treat sleeping problems and prolonged infections. Tonsils are present at the back of your throat. They are a part of the body’s immune system but removing them does not increase your risk of catching infections.
                    </p>
                </Stack>
