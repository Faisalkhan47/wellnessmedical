...
export default function PediatricTongueTieSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Pediatric Tongue-Tie Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    For many children, a minor procedure termed a frenotomy is a successful treatment. This technique is frequently performed in the office by a healthcare physician. The frenulum is severed by the provider. This allows the tongue to move freely.
                    </p>
                </Stack>
