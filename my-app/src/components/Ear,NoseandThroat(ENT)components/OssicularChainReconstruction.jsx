...
export default function OssicularChainReconstruction() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Ossicular Chain Reconstruction</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Ossicular chain reconstruction will improve conducting of a hearing. It's additionally known as tympanum bone surgery. It is done to switch a broken auditory ossicle or anvil bone. Throughout surgery, you'll be administered local anesthesia with sedation. Otherwise, you could have general anesthesia.
                    </p>
                </Stack>
