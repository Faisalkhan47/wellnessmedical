...
export default function Stapedectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Stapedectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A stapedectomy is a surgery to remove a small bone, called the stapes, from the middle ear. The middle ear contains three bones: the stapes, the incus, and the malleus. These bones help with hearing.
                    </p>
                </Stack>
