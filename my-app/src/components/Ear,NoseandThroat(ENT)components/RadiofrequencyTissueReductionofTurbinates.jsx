...
export default function RadiofrequencyTissueReductionofTurbinates() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}> Radiofrequency Tissue Reduction of Turbinates</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Radiofrequency turbinate reduction (RFTR) is a minimally invasive surgical option that can reduce tissue volume in a precise, targeted manner. This technique uses electrical currents in the range of radiofrequency waves to produce heat around the electrode, thereby creating lesions within the submucosal tissue of the turbinate.
                    </p>
                </Stack>
