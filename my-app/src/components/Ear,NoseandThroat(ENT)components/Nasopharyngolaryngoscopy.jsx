...
export default function Nasopharyngolaryngoscopy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}> Nasopharyngolaryngoscopy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Nasopharyngolaryngoscopy is a painless and risk-free treatment that involves passing a thin, flexible endoscope through your nose to allow your doctor to examine the insides of your nose, throat, and voice box.
                    </p>
                </Stack>
