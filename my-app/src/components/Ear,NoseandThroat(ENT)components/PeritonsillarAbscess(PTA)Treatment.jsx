...
export default function PeritonsillarAbscessPTATreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Peritonsillar Abscess (PTA) Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    In otolaryngology emergencies, peritonsillar abscess (PTA) is a widespread condition. PTA is generally treated with antibiotics and either bedside drainage or surgical excision of the tonsils (Quincy tonsillectomy). Patients with immunological suppression, on the other hand, may face a more challenging therapeutic path.
                    </p>
                </Stack>
