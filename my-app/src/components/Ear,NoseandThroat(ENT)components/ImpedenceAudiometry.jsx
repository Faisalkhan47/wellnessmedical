...
export default function ImpedenceAudiometry() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Impedance Audiometry</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The pressure in the middle ear, stapedius reflexes, and tympanic membrane tension are all measured using impedance audiometry. It's one of the most popular and reliable ways to check your middle ear.
                    </p>
                </Stack>
