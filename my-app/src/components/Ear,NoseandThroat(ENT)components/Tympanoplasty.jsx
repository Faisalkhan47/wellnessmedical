            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Tympanoplasty</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A hole in the tympanum or "perforated eardrum" can develop from a bad ear infection; a surgical method, such as installation of an ear tube; or from injury, such as sticking something inside the ear canal. Although some damages heal on their own, if they last for more than 3 months without contamination or drainage, they are dubious to close by themselves. The decision on how to surgically close a perforation depends on a variety of factors, including the patient’s age, and the size and location of the eardrum hole. Common surgery for repairing a hole in the tympanum is called a tympanoplasty. The hole is patched with a graft of the patient’s own tissue, either a connective tissue called fascia or perichondrium that comes from underneath the skin.
                    </p>
                </Stack>
