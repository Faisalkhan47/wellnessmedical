...
export default function Dacryocystorhinostomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Dacryocystorhinostomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A dacryocystorhinostomy (DCR) is a procedure that establishes a new drainage route for tears between your eyes and nose. If your tear duct becomes clogged, surgery may be required.
                    </p>
                </Stack>
