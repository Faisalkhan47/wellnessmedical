...
export default function Mastoidectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Mastoidectomy
                    </h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A mastoidectomy is a surgical treatment that removes pathological mastoid air cells. The mastoid is a part of the skull set behind your ear. It's crammed with air cells made from bone and appears sort of like a honeycomb. The pathological cells are usually the result of an ear infection that has to unfold into your skull. The procedure may take away an abnormal growth of the ear referred to as a cholesteatoma.
                    </p>
                </Stack>
