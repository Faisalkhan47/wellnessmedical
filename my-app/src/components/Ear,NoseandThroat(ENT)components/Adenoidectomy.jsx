...
export default function Adenoidectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Adenoidectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An adenoidectomy, or adenoid removal, is surgery to get rid of the adenoid glands. The adenoids shield the body from viruses and bacteria; they often become swollen and enlarged or inveterately infected. This could result in infections, allergies, or alternative reasons.
                    </p>
                </Stack>
