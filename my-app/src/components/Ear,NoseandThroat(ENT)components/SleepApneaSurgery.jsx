...
export default function SleepApneaSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Sleep Apnea Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Sleep apnea is a variety of sleep disruptions that will have serious health consequences. It causes your respiratory activities to stop when you're sleeping sporadically. This is often associated with the comfort of the muscles in your throat. After you stop respiratory activities, your body sometimes wakes up, inflicting you to lose out on quality sleep. Over time, sleep disorders will increase your risk of developing high-pressure levels, metabolic problems, and different health issues. Therefore it's vital to treat it. If nonsurgical treatments don't facilitate, you'll like surgery.
                    </p>
                </Stack>
