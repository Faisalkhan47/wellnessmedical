...
export default function Glossectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}> Glossectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A glossectomy is a procedure that involves removing part or all of the tongue. Cancers of the tongue, some oral cavity (inside the mouth), and the throat can all be treated with it. Tasting, swallowing, breathing, licking, and speaking are all fun.
                    </p>
                </Stack>
