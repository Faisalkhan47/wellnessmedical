...
export default function Uvulopalatoplasty() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Uvulopalatoplasty</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Uvulopalatoplasty is a surgical technique to treat snoring that reduces or eliminates snoring. It's an outpatient treatment that involves removing portions or all of the uvula at the back of the mouth with a laser. Three to five visits are generally required, each lasting less than 30 minutes.
                    </p>
                </Stack>
