...
export default function NasalObstructionTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Nasal Obstruction Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Nasal obstruction is a sign of an underlying condition that causes the nasal passages to be clogged or obstructed, rather than a disease. Enlarged adenoids and nasal allergies are two of the most prevalent reasons in youngsters. Nasal polyps, tumors, and congenital abnormalities of the nose are less common causes of nasal obstructions.
                    </p>
                </Stack>
