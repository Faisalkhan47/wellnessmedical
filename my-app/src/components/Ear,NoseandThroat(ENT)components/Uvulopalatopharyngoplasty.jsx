...
export default function Uvulopalatopharyngoplasty() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Uvulopalatopharyngoplasty</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Uvulopalatopharyngoplasty (UPPP) is a methodology that eliminates excess tissue in the throat to make the aviation route more extensive. This occasionally can permit air to travel through the throat all the more effectively when you inhale, lessening the seriousness of obstructive rest apnea (OSA). On the off chance that a broadened tongue is a factor in your rest apnea, the specialist might eliminate a little piece of the tongue. This is called an uvulopalatopharyngoglossoplasty.
                    </p>
                </Stack>
