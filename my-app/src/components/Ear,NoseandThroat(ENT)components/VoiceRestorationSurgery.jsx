...
export default function VoiceRestorationSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}> Voice Restoration Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Voice restoration surgery is the most well-known approach to restoring speech after a medical procedure. After a medical procedure to eliminate the entire of your voice box (total laryngectomy), you are as of now not ready to talk in a typical manner. Be that as it may, there are various ways you can convey and figure out how to talk and speak again.
                    </p>
                </Stack>
