            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Myringotomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A myringotomy is generally a procedure to make a hole within the tympanic membrane or the eardrum to permit fluid that's cornered within the tympanum to empty. The liquid could also be blood, pus, and water. In several cases, a tiny low tube is inserted into the outlet within the tympanic membrane to maintain the drain.
                    </p>
                </Stack>
