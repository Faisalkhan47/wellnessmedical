...
export default function LaryngealSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Laryngeal surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Laryngeal surgery is employed to treat patients with vocal fold dysfunction or speech organ pathology to revive the initial form of their voice box. It can also be accustomed to treating people with cancer, a surgery that causes nerve harm or trauma to the voice box.
                    </p>
                </Stack>
