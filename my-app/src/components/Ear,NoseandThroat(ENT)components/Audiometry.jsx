            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Audiometry</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An audiometry examination tests your ability to listen to sounds. Sounds vary, supported by their loudness (intensity) and the speed of undulation vibrations (tone). Hearing happens once sound waves stimulate the nerves of the labyrinth. They will conjointly undergo the bones around and behind the ear (bone conduction).
                    </p>
                </Stack>
