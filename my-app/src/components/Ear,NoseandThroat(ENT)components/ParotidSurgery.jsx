...
export default function ParotidSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Parotid Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Parotidectomy is used to treat parotid gland cancers and, on rare occasions, persistent infections. Surgery is frequently curative for benign and low-grade malignant tumors, with no need for future treatment. Surgery is generally followed by radiation therapy for other malignant tumors.
                    </p>
                </Stack>
