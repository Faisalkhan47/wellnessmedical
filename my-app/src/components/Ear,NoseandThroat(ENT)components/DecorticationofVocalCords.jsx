...
export default function DecorticationofVocalCords() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}> Decortication of Vocal Cords</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Decortication of vocal cords is the procedure of removing damaged mucosa from the vocal cords. Loss of vocal range, a raw feeling in the back of the throat, hoarseness, trouble breathing, and a constant need to clean the throat are all symptoms of vocal cord dysfunction.
                    </p>
                </Stack>
