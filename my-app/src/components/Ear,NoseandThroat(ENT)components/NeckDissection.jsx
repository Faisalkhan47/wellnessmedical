...
export default function NeckDissection() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Neck Dissection</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Neck dissection is a surgery done to get rid of bodily fluid nodes that contain cancer. It's usually done in the hospital. Before surgery, you'll receive anaesthesia. This would cause you to sleep and be unable to feel pain.
                    </p>
                </Stack>
