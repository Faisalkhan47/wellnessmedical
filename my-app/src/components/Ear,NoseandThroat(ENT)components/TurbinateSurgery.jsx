...
export default function TurbinateSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Turbinate Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Turbinate surgery, or inferior turbinate reduction, is a procedure in which the inferior nasal turbinates are examined and reduced in size to supply improved nasal flow of air. Surgery is usually performed through the nostrils on either side of the nose.
                    </p>
                </Stack>
