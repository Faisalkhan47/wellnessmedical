...
export default function NasalPolypsRemoval() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Nasal Polyps Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Nasal polyps are fleshy swellings that develop within the lining of the nose and cavity sinuses, the entire areas connected to the cavity. They're noncancerous growths. Polyps vary in size; they'll be yellowish-brown or pink and are formed like teardrops. As they grow, they eventually appear as grapes on a stem. Polyps could produce in one or each nostril at an equivalent time; they'll grow on their own or in clusters. Large polyps or clusters will cause respiration difficulties and might affect the patient's sense of smell. They'll block the sinuses and cause issues, like chronic infections.
                    </p>
                </Stack>
