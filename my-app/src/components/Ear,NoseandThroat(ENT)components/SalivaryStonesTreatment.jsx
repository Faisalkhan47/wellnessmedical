...
export default function SalivaryStonesTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Salivary Stones Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Salivary stones, commonly known as sialolithiasis, are mineral deposits that occur in the salivary glands and are hardened. Salivary stones are more common in males than in women, and they afflict adults between the ages of 30 and 60.
                    </p>
                </Stack>
