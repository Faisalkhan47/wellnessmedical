...
export default function BoneAnchoredHearingAid() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Bone-Anchored Hearing Aid (BAHA)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Sometimes, hearing aids are not the best option for people with loss of hearing, and bone-anchored hearing systems are suggested as a more suitable option. Yet, multiple people aren't aware of their work and their existence. Unlike hearing aids, bone-anchored hearing systems are surgically implanted devices. They treat hearing loss through bone conduction of sound vibrations to the inner ear—this is in contrast to regular hearing aids, which amplify acoustic sounds that enter the ear canal. For this reason, bone-anchored systems are regarded as specialty devices for some hearing loss conditions.
                    </p>
                </Stack>
