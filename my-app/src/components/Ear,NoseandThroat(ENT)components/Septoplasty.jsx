...
export default function Septoplasty() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Septoplasty</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Septoplasty is a surgery that operates on a crooked nose. A crooked nose can be due to a deviated septum. It helps to have a better airflow through the nose and may improve one’s breathing quality. It is usually counted under an Out-Patient Procedure, which means you can go home right after your surgery is finished.
                    </p>
                </Stack>
