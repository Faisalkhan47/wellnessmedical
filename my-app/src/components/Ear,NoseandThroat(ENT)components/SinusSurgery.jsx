...
export default function SinusSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Sinus Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Sinus issues are usually treated with medication over surgeries. Sinus surgery may be required when those infections are chronic or resolute. Sinus surgery is most commonly used to treat persistent sinusitis (inflammation of the nose and sinuses) but may be needed for other sinus problems. Surgery involves expanding the openings between the sinuses and the inside of the nose so air can get in and drainage can get out. It may involve removing infected sinus tissue, bone, or polyps. Modern sinus surgery has less post-surgical bleeding, is less invasive, and involves a shorter recovery time than sinus surgery in the past.
                    </p>
                </Stack>
