...
export default function SalivaryGlandTumorRemoval() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Salivary Gland Tumor Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The whole gland is removed (excision) during surgery for tumors in the sublingual gland. The sublingual glands are located beneath your tongue on each side of your mouth's floor. To remove the gland and some of the surrounding tissue, your surgeon will cut (surgical incision) within your mouth.
                    </p>
                </Stack>
