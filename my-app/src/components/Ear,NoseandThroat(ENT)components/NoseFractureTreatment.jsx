...
export default function NoseFractureTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Nose Fracture Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A broken nose, also known as a nasal fracture, is a break or split in one of your nose's bones, most commonly the bone above the bridge. Contact sports, physical conflicts, falls, and motor vehicle accidents that result in facial trauma are all common causes of a broken nose. Swelling and bruises around the nose and beneath the eyes are common symptoms of a broken nose. It's possible that your nose is crooked, and you're having problems breathing. Procedures to straighten your nose may be used to treat a fractured nose. A fractured nose normally does not necessitate surgery.
                    </p>
                </Stack>
