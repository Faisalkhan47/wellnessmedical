        ...
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Angiography involves the injection of a contrast agent or dyes into the blood vessels to visualize the internal structures of the blood vessels, such as arteries, veins, and capillaries. The contrast agent makes the blood vessels visible on X-ray images allowing doctors to detect abnormalities, blockages, or other issues.</p>
                </Stack>
