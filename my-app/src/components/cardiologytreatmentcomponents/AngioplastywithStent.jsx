...
export default function AngioplastywithStent() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Angioplasty with Stent</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Angioplasty is a process that is used to open blocked coronary arteries produced by coronary artery disease. It brings back blood flow to the heart muscle without heart surgery. Angioplasty is done in an urgent setting, such as a heart attack. Another name for Angioplasty is percutaneous coronary intervention.</p>
                </Stack>
