...
export default function KeshanDiseaseTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Keshan Disease Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Keshan disease, endemic cardiomyopathy occurring in low-selenium areas and it is associated with low selenium intake and low blood and hair levels and affects mainly children and women of childbearing age.
                    </p>
                </Stack>
