...
export default function DoubleValveReplacementSecond() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Double Valve Replacement (DVR)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A double valve replacement refers to the surgical procedure of replacing both the mitral and aortic valves, which effectively replace the entire left side of the heart. While less common than other types of valve replacements, this procedure carries a slightly higher mortality rate.
                    </p>
                </Stack>
