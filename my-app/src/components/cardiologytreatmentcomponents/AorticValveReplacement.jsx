...
export default function AorticValveReplacement() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Aortic Valve Replacement (Tissue Implant)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Aortic valve replacement is a treatment for people who experience signs and symptoms like chest pain, shortness of breath, and fatigue. It may also be suggested for people with severe valve damage due to infection or congenital heart defects. In this process, a surgeon detaches the aortic valve and replaces it with a valve made from cow, pig, or human heart tissue.
                    </p>
                </Stack>
