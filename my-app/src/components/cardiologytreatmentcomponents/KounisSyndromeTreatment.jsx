...
export default function KounisSyndromeTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Kounis Syndrome Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Kounis Syndrome (KS) has been defined as an acute coronary syndrome with or without the presence of underlying coronary artery disease, showing as unstable vasospastic/non-vasospastic angina or acute myocardial infarction. It is triggered by mediators released from mast cells and activated from allergic, hypersensitivity, or anaphylactoid reactions.
                    </p>
                </Stack>
