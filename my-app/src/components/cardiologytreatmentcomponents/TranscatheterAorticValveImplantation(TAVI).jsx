...
export default function TranscatheterAorticValveImplantation() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}> Transcatheter Aortic Valve Implantation (TAVI)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Transcatheter aortic-valve implantation (TAVI) is a new procedure, in which a bioprosthetic valve is inserted through a catheter and implanted within the diseased native aortic valve. Since 2002, when the procedure was first performed,20,21 there has been rapid growth in its use throughout the world for the treatment of severe aortic stenosis in patients who are at high surgical risk. In India, a lot of domestic and international patients have approached this particular treatment. GoMedii with the best cardiologists in the country on their panel does provide the patient a successful and affordable option.
                    </p>
                </Stack>
                <Stack sx={{ marginLeft: '5rem', marginTop: '2rem', width: '50%' }}>
                    <div>
                        <h2>About</h2>
                        <p>Aortic valve replacement is a treatment for people who experience signs and symptoms like chest pain, shortness of breath, and fatigue. It may also be suggested for people with severe valve damage due to infection or congenital heart defects. A surgeon detaches the aortic valve and replaces it with a mechanical valve or a valve made from cow, pig, or human heart tissue.</p>
                    </div>
                    <div>
