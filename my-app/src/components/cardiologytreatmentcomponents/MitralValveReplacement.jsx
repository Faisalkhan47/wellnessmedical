            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Mitral Valve Replacement (MVR)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Mitral valve replacement is a surgery recommended for those people whose blood flow through the heart is not working properly. The poorly working Mitral Valve will be replaced with an artificial valve, ensuring that blood can flow into the left ventricle and then out to the body normally.
                    </p>
                </Stack>
