...
export default function OpenHeartSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Open Heart Surgery (Pediatric)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Open-heart surgery in pediatric patients refers to a surgical procedure that involves accessing the heart through an incision in the chest to repair structural problems in the heart. Infants and children with genetic heart defects or other heart diseases requiring medical attention often need this type of surgery. Pediatric open-heart surgery is a complex procedure that requires specialized training and expertise. The surgical team typically includes a pediatric cardiac surgeon, anesthesiologists, nurses, and other healthcare professionals.
                    </p>
                </Stack>
