...
export default function AorticStenosisTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}> Aortic Stenosis Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Aortic stenosis is one of the most common and serious valve disease problems. Aortic stenosis is a narrowing of the aortic valve opening. Aortic stenosis limits the blood flow from the left ventricle to the aorta and may likewise influence the pressing factor in the left atrium. In some people who have aortic stenosis due to a congenital heart defect called a bicuspid aortic valve, this condition all the more generally develops during maturing as calcium or scarring harms the valve and limits the measure of blood flow through.
                    </p>
                </Stack>
