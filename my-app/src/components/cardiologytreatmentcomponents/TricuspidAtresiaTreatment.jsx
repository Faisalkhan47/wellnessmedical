...
export default function TricuspidAtresiaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Tricuspid Atresia Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Tricuspid atresia is a congenital heart defect that occurs when the tricuspid valve of the heart is not properly formed. Tricuspid atresia is a heart defect present at birth in which a valve (tricuspid valve) between two of the heart's chambers isn't formed. All things being equal, there's solid tissue between the chambers, which confines blood flow and causes the right lower heart chamber (ventricle) to be immature.
                    </p>
                </Stack>
