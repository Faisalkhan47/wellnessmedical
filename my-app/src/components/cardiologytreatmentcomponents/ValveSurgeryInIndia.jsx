...
export default function ValveSurgeryInIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Aortic Valve Surgery In India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Valve surgery or heart valve surgery is a medical procedure to treat diseases related to heart valve diseases. Heart valve disease involves at least one of the four valves of the heart - mitral valve, tricuspid valve, pulmonary valve and aortic valve. Heart valves keep the blood flow through the heart in the right direction. Each valve has flaps - called leaflets for the mitral and tricuspid valves and cusps for the aortic and pulmonary valves. The flaps open and close once at each heart beat. If they don’t open or close properly, blood flow through the heart to the body can get disrupted. In heart valve surgery, the heart surgeons treat either diseased valve by either repairing or replacing it.
                    </p>
                </Stack>
