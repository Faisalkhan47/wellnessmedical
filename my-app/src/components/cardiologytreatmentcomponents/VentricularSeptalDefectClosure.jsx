...
export default function VentricularSeptalDefectClosure() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Ventricular Septal Defect (VSD) Closure</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    At GoMedii you get the best of the heart facilities that are available in countries around the world. A ventricular septal defect is one of the most demanded of surgeries at GoMedii. A ventricular septal defect (VSD) is a hole in the wall (septum) that separates the heart’s two lower chambers (ventricles). Ventricular septal defects usually occur by themselves, without other birth defects of any kind. Experts estimate that VSDs account for about 30 percent of all congenital heart defects, occurring in 1 out of every 500 babies.
                    </p>
                </Stack>
