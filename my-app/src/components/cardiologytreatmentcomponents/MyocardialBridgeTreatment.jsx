...
export default function MyocardialBridgeTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Myocardial Bridge Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A myocardial bridge is a band of the heart muscle that lies on top of a coronary artery, instead of underneath it. With a myocardial bridge, some portion of the coronary artery dips into and under the heart muscle and afterward returns out once more. The coronary arteries lie on the outside of the heart. However, in individuals with myocardial bridges, at least one of the conduits goes through the heart muscle for a brief distance. The flap of the heart muscle that goes over this little part of the artery forms a “bridge." Generally, a myocardial bridge is innocuous. Patients with a myocardial bridge have it from birth, and most never realize they have the condition. Myocardial bridging, a congenital abnormality wherein a coronary artery route burrows through the myocardial fibers was typically viewed as a kind condition.
                    </p>
                </Stack>
