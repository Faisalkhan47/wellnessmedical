...
export default function HighOutputHeartFailureTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    High Output Heart Failure Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    High-output heart failure happens when the body's need for blood is unusually high, so heart failure symptoms happen even though the heart is working well. This type of heart failure happens to a very small number of people with heart failure. High-output heart failure happens when the typically working heart can't stay aware of a bizarre appeal for blood to at least one organ in the body. The heart might be functioning admirably in any case, yet it can't pump out sufficient blood to stay aware of this additional need. Certain heart conditions, like narrowed arteries in the heart or hypertension, continuously leave the heart excessively frail or stiff to fill and pump blood properly. Legitimate treatment can work on the signs and manifestations of high-output heart failure and may help a few groups live more.
                    </p>
                </Stack>
