...
export default function AcuteDecompensatedHeartFailureTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Acute Decompensated Heart Failure Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    ADHF is a different interaction going from well-seeming patients with gentle pneumonic edema to cardiogenic shock. Patients with confined aspiratory edema may give generally do well showing up just insignificant O2 necessities, and volume over-burden.
                    </p>
                </Stack>
