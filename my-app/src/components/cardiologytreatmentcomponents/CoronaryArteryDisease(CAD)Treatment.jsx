...
export default function CoronaryArteryDiseaseTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Coronary Artery Disease (CAD) Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    At GoMedii you get the best quality healthcare around the world. With increasing cardiac issues, we provide our patients with the hope for better living. Coronary Artery Disease (CAD) Treatment is a condition where plaque develops inside the coronary supply routes.
                    </p>
                </Stack>
