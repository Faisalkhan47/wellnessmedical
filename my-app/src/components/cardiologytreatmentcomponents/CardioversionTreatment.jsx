...
export default function CardioversionTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Cardioversion Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    If your heart has an irregular (uneven) beat or is beating too fast, cardioversion is a way to restore a regular rhythm. Abnormal heart rhythms are called arrhythmias. There are two kinds of cardioversion. Your doctor may give you one or more medicines to bring back your regular heartbeat. This is called pharmacologic (chemical) cardioversion. Doctors also restore regular rhythms by sending an electrical shock to the heart. This is called electrical cardioversion.
                    </p>
                </Stack>
