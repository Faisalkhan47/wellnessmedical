...
export default function GiantCellMyocarditisTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Giant Cell Myocarditis Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Giant-cell myocarditis (GCM) is known as a rare, rapidly progressive, and frequently fatal myocardial disease in young and middle-aged adults. It is ascribed perfectly to T lymphocyte-mediated inflammation of the heart muscle and is associated with systemic autoimmune diseases in 20% of cases. The most widely recognized early indications are heart failure, ventricular arrhythmias, and atrioventricular block, however, GCM may likewise camouflage as an intense myocardial dead tissue and once in a while presents as an unforeseen unexpected cardiac death.
                    </p>
                </Stack>
