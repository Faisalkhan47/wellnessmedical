...
export default function CardiacAsthmaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Cardiac Asthma Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Cardiac asthma is not a form of asthma. It's a type of coughing or wheezing that occurs with left heart failure. Depending on how severe your symptoms are, this wheezing can be a medical emergency. Heart failure can cause fluid development in your lungs (pneumonic edema) and in and around your airways. This can cause shortness of breath, coughing, and wheezing similar to the signs and symptoms of asthma. Right asthma is a constant condition brought about by the inflammation of the airways, which can limit them, prompting breathing difficulties. Genuine asthma steers clear of liquid in the lungs or heart disease.
                    </p>
                </Stack>
