...
export default function MitralValveRepair() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Mitral Valve Repair</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A lot of patients around the world choose GoMedii for their heart and other treatment-related issues. Mitral Valve repair is one of them. Mitral valve surgery is inclusive of both mitral valve repairs and replacements. Through GoMedii, our goal is to deliver the finest medical care treatment. Typically doctors treat mitral valve disease through open-heart surgery; however, depending on the individual case a minimally invasive approach may be possible. When performing minimally invasively, our surgeons use specifically designed instruments passed through a few tiny incisions and into the heart.
                    </p>
                </Stack>
