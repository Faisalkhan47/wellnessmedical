...
export default function AtherosclerosisTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Atherosclerosis Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Atherosclerosis is a specific type of arteriosclerosis. Atherosclerosis is the development of fats, cholesterol, and different substances in and on your artery walls. This development is called plaque.
                    </p>
                </Stack>
