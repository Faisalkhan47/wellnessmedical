...
export default function PulmonaryArteryBanding() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Pulmonary Artery Banding (PAB)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Pulmonary artery banding is a basic careful method to reduce pulmonary over circulation in some innate coronary heart diseases.
                    </p>
                </Stack>
