...
export default function BalloonMitralValvuloplasty() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Balloon Mitral Valvuloplasty</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Balloon Mitral Valvuloplasty may be done to open a stiff (stenotic) heart valve. In balloon mitral valvuloplasty, your primary care physician inserts a very small, narrow, hollow tube into a blood vessel in the groin and advances it through the aorta into the heart.
                    </p>
                </Stack>
