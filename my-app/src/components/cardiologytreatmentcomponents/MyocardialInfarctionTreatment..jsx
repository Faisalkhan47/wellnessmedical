...
export default function MyocardialInfarctionTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Myocardial Infarction Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Myocardial infarction is one of the most common causes of death. This means that the most important measure to reduce deaths is to educate people about the symptoms and signs of acute myocardial infarction. Patients must get near a defibrillator as soon as possible. Once the patient is in a situation where sudden death can be prevented, the important issue is reducing the size of the myocardial infarct, and in this, drug therapy has a major role to play.
                    </p>
                </Stack>
