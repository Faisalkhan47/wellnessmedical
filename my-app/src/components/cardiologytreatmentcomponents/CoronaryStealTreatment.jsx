...
export default function CoronaryStealTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Coronary Steal Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Coronary steal is frequently observed in the recipient artery supplied from collaterals. Coronary stealing during pressure may adversely affect myocardial capacity even in a very much collateralized region.
                    </p>
                </Stack>
