...
export default function VentricularAneurysmTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Ventricular Aneurysm Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Ventricular aneurysm true or pseudo is a potential complication of transmural myocardial infarction the establishment of a patent infarct artery reduces the risk of aneurysm formation. A ventricular aneurysm might be seen in different conditions, for example, hypertrophic cardiomyopathy, cardiovascular sarcoidosis, myocarditis, inborn illness, after cardiac surgery, and blunt trauma.
                    </p>
                </Stack>
