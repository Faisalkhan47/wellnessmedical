...
export default function CardiacAmyloidosisTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Cardiac Amyloidosis Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Cardiac amyloidosis occurs when plaques of a protein byproduct called amyloid build up in heart muscle, affecting its ability to pump blood. The two main types of cardiac amyloidosis are ATTR and AL. ATTR, or transthyretin amyloidosis TTR (the protein transthyretin), transports thyroid hormone and retinol (vitamin A) throughout the body. Hereditary and nonhereditary (wild-type) are the subtypes of TTR (the protein transthyretin) amyloid
                    </p>
                </Stack>
