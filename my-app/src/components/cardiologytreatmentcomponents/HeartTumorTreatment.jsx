...
export default function HeartTumorTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Heart Tumor Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A heart Tumor occurs when diseased cells grow out of control on or near the heart. These cells form a tumor. A tumor that starts in the heart is an essential heart tumor.
                    </p>
                </Stack>
