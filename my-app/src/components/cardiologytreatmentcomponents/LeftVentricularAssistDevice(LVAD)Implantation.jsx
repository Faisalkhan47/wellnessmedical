...
export default function LeftVentricularAssistDeviceImplantation() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Left Ventricular Assist Device (LVAD) Implantation</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A left ventricular assist device (LVAD) is a mechanical pump that is implanted in patients with heart failure. It helps the base left chamber of your heart (left ventricle) pump blood out of the ventricle to the aorta and the remainder of your body. That is the reason it is known as a Left Ventricular Assist Device. LVADs can be utilized as:
                    </p>
                </Stack>
