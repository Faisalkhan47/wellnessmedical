...
export default function CoronaryArteryAngiography() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}> Coronary Artery Angiography (CAG)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The process that provides information about the structure and function of the Heart is Coronary Artery Angiography. Usually, It Involves Taking X-rays of the Coronary arteries (heart's arteries) using the technique called angiography, and the resulting mages are known as an angiogram.
                    </p>
                </Stack>
