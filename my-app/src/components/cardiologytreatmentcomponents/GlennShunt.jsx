...
export default function GlennShunt() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    A Glenn shunt is the second of three surgeries following the Norwood procedure and preceding the Fontan procedure used to treat a severe form of congenital heart disease called hypoplastic left heart syndrome.
                    </p>
                </Stack>
