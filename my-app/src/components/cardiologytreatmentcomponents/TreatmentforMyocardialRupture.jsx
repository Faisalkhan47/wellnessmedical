...
export default function TreatmentforMyocardialRupture() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Myocardial Rupture</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Myocardial Rupture occurs when blood flow to your heart is reduced, preventing the heart muscle from receiving enough oxygen. Its reduced blood flow is generally the aftereffect of a complete blockage of your heart's arteries. It, likewise called cardiac ischemia, reduces the heart muscle's capacity to pump blood. An unexpected, serious blockage of one of the heart's arteries can prompt a heart attack. Myocardial rupture may likewise cause abnormal heart rhythms. Treatment for myocardial rupture includes further developing blood flow to the heart muscle. Treatment may include medications, a procedure to open blocked arteries, or bypass surgery.
                    </p>
                </Stack>
