...
export default function HeartTransplant() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Heart Transplant in India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A heart transplant replaces the patient's heart with a donor's heart. Specialists eliminate the patient's heart by transecting the aorta, the main pulmonary artery, and the prevalent and inferior vena cavae, and partitioning the left atrium, leaving the back wall of the left atrium with the pulmonary vein openings set up.
                    </p>
                </Stack>
