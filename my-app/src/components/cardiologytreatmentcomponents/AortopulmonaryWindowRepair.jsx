...
export default function AortopulmonaryWindowRepair() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Aortopulmonary Window Repair</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An aortopulmonary window is a heart defect in which there is a hole between the blood vessel that feeds the heart (the aorta) and the blood vessel going to the lungs (pulmonary artery). As a result of this opening, blood from the aorta hurries into the pulmonary artery and a lot of blood flows through the lungs.
                    </p>
                </Stack>
