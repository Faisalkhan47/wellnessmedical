...
export default function PancarditisTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Pericarditis is inflammation of the pericardium, a sac-like construction with two thin layers of tissue that encompass the heart to hold it set up and help it work.
                    </p>
                </Stack>
