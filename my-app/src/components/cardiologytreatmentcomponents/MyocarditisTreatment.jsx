...
export default function MyocarditisTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Myocarditis Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Myocarditis is an inflammation of the heart muscle. Myocarditis can influence your heart muscle and electrical system, diminishing your heart's capacity to siphon and causing quick or strange heart rhythms.
                    </p>
                </Stack>
