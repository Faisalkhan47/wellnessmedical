        ...
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Heart Valve Replacement</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The heart is one of the most delicate parts of the human body and it is necessary to get the proper address when needed. At GoMedii, the doctors and hospitals on board take care of the patient with all the necessary diagnosis and treatment. As the patients treatment partner GoMedii stands as one of the most trusted brands in India. The number of patients growing for Heart Valve Replacement with GoMedii explains the need for better healthcare around the world.</p>
                </Stack>
