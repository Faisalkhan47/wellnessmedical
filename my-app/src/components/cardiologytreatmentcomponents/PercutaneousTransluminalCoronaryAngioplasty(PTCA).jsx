...
export default function PercutaneousTransluminalCoronaryAngioplasty() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Percutaneous Transluminal Coronary Angioplasty (PTCA)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Percutaneous coronary intervention refers to a non-surgical technique utilized for addressing the constriction of coronary arteries, a common feature of coronary artery disease affecting the heart. Percutaneous transluminal coronary angioplasty is a process that is used to treat coronary artery disease in which the arteries that provide blood to the heart become shrink or close.
