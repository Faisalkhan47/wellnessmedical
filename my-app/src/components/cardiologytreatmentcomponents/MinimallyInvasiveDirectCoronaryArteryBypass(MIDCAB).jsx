...
export default function MinimallyInvasiveDirectCoronaryArteryBypass() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Minimally Invasive Direct Coronary Artery Bypass (MIDCAB)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Heart bypass surgery restores blood flow in blood vessels (coronary arteries) that have hardened or narrowed. This causes blood flow to the heart to slow and, if not treated, can lead to a heart attack. In bypass surgery, heart surgeons create a new path around the blocked arteries (bypass) to allow for blood and oxygen to reach your heart. Coronary artery bypass grafting, CABG for short and pronounced 'cabbage', is a more precise reference to heart bypass surgery. In CABG, our heart surgery team will create a new route for the blood to flow around the buildup, using an artery from another part of your body. This technique is called grafting.
                    </p>
                </Stack>
