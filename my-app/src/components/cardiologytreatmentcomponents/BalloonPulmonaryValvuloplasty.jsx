...
export default function BalloonPulmonaryValvuloplasty() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Balloon Pulmonary Valvuloplasty</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Balloon Pulmonary Valvuloplasty means that the pulmonary valve, the valve that lets blood flow from the heart to the lungs via the pulmonary artery is narrowed. At the point when the pulmonary valve is too narrow, the right ventricle needs to work more enthusiastically. This implies that the muscle will get greater, actually like some other muscle in the body does when it works hard. On the off chance that the pulmonary valve is severely narrowed, this can restrict how much exercise your kid can oversee.
                    </p>
                </Stack>
