...
export default function TricuspidValveRepair() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Tricuspid Valve Repair</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The tricuspid valve controls the flow of blood from the right upper chamber to the right lower chamber of the heart. This valve may become dysfunctional due to infection, rheumatic heart disease, or congenital birth defects.
                    </p>
                </Stack>
