...
export default function CryoablationforAtrialFibrillation() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Cryoablation for Atrial Fibrillation</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Cryoablation restores normal heart rhythm by disabling heart cells that create an irregular heartbeat. During this minimally invasive procedure, a thin flexible tube called a balloon catheter is utilized to find and freeze the heart tissue that triggers an irregular heartbeat.
                    </p>
                </Stack>
