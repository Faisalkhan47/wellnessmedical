...
export default function CardiacResynchronisationTherapyDeviceImplantation() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Cardiac Resynchronisation Therapy (CRT) Device Implantation</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Cardiac resynchronization therapy (CRT) is a treatment to help your heartbeat with the right rhythm. It uses a pacemaker to restore the normal timing pattern of the heartbeat. The CRT pacemaker coordinates how the timing of the upper heart chambers (atria) and the lower heart chambers (ventricles). It also works on the timing between the left and right sides of the heart. When your heart doesn’t pump strongly enough, fluid can build up in your lungs and your legs. This is called heart failure. This condition can happen when the two bottom chambers (ventricles) of your heart don’t beat at the same time.
                    </p>
                </Stack>
