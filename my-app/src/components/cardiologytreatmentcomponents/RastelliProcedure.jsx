...
export default function RastelliProcedure() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Rastelli Procedure</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The Rastelli methodology is utilized to treat a few patients with D-TGA. Children with this condition are born with reversed primary blood vessels falling off the heart.
                    </p>
                </Stack>
