...
export default function PatentForamenOvaleClosure() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Patent Foramen Ovale (PFO) Closure</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A patent foramen ovale (PFO) is a hole in the heart that didn't close the way it should after birth. During fetal development, a little flap-like opening of the foramen ovale is typically present in the divider between the right and left upper offices of the heart.
                    </p>
                </Stack>
