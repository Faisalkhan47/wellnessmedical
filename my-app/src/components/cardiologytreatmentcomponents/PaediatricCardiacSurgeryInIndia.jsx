...
export default function PaediatricCardiacSurgeryInIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Open Coronary Artery Bypass Graft</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Another route for blood to flow around a closed or partially closed artery in the heart is created during coronary artery bypass surgery. An undamaged blood vessel from the leg or chest is removed during surgery. Below the blocked cardiac artery, the vessel is joined. The new route enables increased blood flow to the heart muscle.
                    </p>
                </Stack>
