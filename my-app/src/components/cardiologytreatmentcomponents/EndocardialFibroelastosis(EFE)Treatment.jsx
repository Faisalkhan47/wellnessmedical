...
export default function EndocardialFibroelastosisTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Endocardial Fibroelastosis (EFE) Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    EFE is presented as an unexplained heart failure and a common cause of death in infants and children. Despite the fact that for obscure reasons, the essential structure, which isn't related to any huge underlying peculiarity of the heart, has gotten uncommon, EFE is still a major feature of several congenital heart diseases.
                    </p>
                </Stack>
