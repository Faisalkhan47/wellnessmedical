...
export default function DiastolicHeartFailureTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Diastolic Heart Failure Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Diastolic heart failure is defined as a condition caused by increased resistance to the filling of one or both ventricles, this prompts symptoms of congestion from the then appropriate upward shift of the diastolic pressing factor volume connection. In this situation, your left ventricle has gotten stiffer than ordinary. Hence, your heart can't loosen up the manner in which it ought to. At the point when it pumps, it can't top off with blood as it should. Since there's less blood in the ventricle, less blood is siphoned out to your entire body.
                    </p>
                </Stack>
