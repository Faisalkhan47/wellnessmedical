...
export default function SurgeryforCoarctationoftheAorta() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Surgery for Coarctation of the Aorta</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Coarctation of the aorta is a common congenital (present at birth) heart defect. The aorta is the largest artery in your body. It moves oxygen-rich blood from your heart to the remainder of your body. Narrowing of the aorta powers your heart to pump harder to move blood through the aorta.
                    </p>
                </Stack>
