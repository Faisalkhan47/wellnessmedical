...
export default function AtrioventricularFistulaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Atrioventricular Fistula Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An atrioventricular (AV) fistula is an abnormal connection between an artery and a vein. Normally, blood flows from your arteries to your capillaries, and then onto your veins. Supplements and oxygen in your blood travel from your capillaries to tissues in your body. With an atrioventricular fistula, the bloodstream straightforwardly from an artery into a vein, bypassing a few capillaries.
                    </p>
                </Stack>
