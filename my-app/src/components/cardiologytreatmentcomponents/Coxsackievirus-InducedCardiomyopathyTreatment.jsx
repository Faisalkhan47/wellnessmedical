...
export default function CoxsackievirusInducedCardiomyopathyTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Coxsackievirus-Induced Cardiomyopathy Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Coxsackievirus-induced cardiomyopathy is due to RNA enteroviruses. It is caused by coxsackieviruses, which can further cause serious myocarditis, further leading to dilated cardiomyopathy. Coxsackievirus-Induced Cardiomyopathy is an inflammation of the heart muscle. Coxsackievirus can influence your heart muscle and your heart's electrical system, decreasing your heart's capacity to pump and causing fast or abnormal heart rhythms (arrhythmias)
                    </p>
                </Stack>
