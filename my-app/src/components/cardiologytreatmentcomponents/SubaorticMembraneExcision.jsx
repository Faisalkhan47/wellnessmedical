...
export default function SubaorticMembraneExcision() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Subaortic Membrane Excision</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Subaortic membrane excision is a medical procedure that is utilized to fix a condition known as subaortic stenosis.
                    </p>
                </Stack>
