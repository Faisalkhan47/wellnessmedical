...
export default function RoemheldSyndrome() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Roemheld Syndrome</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Roemheld Syndrome involves some gastrointestinal problem or disease that leads to arrhythmia or other types of abnormal heart rate issues. Although the precise interactions involved in Roemheld Syndrome are not all around depicted, anatomical proximity, the vagus nerve (VN), and electrolyte lacks are as yet thought to be an as similarly legitimate possibility for the vital component in Roemheld Syndrome, with VN being a very much upheld choice.
                    </p>
                </Stack>
