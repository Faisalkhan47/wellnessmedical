...
export default function PediatricCardiologyTreatmentInIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Open Pediatric Cardiology</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A medical specialty called pediatric cardiology is dedicated to diagnosing, controlling, and treating cardiac conditions in newborns, young children, and adolescents. Children with congenital heart problems, acquired heart illnesses, and other cardiovascular conditions might receive specialist care from pediatric cardiologists. Pediatric cardiology deals with a variety of cardiac problems, including congenital heart defects, irregular heartbeats, heart murmurs, abnormalities of the heart valves, disorders of the heart muscle, and acquired ailments like Kawasaki disease or rheumatic heart disease.
                    </p>
                </Stack>
