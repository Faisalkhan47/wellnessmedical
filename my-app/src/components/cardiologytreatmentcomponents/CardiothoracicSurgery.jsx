...
export default function CardiothoracicSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Cardiothoracic Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Cardiothoracic surgery is a type of specialty surgery that involves procedures on the organs in the chest cavity (thorax) heart, lungs, and esophagus. At GoMedii you get the best surgeons to perform a variety of cardiothoracic surgeries, from minimally invasive to heart transplants.
                    </p>
                </Stack>
