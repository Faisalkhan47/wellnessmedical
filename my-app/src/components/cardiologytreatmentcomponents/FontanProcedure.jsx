...
export default function FontanProcedure() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    The third and last of the staged congenital heart surgeries performed to treat hypoplastic left heart syndrome (HLHS) and other single ventricle heart defects are the Fontan cardiac procedure.
                    </p>
                </Stack>
