...
export default function ShonesSyndromeTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Shone's Syndrome Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Shone's complex is a congenital heart disease, which affects how blood flows both in and out of the left side of the heart. The multiple sites of blockage in the blood flow at the left side of the heart differentiate Shone's syndrome from other isolated heart defects.
                    </p>
                </Stack>
