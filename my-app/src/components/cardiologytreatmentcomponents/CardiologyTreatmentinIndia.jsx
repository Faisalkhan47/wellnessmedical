...
export default function CardiologyTreatmentinIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Cardiology Treatment in India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Understanding, diagnosing, and treating problems affects the heart and circulatory system. The main goal of the healthcare field is cardiology. Cardiologists are specialized and trained to diagnose and treat heart-related conditions like coronary artery disease, heart failure, and congenital heart defects.</p>
                </Stack>
