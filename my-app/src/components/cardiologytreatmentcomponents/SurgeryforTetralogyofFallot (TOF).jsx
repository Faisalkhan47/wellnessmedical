...
export default function SurgeryforTetralogyofFallot() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Surgery for Tetralogy of Fallot (TOF)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Tetralogy of Fallot is the most common form of cyanotic congenital heart disease. Cyanosis is the abnormal bluish discoloration of the skin that occurs because of low levels of circulating oxygen in the blood. Tetralogy of Fallot consists of the combination of four different heart defects: a ventricular septal defect (VSD); obstructed outflow of blood from the right ventricle to the lungs (pulmonary stenosis); a displaced aorta, which causes blood to flow into the aorta from both the right and left ventricles (extraposition or overriding aorta); and abnormal enlargement of the right ventricle (right ventricular hypertrophy). The severity of the symptoms is related to the degree of blood flow obstruction from the right ventricle
                    </p>
                </Stack>
