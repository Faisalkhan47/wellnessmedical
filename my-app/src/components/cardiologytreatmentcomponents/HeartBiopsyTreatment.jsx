...
export default function HeartBiopsyTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Heart Biopsy Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    GoMedii has the best cardiologists around the world to associate with it. Here is the understanding of what exactly a Cardiac biopsy is. A Cardiac Biopsy takes small samples of the heart muscle to examine under the microscope. It is most commonly done after a heart transplant to look for rejection of the new heart. It is also done to try and find a cause of new-onset heart failure or to determine the cause of specific heart muscle problems where all other tests cannot clearly make the diagnosis. It is typically a day procedure.
                    </p>
                </Stack>
