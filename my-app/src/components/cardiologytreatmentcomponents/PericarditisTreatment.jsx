...
export default function PericarditisTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Pericarditis Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Pericarditis is an inflammation of the pericardium. Pericarditis is usually acute it develops suddenly and may last up to several months. The condition as a rule clears up following 3 months, yet some of the time assaults can travel every which way for quite a long time.
                    </p>
                </Stack>
