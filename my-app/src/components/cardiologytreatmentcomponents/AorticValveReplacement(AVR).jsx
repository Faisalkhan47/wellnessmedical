...
export default function AorticValveReplacementAVR() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}> Aortic Valve Replacement (AVR)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Aortic valve replacement is usually suggested for those people having severe aortic valve stenosis who are experiencing symptoms such as chest pain, shortness of breath, and fatigue. It may also be suggested for people with severe valve damage due to infection or congenital heart defects.
                    </p>
                </Stack>
                <Stack sx={{ marginLeft: '3rem', marginTop: '2rem', width: '50%' }}>
                    <div>
                        <h2>About</h2>
