...
export default function OpenHeartSurgeryinIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Open Heart Surgery in India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A hole must be drilled through the chest wall during open-heart surgery, which is also known as cardiac surgery, in order to operate directly on the heart. To gain access to the heart and the surrounding tissues, the sternum, often known as the breastbone, must be cut. In a specialist operating room, with the patient under general anesthesia, open-heart surgery is routinely performed. The phrase "open-heart surgery" describes a procedure in which the surgeon must expose the heart directly and momentarily stop its beating by employing a heart-lung bypass machine.</p>
                </Stack>
