...
export default function DoubleValveReplacement() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Double Valve Replacement (Tissue Implant)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A double valve replacement refers to replacing both the mitral and aortic valves, effectively replacing the entire left side of the heart. This process carries a slightly higher mortality rate. Tissue implant of double valve replacement is a process in which the heart's aortic valve and mitral valve are replaced with artificial valves made from pig or cows biological tissues. This surgery is generally performed on patients with severe valve diseases like aortic stenosis and mitral regurgitation, in which the valves of patients get damaged and cannot function properly.</p>
                </Stack>
