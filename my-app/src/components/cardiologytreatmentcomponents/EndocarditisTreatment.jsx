...
export default function EndocarditisTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Endocarditis Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Endocarditis is a life-threatening inflammation of the inner lining of your heart's chambers and valves. Endocarditis is generally caused by an infection. Bacteria, fungi, or other germs from another piece of your body, like your mouth, spread through your bloodstream and connect to harmed regions in your heart. In case it's not treated rapidly, endocarditis can harm or obliterate your heart valves.
                    </p>
                </Stack>
