...
export default function HeartArrhythmiaCatheterAblation() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Heart Arrhythmia - Catheter Ablation</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Heart Ablation Surgery is done to scar the tissues so that there are no unwanted electrical signals transferring into the heart. It helps in normalizing the heart rhythm of the patient. This procedure uses energy to make small scars in your heart tissue. They stop unusual electrical signals that move through your heart and cause an uneven heartbeat. This is also referred to as arrhythmia, which your doctors might call it.
                    </p>
                </Stack>
