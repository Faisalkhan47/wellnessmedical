...
export default function DonorEggs() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Donor Eggs</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Donor eggs are eggs that are retrieved from a woman who donates them to be used in fertility treatments. The eggs are typically collected through a process called ovarian stimulation in which the donor takes medications to stimulate her ovaries to produce multiple eggs. In this process, the surgeon removes the ovum or the female egg which is later used for in-vitro fertilization. This process helps infertile couples become parents. When a women's eggs are not viable or when there is a substantial danger of passing on a genetic disease donor eggs may be used.
                    </p>
                </Stack>
