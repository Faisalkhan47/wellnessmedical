...
export default function EmbryoTransferProducts() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Embryo Transfer Products</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Infertility is common in both men and women, it is a disease of both sexes that can affect your reproductive system preventing the woman from conceiving. It is usually taken into consideration after 12 or months of regular unprotected sexual intercourse. Transferring a fertilized embryo to a woman’s uterus is an important part of the in-vitro fertilization process. There are some things to expect during the embryo transfer process, as well as some risks and precautions to consider.
                    </p>
                </Stack>
