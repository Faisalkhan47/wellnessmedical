...
export default function BlastocystTransfer() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Blastocyst Transfer</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Blastocyst embryo transfer is specialized In Vitro Fertilisation (IVF) technique in which an embryo that has been cultured to the blastocyst stage is transferred to the womb. It is at the blastocyst stage of development (five days after fertilization) that an embryo would normally move out of the fallopian tube and into the uterus. Once in the uterus, the blastocyst starts to attach to the uterine lining in a process known as implantation.
                    </p>
                </Stack>
