...
export default function MicrosurgicalTesticularSpermExtraction() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Microsurgical Testicular Sperm Extraction (Micro TESA)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The medical procedure known as microTESE involves extracting sperm directly from the testicular tissue of a man's reproductive system. It is typically recommended for men who are unable to produce or release sufficient healthy sperm naturally, to improve their fertility and enable them to father a child.
                    </p>
                </Stack>
