...
export default function MagneticActivatedCellSorting() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Magnetic-Activated Cell Sorting (MACS)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The ability to isolate cell populations from heterogeneous mixtures is a key part of life sciences research. One approach to separating cells is magnetic-activated cell sorting (MACS), which uses magnets to isolate targeted cells from the rest of a biological sample. Magnetic cell separation is a popular technology; however, like any method of sorting cells, it has its shortcomings. But MACS needs to look out because there is a new player on the field buoyancy-activated microbubbles that are changing the game.
                    </p>
                </Stack>
