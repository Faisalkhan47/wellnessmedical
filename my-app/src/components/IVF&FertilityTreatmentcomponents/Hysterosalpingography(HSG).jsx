...
export default function Hysterosalpingography() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hysterosalpingography (HSG)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A Hysterosalpingogram or HSG is an x-ray procedure used to determine if the fallopian tubes are patented (open) and whether the inside of the uterus (uterine cavity) is normal. HSG is an outpatient procedure that usually takes less than 5 minutes to perform. It is usually done after the end of the menstrual cycle but before puberty.
                    </p>
                </Stack>
