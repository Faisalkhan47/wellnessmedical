...
export default function TesticularSpermAspiration() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Testicular Sperm Aspiration</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A procedure in which a sample of sperm cells and tissue are separated or removed from the testicle through a small needle attached to a syringe. The sperm is removed from the tissue and looked at under a microscope in the laboratory. It may then be used right away to fertilize eggs or frozen for future infertility treatment.
                    </p>
                </Stack>
