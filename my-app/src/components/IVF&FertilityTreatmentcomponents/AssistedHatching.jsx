...
export default function AssistedHatching() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Assisted Hatching</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Infertility is common in both men and women, it is a disease of both sexes that can affect your reproductive system preventing the woman from conceiving. It is usually taken into consideration after 12 or months of regular unprotected sexual intercourse. Assisted fertilization is an additional procedure that can be performed on patients receiving in vitro fertilization (IVF) treatment. Once embryos are formed using IVF, the embryo is surrounded by a solid layer of cells called zona pellucida. You can think of this outer layer as the “shell” of an embryo. The embryo must release itself from its “shell” in order to grow and develop in the womb. Assisted hatching is a process in which we can help the fetus to “hatch” its “shell” by making a small crack in them pellucid. It is believed that assisted fertilization may help the fetus implant in the uterus, leading to higher pregnancy rates in some patients.
                    </p>
                </Stack>
