...
export default function PreimplantationGeneticDiagnosis() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Preimplantation Genetic Diagnosis (PGD)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Pre-implantation genetic diagnosis (PGD) is commonly defined as the pre-implantation of pre-implanted embryos or oocytes with genetic damage. Designed for couples whose potential offspring are at risk for major Mendelian disorders, structural chromosome abnormalities, or mitochondrial disorders. Pre-embryonic diagnosis requires in vitro fertilization, embryo biopsy, and the application of fluorescent in situ hybridization or polymerase chain reaction at a single-cell level. Therefore, it is a complex process that requires a lot of knowledge. An aneuploidy test to improve in vitro fertilization / intracytoplasmic sperm injection is a different form of PGD.
                    </p>
                </Stack>
