...
export default function EggRetrieval() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Fertility Preservation</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Cancer treatment can have a major impact on fertility. Get the facts about fertility preservation options and know how to choose what's right for you. If you're being treated for cancer, you might have questions about fertility preservation. Find out how cancer treatment can affect your ability to have a child, as well as what fertility preservation steps you can take before you begin cancer treatment.
                    </p>
                </Stack>
