...
export default function ReceptionofOocytesfromPartner() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Reception of Oocytes from Partner (ROPA)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    ROPA, which stands for Reception of Oocytes from the Partner, allows same-sex couples to ‘share motherhood’. This technique consists of an In Vitro Fertilization (IVF) procedure where one woman contributes with her oocytes and the other woman contributes with her uterus. Thus, both women can actively participate in the process, in order to achieve a full-term pregnancy and a healthy baby at home.
                    </p>
                </Stack>
