...
export default function IntracytoplasmicMorphologicallyselectedSpermInjection() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Intracytoplasmic Morphologically Selected Sperm Injection</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Intracytoplasmic sperm injection (ICSI) is performed in cases of infertility by injecting a motile and morphologically normal sperm cell under a routine ×400 magnification at which is hard to distinguish morphologically healthy sperm. The present study aimed to evaluate the efficacy of the intracytoplasmic morphologically selected sperm injection (IMSI) technique in different infertility populations undergoing ICSI. Main outcome measures of routine ICSI were compared with IMSI in three different groups of patients.
                    </p>
                </Stack>
