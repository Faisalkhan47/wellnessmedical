...
export default function BladderNeckIncisionBNI() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Bladder Neck Incision (BNI)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Bladder Neck Incision is a surgical procedure done to correct the flow of urine in men who have a decreased urinary stream and faces problems passing urine because of a bladder neck stenosis or a urethral stricture. It is treated with the help of an incision made in the bladder neck. Under the procedure, the surgeon will track any obstruction in the bladder neck, so as to remove it.
                    </p>
                </Stack>
