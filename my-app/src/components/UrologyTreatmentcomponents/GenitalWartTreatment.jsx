...
export default function GenitalWartTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Genital Wart Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Genital warts are soft growths that appear on the genitals. They can cause pain, discomfort, and itching. They are a sexually transmitted infection (STI) caused by low-risk strains of the human papillomavirus (HPV). These strains, HPV 6 and HPV 11 are different from the high-risk strains that can lead to cervical dysplasia and cancer. According to the Centers for Disease Control and Prevention (CDC)Trusted Source, HPV is the most common of all STIs. Everyone who is sexually active is vulnerable to complications of HPV, including genital warts. HPV infection is especially dangerous for people with vulvas because high-risk strains can also cause cancer of the cervix and vulva. Treatment is key in managing this infection.
                    </p>
                </Stack>
