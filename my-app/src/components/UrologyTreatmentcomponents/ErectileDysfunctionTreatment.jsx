...
export default function ErectileDysfunctionTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Erectile Dysfunction Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Erectile dysfunction, or ED, is the most common sex problem that men report to their doctor. It affects as many as 30 million men. ED is defined as trouble getting or keeping an erection that's firm enough for sex. Though it's not rare for a man to have some problems with erections from time to time, ED that is progressive or happens routinely with sex is not normal, and it should be treated. ED can happen: Most often when blood flow in the penis is limited or nerves are harmed, With stress or emotional reasons, As an early warning of a more serious illness, like atherosclerosis (hardening or blocked arteries), heart disease, high blood pressure, or high blood sugar from Diabetes.
                    </p>
                </Stack>
