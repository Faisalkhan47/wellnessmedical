...
export default function UreteralReimplantationSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Ureteral Reimplantation Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Ureteroneocystostomy (UNC) refers to the reimplantation of the ureter into the bladder. In the adult population, ureteroneocystostomy is primarily used for disease or trauma involving the lower third portion of the ureter that results in obstruction or fistula. In children, ureteroneocystostomy is commonly used for surgical treatment of vesicoureteral reflux (VUR).
                    </p>
                </Stack>
