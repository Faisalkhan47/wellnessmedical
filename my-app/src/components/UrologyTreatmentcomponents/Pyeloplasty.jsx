...
export default function Pyeloplasty() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Pyeloplasty</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Pyeloplasty is a type of surgery that repairs your ureter – a tube that attaches your kidney and bladder. This inpatient procedure, performed by a general surgeon or urologist, corrects ureteropelvic junction (UPJ) obstruction. You’ll likely remain in the hospital for two days. Pyeloplasty is surgery to correct a condition called ureteropelvic junction (UPJ) obstruction. “Pyelo” refers to the kidney (renal pelvis). “Plasty” is the term for a surgical procedure that repairs restores or replaces something. Adults and children may need a pyeloplasty. One baby out of every 1500 is born with a UPJ obstruction. Twice as many males than females have it. For infants, if the condition doesn’t improve within 18 months, they will likely need pyeloplasty. Older children, teenagers, and adults can also get a UPJ obstruction and may need a pyeloplasty if their kidney is obstructed.
                    </p>
                </Stack>
