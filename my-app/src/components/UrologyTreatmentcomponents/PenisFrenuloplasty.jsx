...
export default function PenisFrenuloplasty() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Penis Frenuloplasty</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A frenulum is a small fold or band of tissue that secures or restricts the motion of a mobile organ in the body. There are several frenula in the body, including some in the mouth. If you’re experiencing pain or discomfort while having sex, or retracting your foreskin is difficult or painful, you may have a short penile frenulum. Don’t panic or feel embarrassed, this can be rectified with a quick and simple operation, called a penile frenuloplasty. Frenuloplasty is simply the surgical alteration of a frenulum when its presence restricts the range of motion between interconnected Tissues.
                    </p>
                </Stack>
