...
export default function PeyroniesDiseaseTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Peyronie's Disease Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Peyronie’s disease is a condition where scar tissue causes the penis to curve or lose length or girth. In some cases, it can cause pain and prevent the man from having sex. There are surgical and nonsurgical treatments that can manage it and it doesn’t cause any harm to the rest of the body. Peyronie’s disease is not cancerous and it doesn’t affect fertility. Peyronie’s disease has two stages: acute and chronic.
                    </p>
                </Stack>
