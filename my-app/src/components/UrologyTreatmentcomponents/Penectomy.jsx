...
export default function Penectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Penectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Penectomy is the surgical procedure to remove all or part of the penis. This procedure is mainly used as a treatment against penile cancer. Penile cancer is a collection of malignant, or cancerous, cells either inside or on the surface tissue of the penis. Removing the penis is a procedure that isn’t undertaken lightly because it has both physical and psychological consequences. Doctors may recommend the procedure, either full or partial if your situation warrants it. Although it’s mainly used if you have penile cancer, in rare cases it might be recommended following severe penile trauma. Besides surgery, other treatment options include radiation therapy, chemotherapy, and various drugs. No treatment is 100 percent effective, and you need to discuss the pros and cons of each option with your doctors.
                    </p>
                </Stack>
