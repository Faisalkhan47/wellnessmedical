...
export default function Varicocelectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Varicocelectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Varicocelectomy is a surgery that removes swollen veins inside the scrotum, called varicoceles. There aren’t any medications that treat or get rid of varicoceles, so your doctor may recommend surgery to remove them. Varicoceles are veins in the scrotum, the pouch of skin where the testicles are held, that become swollen or enlarged. They're a fairly common problem, as it’s estimated that 10 to 15 out of every 100 men have a varicocele. Varicoceles are similar to the varicose veins you might get in your legs in that the veins become swollen and twisted. Varicoceles are visible through your skin and carry sperm to the testicles. Since they are larger than they should be, these veins can cause blood to build up in your scrotum or even flow backward into the testicles.
                    </p>
                </Stack>
