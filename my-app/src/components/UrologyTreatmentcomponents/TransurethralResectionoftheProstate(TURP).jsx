...
export default function TransurethralResectionoftheProstate() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Transurethral Resection of the Prostate (TURP)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Transurethral resection of the prostate (TURP) is a surgery used to treat urinary problems caused by enlargement of the prostate. TURP is generally considered an option for men with moderate and severe urinary problems who have not responded to medication. Although TURP is considered an effective treatment for enlarged prostate, a few other, less invasive procedures work better. These procedures usually cause fewer problems and have a faster recovery time than TURP. TURP helps reduce urinary symptoms caused by benign prostatic hyperplasia (BPH).
                    </p>
                </Stack>
