...
export default function IVUIntravenousUrography() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>IVU (Intravenous Urography)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An intravenous urography (IVP) is a type of X-ray that looks at your kidneys and bladder and the ducts (ureters) that connect them. Doctors don’t use it very often. Other imaging tests, like CT scans, are more common.
                    </p>
                </Stack>
