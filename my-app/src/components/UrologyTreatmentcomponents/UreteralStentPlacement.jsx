...
export default function UreteralStentPlacement() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Ureteral Stent Placement</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Ureteral stents hold open the ureters, tubes that allow urine to flow from the kidneys into the bladder. People may need them due to ureteral obstructions from kidney stones, ureteral stones, narrowed ureters, or tumors. Most stents are temporary, but some people with chronic problems need ureteral stents for a longer time. Ureteral stents are thin, flexible tubes that hold ureters open. The ureters are part of the urinary system. Typically, these long, thin tubes carry urine from the kidneys to the bladder. Healthcare providers place ureteral stents to prevent or treat ureteral obstructions. Silicone or polyurethane (plastic) ureteral stents are about 10 to 15 inches long and about ¼ inch in diameter. They line the entire length of the ureter, keeping it open. The top part of the stent has a coil that sits inside a kidney. The loop at the lower end sits inside the bladder.
                    </p>
                </Stack>
