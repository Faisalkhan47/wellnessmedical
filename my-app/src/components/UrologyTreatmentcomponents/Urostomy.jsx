...
export default function Urostomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Urostomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A urostomy is done after your bladder has been surgically removed or if it no longer works. During this procedure, a surgeon creates an opening in your belly, called a stoma. A piece of your intestine is then used to remove urine from your body through that opening. Urostomy is one of the most common surgeries used in the treatment of bladder cancer. An alternative to urostomy is called continent urinary diversion. In this procedure, the surgeon uses a piece of your intestine to create a pouch that holds urine inside your body. The pouch either drains to a stoma or replaces your bladder.
                    </p>
                </Stack>
