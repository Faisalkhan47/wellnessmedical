            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Cystoscopy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Cystoscopy is a procedure that allows your doctor to examine the lining of your bladder and the tube that carries urine out of your body (urethra). A hollow tube (cystoscope) equipped with a lens is inserted into your urethra and slowly advanced into your bladder. Cystoscopy may be done in a testing room, using a local anesthetic jelly to numb your urethra. Or it may be done as an outpatient procedure, with sedation. Another option is to have cystoscopy in the hospital during general anesthesia. The type of cystoscopy you'll have depends on the reason for your procedure.
                    </p>
                </Stack>
