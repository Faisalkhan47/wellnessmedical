...
export default function Prostatectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Prostatectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Prostatectomy is a medical procedure to eliminate part or the entirety of the prostate gland. The prostate gland is arranged in the male pelvis, underneath the urinary bladder. It encompasses the urethra, which conveys pee from the bladder to the penis. The technique is utilized to treat various conditions influencing the prostate. It's most regularly utilized as a treatment for prostate cancer. Prostatectomy can be performed in more than one way, contingent upon the condition involved. Choices incorporate minimally invasive surgery performed with mechanical help and customary open a medical procedure.
                    </p>
                </Stack>
