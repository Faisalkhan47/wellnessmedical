...
export default function TesticularBiopsy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Testicular Biopsy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A testicular biopsy takes a tissue test from your testicle for lab investigation. The two balls are the male conceptive organs. They produce sperm and the male sex hormone testosterone. Your testicles are situated in your scrotum, which is the plump pocket of tissue that hangs under your penis. A testicular biopsy can be utilized to: Analyze the area and state of a lump in the testicles, Analyze reasons for male infertility, Obtain sperm for in vitro fertilization (IVF).
                    </p>
                </Stack>
