...
export default function VesicoureteralRefluxTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Vesicoureteral Reflux (VUR) Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Vesicoureteral reflux (VUR) is a condition in which urine backwashes back up in the ureters/kidneys from the bladder. Urine will typically flow from the kidneys, drain down the ureters, and then get stored in the bladder. The urinary tract is your body’s drainage system for removing waste and extra water. Normally urine flows downward through the main structures of the urinary tract. These structures and what they do are: Kidneys: Two bean-shaped, fist-sized organs — one on each side of the spine below the rib cage — filter the body’s blood, producing urine. Ureters: Two thin, muscular tubes — one from each kidney — carry urine from the kidneys to the bladder. Bladder: The hollow, balloon-shaped organ located between the pelvic bones, which expands to store urine. Urethra: The thin tube at the bottom of the bladder through which urine exits the body. The male urethra is located in the penis and the female urethra ends in the vulvar area. In VUR, urine flows back — refluxes — into one or both of your ureters and, in some cases, to one or both kidneys. VUR that affects only one ureter and kidney is called unilateral reflux. VUR that affects both ureters and kidneys is called bilateral reflux. Looking at the medical words “vesicoureteral reflux,” “Vescio” refers to the bladder while “ureteral” refers to the ureters. “Reflux,” means backup or backflow. Thus, vesicoureteral reflux is about backflow between the bladder and the ureters. Vesicoureteral reflux (VUR) mostly affects newborns, infants, and young children ages two and under, but older children and (rarely) adults can also be affected. Children who have abnormal kidneys or urinary tracts are more likely to have VUR. The condition is more common in girls than in boys.
                    </p>
                </Stack>
