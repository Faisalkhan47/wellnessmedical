...
export default function PediatricUrologyTreatmentinIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Circumcision</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Circumcision eliminates the prepuce covering the glans of the penis. Ordinarily, children go through circumcision not long after birth. Circumcision started as a strict ritual. Today, individuals get circumcised for religious, clinical, and social reasons. Many child young men get circumcised, as a rule inside the main seven-day stretch of life. Adults can get circumcised too, however, it's less common. The foreskin is a piece of skin that covers the round tip of the penis. At the point when a child is conceived, the foreskin is totally attached to the penis. Over the long run, the attached isolates from the top of the penis and can be withdrawn or pulled back. At times, the foreskin doesn't separate when it ought to and stays tight, a condition called phimosis.
                    </p>
                </Stack>
