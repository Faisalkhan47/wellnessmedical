...
export default function Ureteroscopy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Ureteroscopy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    If you have pain when you pee or possibly kidney stones, your doctor may want you to have a ureteroscopy. It’s a procedure to find -- and, in some cases, fix --problems in your urinary tract. During ureteroscopy, your doctor inserts a thin, flexible scope into your bladder and ureter (the tube that carries urine from your kidneys to your bladder). This way they can look for kidney stones or other signs of trouble.
                    </p>
                </Stack>
