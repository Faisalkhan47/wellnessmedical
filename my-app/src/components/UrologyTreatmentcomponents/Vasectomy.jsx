...
export default function Vasectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Vasectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A vasectomy is a type of male birth prevention that slices the stockpile of sperm into your semen. It's finished by cutting and fixing the tubes that convey sperm. Vasectomy has a moderate chance of issues and can generally be acted in an outpatient setting under neighborhood sedation. Prior to getting a vasectomy, you should be sure you would prefer not to father a kid later on. In spite of the fact that vasectomy inversions are conceivable, vasectomy ought to be viewed as a long-lasting type of male birth control. Vasectomy offers no security from sexually transmitted infections.
                    </p>
                </Stack>
