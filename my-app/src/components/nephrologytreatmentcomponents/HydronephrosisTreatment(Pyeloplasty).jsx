...
export default function HydronephrosisTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hydronephrosis Treatment (Pyeloplasty)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Adults and children may need a pyeloplasty. Sometimes one baby out of every 1500 is born with a UPJ obstruction. Twice as many males than females have it. For infants, if the condition doesn’t improve within 18 months, they will likely need pyeloplasty.
                    </p>
                </Stack>
