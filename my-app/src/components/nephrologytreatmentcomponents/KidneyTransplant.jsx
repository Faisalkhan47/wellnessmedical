            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Kidney Transplant</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Medical tourism in India has seen a major increase in recent years, as the international community has noticed the affordable yet state-of-the-art renal and kidney healthcare provided in India. India has some of the best, internationally acclaimed doctors, surgeons, and hospitals that excel in kidney transplantation treatments.
                    </p>
                </Stack>
