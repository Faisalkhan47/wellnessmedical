...
export default function KidneyDialysis() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Kidney Dialysis</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Dialysis is a treatment that does some of the things done by healthy kidneys. It is needed when your own kidneys can no longer take care of your body's needs. You need dialysis when you foster end-stage kidney disappointment as a rule when you lose around 85 to 90 percent of your kidney work and have a GFR of 15.
                    </p>
                </Stack>
