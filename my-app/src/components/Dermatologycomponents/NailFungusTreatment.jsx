...
export default function NailFungusTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Nail Fungus Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Photodynamic therapy (PDT) is a two-step treatment that mixes mild electricity with a drug (photosensitizer) designed to wreck cancerous and precancerous cells after mild activation. Photosensitizers are activated through a specific wavelength of light electricity, usually from a laser. The photosensitizer is dependable until it's miles activated by means of light. but, after mild activation, the photosensitizer becomes poisonous to the focused tissue. Numerous photosensitizer drugs are to be had nowadays to treat a diffusion of illnesses, including acne, psoriasis, age-associated macular degeneration, and several cancers, along with skin, lung, mind, bladder, pancreas, bile duct, esophagus, and head and neck. Similar to treating these conditions, PDT additionally helps treat bacterial, fungal, and viral infections. Studies have proven that this mild-based remedy can cause the body's immune response, giving your body any other way to assist in spoiling cancerous and precancerous cells.
                    </p>
                </Stack>
