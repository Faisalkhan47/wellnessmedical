...
export default function SkinGrafting() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Skin Grafting</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Skin grafting is a surgery that involves disposing of skin from one area of the body and moving it or transplanting it, to an exclusive place of the body. This surgical procedure can be finished if a part of your body has misplaced its protecting overlaying of the skin due to burns, damage, or infection. Skin grafts are performed in a hospital. Most skin grafts are executed using preferred anesthesia, which means you’ll be asleep in the course of the process and not experience any ache.
                    </p>
                </Stack>
