...
export default function SkinBiopsy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Skin Biopsy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A skin biopsy is a system to cast off cells or pores and skin samples out of your body for laboratory exams. A health practitioner makes use of skin biopsy to diagnose skin conditions and dispose of abnormal tissue.
                    </p>
                </Stack>
