...
export default function MiliaRemoval() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Milia Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Milia are typically found on the skin of human beings of every age. They're formed when keratin (a substance produced by the skin) is trapped beneath the outer layer of the skin, forming a tiny cyst. An individual milium (the singular of milia) is shaped at the base of a hair follicle or sweat gland. Milia may be labeled as either primary or secondary. Primary milia are fashioned directly from entrapped keratin and are commonly determined on the faces of infants and adults. Secondary milia are also tiny cysts and appear similar, but those develop after something clogs the ducts leading to the skin floor, inclusive of after an injury, burn, or blistering of the skin.
                    </p>
                </Stack>
