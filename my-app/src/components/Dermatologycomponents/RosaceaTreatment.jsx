...
export default function RosaceaTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Rosacea Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Rosacea is a common skin condition that causes blushing or flushing and blood vessels to your face. It is able to additionally produce small, pus-crammed bumps. Those signs and symptoms may also flare up for weeks to months and then leave for some time. Rosacea may be unsuitable for acne, different skin problems, or herbal ruddiness. Rosacea can have an effect on each person. However, it's most common in center-elderly white women. There is no therapy for rosacea, but remedies can control and reduce the symptoms.
                    </p>
                </Stack>
