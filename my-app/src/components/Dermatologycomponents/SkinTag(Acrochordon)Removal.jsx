...
export default function SkinTagRemoval() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Skin Tag (Acrochordon) Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Skin tags are common, acquired benign pores and skin-colored growths that resemble a small, gentle balloon suspended on a narrow stalk. Skin tags are innocent growths that could range in quantity from one to load. Men and women are equally vulnerable to growing skin tags. Obesity seems to be associated with pores and skin tag development. Despite the fact that a few skin tags may fall off spontaneously, maximum persist as soon as formed. The medical call for the skin tag is acrochordon. Some humans call them "skin tabs." Early on, skin tags can be as small as a flattened pinhead-sized bump. At the same time as most tags normally are small (2 mm-5 mm in diameter) at about one-1/3 to one-half the size of a pencil eraser, some pores, and skin tags may also come to be as big as a big grape (1 cm in diameter) or a fig (five cm in diameter).
                    </p>
                </Stack>
