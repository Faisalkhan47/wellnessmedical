...
export default function CutaneousHornRemoval() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Cutaneous Horn Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A cutaneous horn is a sort of lesion or growth that looks at the pores and skin. It’s made of keratin, which is a protein that makes up the top layer of the pores and skin. The growth may additionally look like a cone or horn, and it may range in length. The name comes from the increase once in a while comparable to an animal’s horn. This skin condition is more common in older adults, and both ladies and men may have it. Many cutaneous horns are benign or noncancerous, however, they can also be precancerous or cancerous.
                    </p>
                </Stack>
