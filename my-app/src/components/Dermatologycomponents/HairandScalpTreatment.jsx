...
export default function HairandScalpTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hair and Scalp Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Alopecia areata is a circumstance that causes hair to fall out in small patches, which can be unnoticeable. These patches may additionally join, but, and then come to be considerable. The situation develops when the immune system attacks the hair follicles, resulting in hair loss. Unexpected hair loss may additionally occur on the scalp, and in some cases the eyebrows, eyelashes, and face, in addition to other parts of the body. It can additionally increase slowly and recur after years among instances. The situation can bring about general hair loss, referred to as alopecia Universalis, and it can prevent hair from growing back. When hair does develop back, it’s possible for the hair to fall out again. The volume of hair loss and regrowth varies from man or woman to man or woman. There’s currently no cure for alopecia areata. However, there are treatments that can assist hair growing back extra quick and that may prevent destiny hair loss, in addition to unique ways to cowl up the hair loss.
                    </p>
                </Stack>
