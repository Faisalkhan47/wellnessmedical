...
export default function MoleandSkinLesionEvaluation() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Mole and Skin Lesion Evaluation</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Moles are a common kind of skin growth. They often appear as small, darkish brown spots and are a result of clusters of pigmented cells. Moles typically seem at some stage in formative years and childhood. Most of the people have 10 to 40 moles, a number of which may trade in appearance or fade away over the years.
                    </p>
                </Stack>
