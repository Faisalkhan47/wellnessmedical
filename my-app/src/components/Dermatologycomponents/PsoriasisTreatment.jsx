            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Acne Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Acne is a skin condition that happens while your hair follicles turn out to be plugged with oil and lifeless skin cells. It causes whiteheads, blackheads or pimples. Acne is most common among teens, though it impacts humans of all ages. Effective acne treatments are available, but acne may be continual. The acne and bumps heal slowly, and when one begins to go away, others seem to crop up. Depending on its severity, acne can cause emotional misery and scar the pores and skin. The earlier you start treatment, it decreases your threat of such problems
                    </p>
                </Stack>
