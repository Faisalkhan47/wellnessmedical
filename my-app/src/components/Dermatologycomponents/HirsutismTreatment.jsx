...
export default function HirsutismTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hirsutism Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Hirsutism is a situation in women that results in an excessive increase of dark or coarse hair like in a male on the face, chest, and lower back. With hirsutism, extra hair growth frequently arises from extra male hormones (androgens), generally testosterone.
                    </p>
                </Stack>
