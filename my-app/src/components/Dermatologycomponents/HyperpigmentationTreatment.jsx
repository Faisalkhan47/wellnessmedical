            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hyperpigmentation Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Pigmentation refers to the coloring of the pores and skin. Skin pigmentation causes modifications to the shade of your skin. Melanin is made by means of cells within the skin and is the pigment responsible for your skin’s coloration. Hyperpigmentation is a circumstance that reasons your skin to darken. This will affect patches of your pores and skin or your complete body. Age spots, additionally referred to as liver spots, are a common type of hyperpigmentation. Hyperpigmentation is generally harmless however can from time to time be because of an underlying medical condition. Positive medicines can also cause your pores and skin to darken. It’s extra of a beauty problem for the majority.
                    </p>
                </Stack>
