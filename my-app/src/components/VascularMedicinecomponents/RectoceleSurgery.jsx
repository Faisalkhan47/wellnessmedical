...
export default function RectoceleSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Rectocele Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A rectocele is a bulge, or herniation, of the front wall of the rectum into the back of the vagina. Rectocele occurs as a result of thinning and weakening of the band of tissue that separates the vagina from the rectum. If it causes symptoms such as difficult bowel movements or discomfort, it needs to be repaired. A rectocele is a bulging of the front wall of the rectum into the back of the vagina. The bulge occurs as a result of thinning and weakening of the band of tissue that separates the vagina from the rectum. This thinning has a number of causes, including: Advanced age. Multiple vaginal childbirths or trauma during childbirth (for example, the use of forceps or the tearing of tissue during delivery). Repeated surgeries in the area of the pelvic floor or rectum. Chronic straining during bowel movements due to long-term constipation.
                    </p>
                </Stack>
