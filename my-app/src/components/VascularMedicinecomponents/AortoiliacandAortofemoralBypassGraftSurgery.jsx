...
export default function AortoiliacandAortofemoralBypassGraftSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Stent Insertion</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Stent Insertion is a procedure to open narrowed or blocked blood vessels that supply blood to the heart. These blood vessels are called the coronary arteries. A coronary artery stent is a small, metal mesh tube that expands inside a coronary artery. A stent is often placed during or immediately after angioplasty. It helps prevent the artery from closing up again. A drug-eluting stent has medicine embedded in it that helps prevent the artery from closing in the long term.
                    </p>
                </Stack>
