...
export default function Hemorrhoidectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hemorrhoidectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Hemorrhoidectomy is a medical procedure to eliminate hemorrhoids. You will be given general sedation or spinal sedation so you won't feel torment. Cuts are made in the tissue around the hemorrhoid. The enlarged vein inside the hemorrhoid is tied off to forestall dying, and the hemorrhoid is taken out. The surgical area might be sewn shut or left open. Sedated dressing covers the injury. The medical procedure should be possible with a blade (scalpel), a device that utilizes power (cautery pencil), or a laser. The operation is generally done in a medical procedure community. You will doubtlessly return home that very day.
                    </p>
                </Stack>
