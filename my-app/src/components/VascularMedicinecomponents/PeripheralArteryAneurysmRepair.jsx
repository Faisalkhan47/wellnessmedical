...
export default function PeripheralArteryAneurysmRepair() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Peripheral Artery Aneurysm Repair</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An aneurysm is a localized bulge in an artery caused by weakening, which may be a result of atherosclerosis or an infection or injury of the arterial wall. A peripheral aneurysm is an aneurysm that is not located in the aorta. They usually occur in the popliteal artery in your leg, though may also occur in other areas. An aneurysm is defined as a persistent, abnormal dilatation of an artery above 1.5 times its normal diameter. The abdominal aorta is the most commonly affected vessel, but peripheral artery aneurysms and visceral artery aneurysms can also occur. This article will focus on the more common types of peripheral and visceral aneurysms, including their presentation, investigations needed, and potential management.
                    </p>
                </Stack>
