...
export default function RubberBandLigationforHemorrhoids() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Rubber Band Ligation for Hemorrhoids</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    To remove hemorrhoids using rubber band ligation, your doctor inserts a small tool called a ligator through a lighted tube (scope) in the anal canal and grasps hemorrhoids with forceps. Sliding the ligator's cylinder upward releases rubber bands around the base of the hemorrhoid. Rubber bands cut off the hemorrhoid's blood supply, causing it to wither and drop off.
                    </p>
                </Stack>
