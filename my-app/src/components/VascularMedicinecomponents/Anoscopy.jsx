...
export default function Anoscopy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Anoscopy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An anoscopy is a simple medical procedure that can help your doctor identify an abnormality in your gastrointestinal tract, notably in your anus and rectum. To perform an anoscopy, your doctor will insert a device called an anoscope into your anus. This scope is typically made of plastic (disposable) or stainless steel (sterilizable). An anoscope allows your doctor to get a detailed look at the tissue within your anal-rectal areas
                    </p>
                </Stack>
