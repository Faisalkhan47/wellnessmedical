...
export default function AorticArchSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Aortic Arch Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The aorta arch is the part of the aorta that helps distribute blood to the head and beyond through the brachiocephalic trunk, the common left carotid, and the left subclavian artery, brain and arms. When the walls of the aortic arch are enlarged (causing an aneurysm), or when tears appear (aortic dissection), surgical or medical intervention is required, as major internal bleeding is possible. A brain aneurysm explodes or a balloon in a blood vessel in the brain. It usually looks like a berry hanging from a stalk. A brain aneurysm can leak or rupture, causing bleeding in the brain (hemorrhagic stroke). Frequent rupture of the brain aneurysm occurs in the space between the brain and the small tissues that cover the brain.
                    </p>
                </Stack>
