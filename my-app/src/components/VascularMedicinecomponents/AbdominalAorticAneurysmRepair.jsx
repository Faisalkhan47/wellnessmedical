...
export default function AbdominalAorticAneurysmRepairs() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Abdominal Aortic Aneurysm Repair</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Your doctor may recommend abdominal aortic aneurysm (AAA) repair to treat an aneurysm. An aneurysm is a bulging, weak spot in the aorta that may be at risk for rupturing. In this case, the aneurysm is in part of the aorta that is in the abdomen.
                    </p>
                </Stack>
