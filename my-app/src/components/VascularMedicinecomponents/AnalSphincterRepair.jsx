...
export default function AnalSphincterRepair() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Anal Sphincter Repair</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The indications for repairing an anal sphincter are usually disrupted following injury. The latter almost always relates to a traumatic vaginal delivery. On most occasions this is recognized at the time of the delivery and an immediate repair is undertaken by the attending obstetrician. However, a secondary repair may be required if it is deemed that the primary repair has been suboptimal.
                    </p>
                </Stack>
