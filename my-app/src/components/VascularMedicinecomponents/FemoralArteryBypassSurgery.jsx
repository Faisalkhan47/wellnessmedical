...
export default function FemoralArteryBypassSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Femoral Artery Bypass Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Femoral popliteal bypass surgery is used to treat blocked femoral arteries. The femoral artery is the largest artery in the thigh. It supplies oxygen-rich blood to the leg. The blockage is due to plaque buildup or atherosclerosis. Atherosclerosis in the leg arteries causes peripheral vascular disease. The same process causes heart disease and stroke.
                    </p>
                </Stack>
