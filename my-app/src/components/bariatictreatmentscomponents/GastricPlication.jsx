            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Gastric Plication</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Gastric plication is a newer minimally invasive weight-loss surgery technique that reduces the size of the stomach capacity to approximately 3 ounces. The procedure does not involve the use of an implanted device (such as gastric banding). Also, unlike the gastric sleeve procedure, gastric plication may be reversible because a portion of the stomach is not removed. In addition, unlike gastric bypass, gastric plication does not involve rerouting and reconnecting the intestines. It is a restrictive weight-loss surgery, meaning that it restricts the amount of food the stomach can hold. You will feel full sooner so you won’t want to eat as much.
                    </p>
                </Stack>
