...
export default function PrimaryObesitySurgeryEndolumenal() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Primary Obesity Surgery Endolumenal (POSE)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Primary obesity surgery endoluminal (POSE) is an endoscopic technique that involves the placement of gastric transmural plications in the fundus and pre-antral area to trigger earlier physiologic feedback of fullness and less hunger. The POSE procedure reduces the size of your stomach without making a single incision into the body by utilizing special tools that access the stomach through the mouth and esophagus.
                    </p>
                </Stack>
