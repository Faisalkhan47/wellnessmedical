export const PhotoService = {
    getData() {
        return [
            {
                itemImageSrc: 'https://i.imghippo.com/files/qLE1610VSI.jpg',
                thumbnailImageSrc: 'https://i.imghippo.com/files/PTeN9894FnA.jpg',
                alt: 'Description for Image 1',
                title: 'Title 1'
            },
            {
                itemImageSrc: 'https://i.imghippo.com/files/INB8943oBQ.jpg',
                thumbnailImageSrc: 'https://i.imghippo.com/files/WRfV6454W.jpg',
                alt: 'Description for Image 2',
                title: 'Title 2'
            },
            {
                itemImageSrc: 'https://i.imghippo.com/files/PoDK1382pg.jpg',
                thumbnailImageSrc: 'https://i.imghippo.com/files/zXpX6466eI.jpg',
