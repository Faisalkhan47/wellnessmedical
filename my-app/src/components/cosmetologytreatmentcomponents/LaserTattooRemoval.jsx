            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Laser Tattoo Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Most the People are getting tattoos on the body for some reasons and some have no reasons, but after some time they have regret so they want to remove the tattoo. In the current time, each and every treatment is possible, Laser tattoo removal is also available in India. Tattoos are becoming more popular in the current time. There are so many reasons people&#39;s get tattoos on their body, but there are other reasons when people want to remove their tattoos, then it is possible. A tattoo can be removed easily if you decide you no longer want them. Let’s take a look at the ways you can remove a tattoo at a very affordable cost, and how long it’ll take time. The common techniques to remove the tattoo includes laser tattoo removal, laser surgery, surgical removal and dermabrasion.
                    </p>
                </Stack>
