...
export default function StemCellFacelift() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Stem Cell Facelift</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A stem cell facial is a treatment that uses stem cells from your own body. Hence, it can improve the appearance of aging skin. Aging is normal and it can cause wear and tear to your body most especially on the face. Moreover, it can slow down the production of collagen drastically. Thus, it can cause some of the most visible signs of aging to your face. Truth is, more factors can contribute to damaging your skin. Traditionally, the facelift has been a costly surgical procedure. Aside from that, it is also high risk and sometimes the results are unsatisfactory. So, if you are not ready for a surgical facelift yet, there’s a new and popular procedure available today. This cosmetic procedure is minimally invasive. Not only that, but it is also very effective at brightening your face.
                    </p>
                </Stack>
