...
export default function BlemishRemoval() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Blemish Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A blemish is a term for any mark on the skin. There are many different types of blemishes. Most blemishes are harmless, but some people may wish to treat them for cosmetic reasons. Certain blemishes may indicate an underlying condition, such as skin cancer, which requires prompt medical treatment. In this article, we outline the different types of blemish that people may have and the treatment options available in each case.
                    </p>
                </Stack>
