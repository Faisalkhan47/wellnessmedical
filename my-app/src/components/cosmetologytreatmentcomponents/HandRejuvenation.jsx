...
export default function HandRejuvenation() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hand Rejuvenation</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    As you get older, the skin on your hands is one of the first areas to show signs of aging. The skin becomes thinner and is subject to daily wear and tear. Your hands lose volume fat and elasticity, especially after menopause, becoming translucent and shriveled so that tendons and veins show more easily and age spots can appear. The loss of muscle bulk between fingers creates hollows, making hands look bony. The skin on your hands is naturally thin but becomes thinner and rougher with time and with constant exposure to the sun and the elements.
                    </p>
                </Stack>
