...
export default function PoreReductionTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Pore Reduction Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Open pores are a problem for many, as they are visible and make one look unattractive. People often dislike the presence of open pores on their skin especially in the forehead, cheeks, and nose because such pores become more noticeable. Open pores are often formed as a result of some skin-related issues that occur due to adolescence and UV exposure. This makes the skin appear inflamed and rough. People with extremely oily skin are more likely to have enlarged open pores. Open pores differ in size and are invisible during the early stages and they can get enlarged due to aging or other skin-related problems. Pores often get enlarged due to inflammatory acne. The open pores are filled with dirt, oil, bacteria, and dead skin cells, and these impurities when get oxidized (exposed to the oxygen) it leads to the formation of blackheads, whiteheads, and acne or pimples formation.
                    </p>
                </Stack>
