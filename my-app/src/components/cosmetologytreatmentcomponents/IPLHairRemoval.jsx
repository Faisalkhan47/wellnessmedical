...
export default function IPLHairRemoval() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>IPL Hair Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    IPL is similar to laser treatment. However, a laser focuses just one wavelength of light on your skin, while IPL releases light of many different wavelengths, like a photo flash. The light from IPL is more scattered and less focused than a laser. IPL penetrates down to the second layer of your skin (dermis) without harming the top layer (epidermis), so it causes less damage to your skin. Pigment cells in your skin absorb the light energy, which is converted into heat. The heat destroys the unwanted pigment to clear up freckles and other spots. Or, it destroys the hair follicle to prevent the hair from growing again.
                    </p>
                </Stack>
