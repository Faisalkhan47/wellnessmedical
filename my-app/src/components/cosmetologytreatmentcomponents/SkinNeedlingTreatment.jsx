...
export default function SkinNeedlingTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Skin Needling Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Microneedling is a minimally invasive cosmetic procedure that’s used to treat skin concerns via collagen production. Also known as collagen induction therapy, this treatment may help those looking to reduce the appearance of acne scars and stretch marks. It’s also used in certain anti-aging procedures, such as eyelid surgery and sunspots. Though more research is needed, studies have shown the potential benefits of microneedling in promoting hair growth. You may be an ideal candidate for this procedure if you’re in good health and have certain skin concerns that haven’t responded to home treatments or other types of dermatologic procedures, such as peels. This may also be a final step before considering cosmetic surgery for anti-aging and other concerns. Learn more about microneedling and talk to your dermatologist to see if this is the right option for your skin.
                    </p>
                </Stack>
