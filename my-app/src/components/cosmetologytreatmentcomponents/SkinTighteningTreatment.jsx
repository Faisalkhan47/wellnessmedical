...
export default function SkinTighteningTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Skin Tightening Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    One of the parts of your body that shows the first signs of aging is your face. According to the American Society for Dermatologic Surgery, your neck and lower face are the two areas where skin sagging first starts. Most people find it hard to watch their appearance change as they age. If you are also worried about your sagging facial skin, consider opting for skin tightening treatments. Skin tightening treatment are usually started before one notices sagging of the skin. They are performed as a preventive treatment to prevent skin from sagging and enhance the skin collagen. There are quite a few treatments that are effective in tightening loose skin.
                    </p>
                </Stack>
