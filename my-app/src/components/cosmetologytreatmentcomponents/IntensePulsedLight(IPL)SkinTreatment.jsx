...
export default function IntensePulsedLightSkinTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Intense Pulsed Light (IPL) Skin Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Intense Pulsed Light Therapy, a cutting-edge innovation, offers an insignificantly obtrusive, non-careful approach to treat obscurely pigmented injuries, age or maturity spots, acne scars, rosacea, and facial rejuvenation. Intense Pulsed Light (IPL) frameworks and lasers are practically the same. IPL can be utilized over a wide space of the skin to treat dim pigmented regions, for example, age spots, scars, and such. The IPL yields phenomenal outcomes in treating these conditions by continuously improving and blurring the skin's shade. Rosacea and skin inflammation victims will likewise see a stamped decrease in breakouts. What's more, almost negligible differences and kinks will improve, and patients experience a decrease in pore size.
                    </p>
                </Stack>
