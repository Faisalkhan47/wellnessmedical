            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Laser Hair Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Laser-is a medical procedure, the laser light is converted into heat destroying hair follicles, after which the hair does not grow. It is available at a very cheap price, but before the treatment, we will tell the basic point and clear all doubts like is it safe or not and how much does it cost in India and does Laser guarantee 100%-so many other questions in person's mind.
                    </p>
                </Stack>
