            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Microdermabrasion</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Microdermabrasion treatments use a minimally abrasive instrument to gently sand your skin, removing the thicker, uneven outer layer and has many benefits. Microdermabrasion helps to thicken your collagen, which results in a younger-looking complexion. Collagen is a protein in your skin that is abundant when you're a child and makes skin appear taut and smooth. Collagen production declines as we age, resulting in looser, uneven skin.
                    </p>
                </Stack>
