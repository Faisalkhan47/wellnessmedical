...
export default function ChemicalPeel() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Chemical Peel</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    It is cosmetic treatments that are performed by the most experienced and qualified doctors, chemical Peel applied to the face, hands, and neck. This surgery will help to look better and smoother, less wrinkled than older skin, the regenerated skin is smoother and more glowing from older skin. It is kind of facial but it is performed by the dermatologist, if we are talking about the Chemical Peel then it is also known as derma peeling or chemexfoliation, which can be used to treat certain conditions. GoMedii will help in all the possible ways.
                    </p>
                </Stack>
