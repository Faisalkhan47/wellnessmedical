...
export default function PancreatectomyTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Pancreatectomy Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The pancreas is a pear-formed organ that sits between the stomach and spine. There are three sections to the pancreas: the head, the body, and the tail. The pancreas makes stomach-related hormones and chemicals that direct sugar. A pancreatectomy is the evacuation of part or the entirety of the pancreas. It tends to be utilized to treat a few instances of pancreatic malignant cancer. There are two sorts of pancreatectomy.
                    </p>
                </Stack>
