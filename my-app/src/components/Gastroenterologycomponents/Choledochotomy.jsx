...
export default function Choledochotomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Choledochotomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Choledochotomy surgical incision of the common bile duct. Choledocholithiasis straightforward by intense climbing cholangitis is being treated by a two-venture approach including two separate groups of specific consideration bringing about more cost and potentiating potential confusions. Bile duct injury rates have expanded since the presentation of laparoscopic cholecystectomy, happening in around 3 for every 1,000 strategies performed. Bile duct injuries after cholecystectomy can be life-changing intricacies prompting huge horribleness and cost.
                    </p>
                </Stack>
