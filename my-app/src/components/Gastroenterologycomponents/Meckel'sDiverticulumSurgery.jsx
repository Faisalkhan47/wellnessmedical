...
export default function MeckelsDiverticulumSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Meckel's Diverticulum Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Meckel's diverticulum is an outpouching or lump in the lower part of the small intestine. The lump is intrinsic (present upon entering the world) and is an extra umbilical cord. Meckel's diverticulum is the most widely recognized inborn imperfection of the gastrointestinal plot. It happens in about 2% to 3% of everyone. On the off chance that it causes side effects, Meckel's diverticulum can be fixed with a medical procedure.
                    </p>
                </Stack>
