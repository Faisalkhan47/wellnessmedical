...
export default function LiverHemangiomaSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Liver Hemangioma Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A liver hemangioma, otherwise called a hepatic hemangioma, is a harmless (non-dangerous) cancer in the liver that is comprised of groups of blood-filled cavities fed by the hepatic (liver) artery. Typically, a patient has just a single hemangioma, yet now and again, there might be multiple. Hemangiomas don't form into cancer and don't spread to different spaces of the body. Liver hemangiomas are more normal in grown-ups than in kids; the common age at a conclusion is 30-50 years, yet they can occur at whatever stage in life. Liver hemangiomas happen more frequently in ladies than in men yet can influence both.</p>
                </Stack>
