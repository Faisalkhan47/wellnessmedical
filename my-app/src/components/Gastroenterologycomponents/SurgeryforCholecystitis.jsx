...
export default function SurgeryforCholecystitis() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Surgery for Cholecystitis</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Cholecystitis is an aggravation of the gallbladder. Your gallbladder is a little, pear-shaped organ on the right half of your abdomen, underneath your liver. The gallbladder holds a digestive fluid liquid that is delivered into your small intestine (bile). Much of the time, gallstones obstructing the tube driving out of your gallbladder cause cholecystitis. These outcomes in bile buildup can cause aggravation. Different reasons for cholecystitis incorporate bile duct issues, tumors, genuine sickness, and certain diseases. Whenever left untreated, cholecystitis can prompt genuine, once in a while dangerous entanglements, for example, a gallbladder rupture. Treatment for cholecystitis frequently includes gallbladder removal.</p>
                </Stack>
