...
export default function GastroscopyTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Endoscopy Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An endoscopy is a procedure used to outwardly inspect your digestive system with a minuscule camera on the end of a long, adaptable tube. An expert in sicknesses of the digestive system utilizes endoscopy to analyze and, now and again, treat conditions that influence the esophagus, stomach, and beginning of the small intestine. The clinical term for an upper endoscopy is esophagogastroduodenoscopy. You might have an upper endoscopy done in your doctor's office, an outpatient medical procedure center, or a clinic.
                    </p>
                </Stack>
