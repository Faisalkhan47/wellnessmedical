...
export default function GastroesophagealRefluxDiseaseTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Gastroesophageal Reflux Disease (GERD) Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Gastroesophageal reflux disease (GERD) happens when the stomach is corrosive oftentimes streams once again into the tube interfacing your mouth and stomach (throat). This discharge (acid reflux) can disturb the coating of your esophagus. Many individuals experience heartburn now and again. GERD is gentle heartburn that happens to some extent two times per week, or moderate to serious indigestion that happens one time per week. The vast majority can deal with the distress of GERD with way of life changes and over-the-counter prescriptions. However, certain individuals with GERD might require more grounded drugs or medical procedures to ease manifestations.
                    </p>
                </Stack>
