...
export default function ColonoscopyTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Colonoscopy Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A colonoscopy is a test used to identify changes or irregularities in the large intestine (colon) and rectum. During a colonoscopy, a long, adaptable tube (colonoscope) is embedded into the rectum. A small camcorder at the tip of the tube permits the specialist to see within the whole colon. In the event that fundamental, polyps or different kinds of strange tissue can be eliminated through the extension during a colonoscopy. Tissue tests (biopsies) can be taken during a colonoscopy
                    </p>
                </Stack>
