...
export default function EndoscopicRetrogradeCholangiopancreatography() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Endoscopic Retrograde Cholangiopancreatography (ERCP)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Endoscopic retrograde cholangiopancreatography, or ERCP, is a strategy to analyze and treat issues in the liver, gallbladder, bile conduits, and pancreas. It consolidates X-rays and the utilization of an endoscope—a long, adaptable, lighted tube. Your medical services supplier guides the scope through your mouth and throat, then, at that point down the esophagus, stomach, and the initial segment of the small intestine (duodenum). Your medical services supplier can see within these organs and check for issues. Then, the person will go through a tube through the extension and inject a dye. This features the organs on the X-ray.
                    </p>
                </Stack>
