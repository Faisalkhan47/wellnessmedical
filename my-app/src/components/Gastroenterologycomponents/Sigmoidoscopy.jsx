...
export default function Sigmoidoscopy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Sigmoidoscopy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A sigmoidoscopy is likewise called a flexible sigmoidoscopy due to the flexible tube utilized in the method. A gastroenterologist, or medical services supplier having some expertise in the gastrointestinal system, plays out a flexible sigmoidoscopy to see within the lower (sigmoid) part of your colon and rectum. Your medical services supplier utilizes a sigmoidoscope, an adaptable lighted tube with a camera. The system helps your medical services supplier analyze, and in some cases treat, bowel disorders and cancer.
                    </p>
                </Stack>
