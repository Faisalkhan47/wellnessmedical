            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hernia Repair</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A hernia occurs when an inner organ or other body component protrudes through the wall of muscle or tissue that typically incorporates it. Most hernias arise within the belly cavity, among the chest and the hips. The most common types of hernia are: Lingual hernia Femoral hernia Umbilical hernia Hiatal hernia Here we can speak about inguinal hernia briefly
                    </p>
                </Stack>
