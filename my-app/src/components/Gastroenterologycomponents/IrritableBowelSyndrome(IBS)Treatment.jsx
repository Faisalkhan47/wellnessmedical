...
export default function IrritableBowelSyndromeTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Irritable Bowel Syndrome (IBS) Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Irritable bowel syndrome (IBS) is an issue where abdominal pain is related to a scope of manifestations. Regularly, these include discontinuous abdominal pain joined by diarrhea, constipation, or alternating episodes of both. Different manifestations may likewise be available. IBS is an ongoing condition that you'll have to oversee the long haul. Just a few individuals with IBS have serious signs and manifestations. Certain individuals can handle their indications by overseeing diet, lifestyle, and stress. More serious manifestations can be treated with medicine and advice. IBS doesn't cause changes in entrail tissue or increment your danger of colorectal cancer.
                    </p>
                </Stack>
