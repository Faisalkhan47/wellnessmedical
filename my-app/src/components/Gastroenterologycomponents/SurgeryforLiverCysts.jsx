...
export default function SurgeryforLiverCysts() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Surgery for Liver Cysts</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Simple liver cysts liquid-filled holes in the liver normally cause no signs or manifestations and sometimes need no treatment. Notwithstanding, they might turn out to be adequately huge to cause torment or uneasiness in the upper right piece of the abdomen. The reason for straightforward liver cysts isn't known. However, they might be the consequence of a mutation present at birth.
                    </p>
                </Stack>
