...
export default function GastrointestinalPerforationRepair() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Gastrointestinal Perforation Repair</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The vast majority who have gastrointestinal perforation will have an opening in their stomach or small intestine. An opening in the large bowel, otherwise called the lower intestine, happens less habitually. Perforation can cause the substance of the stomach, small intestine, or huge gut to saturate the abdominal cavity. Bacteria can also enter, possibly prompting a condition called peritonitis, which is hazardous and requires quick treatment.
                    </p>
                </Stack>
