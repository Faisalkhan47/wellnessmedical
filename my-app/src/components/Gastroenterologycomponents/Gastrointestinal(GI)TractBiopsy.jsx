...
export default function GastrointestinalTractBiopsy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Gastrointestinal (GI) Tract Biopsy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Upper GI endoscopy is a test that looks inside your upper GI (gastrointestinal) tract. This incorporates your food pipe (esophagus), stomach, and duodenum. The test is otherwise called EGD (esophagogastroduodenoscopy). It is finished utilizing a device called an endoscope. This is a long, slight, adaptable tube with a small camera toward one end. The test helps discover issues like ulcers, infection, or growths. It can check for celiac disease, gastritis, and esophagitis. During the test, tissue tests (biopsies) might be taken and studied for problems.
                    </p>
                </Stack>
