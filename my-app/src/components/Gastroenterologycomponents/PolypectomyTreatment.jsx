...
export default function PolypectomyTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Polypectomy Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A polypectomy is the surgical removal of a polyp. Colon polyps can be eliminated through an open abdominal medical procedure, however, more-ordinarily it is performed during a colonoscopy. The endoscopist might cut off a little polyp with forceps or eliminate a bigger polyp with a catch that consumes the foundation of the polyp. A polyp is a strange mass of tissue that creates the internal mass of a hollow organ. Colon polyps are a worry since they are here and there joined by disease and the actual polyps can become cancerous.
                    </p>
                </Stack>
