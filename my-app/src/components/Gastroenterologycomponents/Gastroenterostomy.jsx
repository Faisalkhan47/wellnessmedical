...
export default function Gastroenterostomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Heller Myotomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Heller myotomy (esophagomyotomy) is viewed as the best treatment for achalasia. In this procedure, the lower piece of the esophagus is cut longwise and the lower esophageal sphincter (LES) is cut. Heller myotomy cuts through the external muscle layers that are making the esophagus constrict and squeeze shut, leaving the inward layer intact. A partial fundoplication or "wrap" at the space of the LES is by and large included a request to forestall unnecessary reflux. Heller myotomy is generally performed laparoscopically through little cuts in the abdomen.
                    </p>
                </Stack>
