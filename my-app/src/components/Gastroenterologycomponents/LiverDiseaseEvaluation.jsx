...
export default function LiverDiseaseEvaluation() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Liver Disease Evaluation</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Liver disease evaluation is any condition that causes liver inflammation or damage and may influence liver function. It is classified both by the reason and the impact it has on the liver. Causes may include infection, injury, exposure to drugs or toxic compounds, an autoimmune process, or a genetic defect that leads to the depositing and build-up of damaging substances, such as iron or copper. Impacts of these wounds on the liver might incorporate aggravation, scarring, obstructions, blood clotting irregularities, and liver failure.
                    </p>
                </Stack>
