...
export default function HiatalHerniaSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hiatal Hernia Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A hiatal hernia is when your belly bulges up into your chest through an opening for your diaphragm, the muscle that separates the two areas. The opening is referred to as the hiatus, so this situation is likewise referred to as a hiatus hernia. There are major sorts of Hiatal hernias: sliding and paraesophageal. In most cases, your esophagus (meals pipe) is going through a hiatus and attaches to your belly. In a sliding hiatal hernia, your belly and the lower part of your esophagus slide up into your chest through the diaphragm. The general public with Hiatal hernias has this type. A paraesophageal hernia is more dangerous. Your esophagus and stomach live where they must be, but part of your belly squeezes through the hiatus to take a seat subsequently in your esophagus. Your stomach can grow to be squeezed and lose its blood delivery. Your physician might name this a strangulated hernia
                    </p>
                </Stack>
