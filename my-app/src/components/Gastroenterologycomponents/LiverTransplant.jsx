            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Liver Transplant</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A liver transfer is a surgery that eliminates a liver that no longer capacities appropriately (liver failure) and replaces it with a healthy liver from a deceased donor or a part of a solid liver from a living donor. A liver transplant is normally held as a treatment alternative for individuals who have huge intricacies because of end-stage constant liver disease. A liver transfer may likewise be a treatment choice in uncommon instances of unexpected disappointment of a formerly solid liver. The quantity of individuals sitting tight for a liver transfer enormously surpasses the quantity of accessible perished contributor livers. A living donor liver transplant is an option in contrast to trusting that a perished benefactor's liver will open up.
                    </p>
                </Stack>
