...
export default function PepticUlcerTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Gastrostomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Certain individuals have clinical issues that make it difficult for them to get sufficient nourishment by mouth. A gastrostomy tube (likewise called a G-tube) is a tube embedded through the belly that brings sustenance straightforwardly to the stomach. It's one of the manners in which specialists can raise sure children who have hell eating get the liquid and calories they need.
                    </p>
                </Stack>
