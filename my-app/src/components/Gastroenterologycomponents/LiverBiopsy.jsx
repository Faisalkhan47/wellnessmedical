...
export default function LiverBiopsy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Liver Biopsy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A liver biopsy is a technique to eliminate a little piece of liver tissue, so it may be inspected under a magnifying lens for indications of damage or disease. Your primary care physician might suggest a liver biopsy if blood tests or imaging studies recommend you may have a liver issue. A liver biopsy is additionally used to decide the seriousness of the liver infection. This data helps guide treatment choices. The most widely recognized sort of liver biopsy is known as a percutaneous liver biopsy. It includes embeddings a slender needle through your abdomen into the liver and eliminating a little piece of tissue. Two different sorts of liver biopsy one utilizing a vein in the neck (transjugular) and the other utilizing a little abdominal incision (laparoscopic) additionally eliminating liver tissue with a needle.
                    </p>
                </Stack>
