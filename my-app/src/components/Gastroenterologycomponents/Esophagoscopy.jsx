...
export default function Esophagoscopy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Esophagoscopy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An esophagoscopy includes inserting a long, thin, tube-like device with a light and a camera, known as an endoscope, into your throat. The throat is a long, solid cylinder that gets food and fluids from your mouth to your stomach. Utilizing an endoscope, your primary care physician inspects your esophagus for irregularities or takes a tissue test (biopsy) to test it for specific conditions. Your doctor can likewise utilize apparatuses connected to the endoscope to perform the treatment or medical procedures.
                    </p>
                </Stack>
