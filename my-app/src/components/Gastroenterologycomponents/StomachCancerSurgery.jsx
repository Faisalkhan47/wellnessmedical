...
export default function StomachCancerSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Stomach Cancer Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Stomach cancer is a strange development of cells that starts in the stomach. The stomach is a strong sac situated in the upper center of your abdomen, just beneath your ribs. Your stomach gets and holds the food you eat and afterward assists with separating and overviewing it. Stomach cancer, otherwise called gastric cancer, can influence any piece of the stomach. In a large portion of the world, stomach cancer structure in the principle a piece of the (stomach body).
                    </p>
                </Stack>
