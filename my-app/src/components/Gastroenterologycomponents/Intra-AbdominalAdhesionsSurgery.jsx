...
export default function IntraAbdominalAdhesionsSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Intra-Abdominal Adhesions Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Intra-Abdominal Adhesions are groups of tissue that structure between stomach tissues and organs. Regularly, inner tissues and organs have dangerous surfaces, which permit them to move effectively as the body moves. Adhesions cause tissues and organs to stick together. The digestive organs are essential for the stomach related framework. Intra-Abdominal Adhesions can cause an intestinal obstruction. However, most adhesions cause no side effects or issues, others cause chronic abdominal or pelvic pain. Adhesions are additionally a significant reason for gastrointestinal deterrent and female infertility. Intra-Abdominal Adhesions are scar tissue that structures between stomach tissues and organs that makes your tissues and organs stay together. The medical procedure of the abdomen is the fundamental driver of this scar tissue.
                    </p>
                </Stack>
