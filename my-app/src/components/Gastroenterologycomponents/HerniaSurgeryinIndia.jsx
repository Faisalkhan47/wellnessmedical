...
export default function HerniaSurgeryinIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hernia Surgery in India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An organ or fatty tissue protruding through a weak area or opening in the surrounding muscle or connective tissue is known as a hernia, which is a medical ailment. Although it can appear anywhere on the body, the abdominal area is where it usually happens. Layers of muscle and connective tissue make up the abdominal wall, which aids in defending and supporting the organs located within the abdominal cavity. However, if there is a weakness or a defect in this wall, it can create an opening through which organs or tissues can bulge out.
                    </p>
                </Stack>
