...
export default function LiverCancerSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Liver Cancer Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Liver cancer is a disease that starts in the cells of your liver. Your liver is a football-sized organ that sits in the upper right piece of your mid-region, beneath your diaphragm or more your stomach. A few kinds of cancer can form in the liver. The most widely recognized kind of liver disease is hepatocellular carcinoma, which starts in the primary sort of liver cell (hepatocyte). Different kinds of liver cancer, for example, intrahepatic cholangiocarcinoma and hepatoblastoma, are significantly less normal. Malignant growth that starts in one more space of the body like the colon, lung, or breast and afterward spreads to the liver is called metastatic cancer instead of liver cancer.
                    </p>
                </Stack>
