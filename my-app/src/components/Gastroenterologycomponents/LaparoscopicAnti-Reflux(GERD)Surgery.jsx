...
export default function LaparoscopicAntiRefluxSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Laparoscopic Anti Reflux (GERD) Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    In spite of the fact that "indigestion" is frequently used to portray an assortment of digestive problems, in clinical terms, it is really a side effect of gastroesophageal reflux disease. In this condition, stomach acids reflux or "back up" from the stomach into the esophagus. Indigestion is depicted as a cruel, consuming sensation nearby in the middle of your ribs or just underneath your neck. The inclination might transmit through the chest and into the throat and neck.
                    </p>
                </Stack>
