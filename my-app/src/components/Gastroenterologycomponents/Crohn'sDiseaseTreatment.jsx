            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Crohn's Disease Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Crohn's disease is a sort of inflammatory bowel disease (IBD). It causes irritation of your digestive tract, which can prompt abdominal torment, severe diarrhea, fatigue, weight loss, and malnutrition. Inflammation caused by Crohn's disease can include various areas of the digestive tract in various individuals. This inflammation frequently spreads into the more profound layers of the bowel. Crohn's disease can be both excruciating and incapacitating and in some cases might prompt perilous difficulties.
                    </p>
                </Stack>
