...
export default function CholecystectomyTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Cholecystectomy Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A cholecystectomy is a surgery to eliminate your gallbladder a pear-shaped organ that sits just beneath your liver on the upper right half of your abdomen. Your gallbladder gathers and stores bile a digestive fluid produced in your liver. A cholecystectomy is a typical medical procedure, and it conveys just a little danger of intricacies. By and large, you can return home that very day of your cholecystectomy. A cholecystectomy is most normally performed by embeddings a minuscule camcorder and unique careful devices through four little incisions to see inside your midsection and eliminate the Gallbladder.
                    </p>
                </Stack>
