...
export default function PancreatitisTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Pancreatitis Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Pancreatitis is irritation of the pancreas. The pancreas is a long, flat organ that sits tucked behind the stomach in the upper abdomen. The pancreas produces enzymes that help absorption and hormones that assist with controlling the manner in which your body measures sugar (glucose). Pancreatitis can happen as intense pancreatitis meaning it shows up unexpectedly and goes on for quite a long time. Certain individuals foster chronic pancreatitis, which is pancreatitis that happens over numerous years. Gentle instances of pancreatitis improve with treatment. However, serious cases can cause hazardous entanglements.
                    </p>
                </Stack>
