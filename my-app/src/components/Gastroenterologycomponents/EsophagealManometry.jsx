...
export default function EsophagealManometry() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    ...
                    Esophageal Manometry</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A colostomy is an opening in the belly (abdominal wall) that is made during a medical procedure. It's normally required on the grounds that an issue is making the colon not work as expected, or disease is influencing a piece of the colon and it should be taken out. The finish of the colon (large intestine) is brought through this opening in the skin to shape a stoma. A colostomy may just be required for a brief time frame (temporary), perhaps for 3 to a half years. A temporary colostomy might be utilized when a piece of the colon needs an ideal opportunity to rest and mend from an issue or disease. Yet, once in a while illness, like disease, is more genuine and a colostomy might be required for the remainder of an individual's life (permanent).</p>
                </Stack>
