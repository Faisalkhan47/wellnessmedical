...
export default function PancreasTransplant() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Pancreas Transplant</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A pancreas transplant is surgery to put a sound pancreas from a deceased donor into an individual whose pancreas no longer capacities appropriately. Your pancreas is an organ that lies behind the lower part of your stomach. One of its principle capacities is to make insulin, a hormone that manages the ingestion of sugar (glucose) into your cells. On the off chance that your pancreas doesn't make sufficient insulin, glucose levels can ascend to undesirable levels, bringing about type 1 diabetes. Most pancreas transplants are done to treat type 1 diabetes. A pancreas transplant offers a likely remedy for this condition. Yet, it is commonly saved for those with genuine complexities of diabetes in light of the fact that the results of pancreas transplants can be significant.
                    </p>
                </Stack>
