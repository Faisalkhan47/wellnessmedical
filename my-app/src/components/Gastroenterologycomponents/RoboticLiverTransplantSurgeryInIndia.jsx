...
export default function RoboticLiverTransplantSurgeryInIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Robotic Liver Transplant Surgery In India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The term robotic liver transplant also known as robot-assisted liver transplantation which is a process that makes use of robotic technology to aid with a liver transplant. The replacement of a sick or damaged liver with a healthy liver from a donor is known as a liver transplant. The surgeon uses a console to operate the robotic arms that are part of the robotic equipment utilized in this treatment. These robotic arms have cameras and devices for the operation as well as a magnified view of the surgical site. While seated at the console, the surgeon controls the robotic arms, deftly and precisely manipulating the instruments.
                    </p>
                </Stack>
