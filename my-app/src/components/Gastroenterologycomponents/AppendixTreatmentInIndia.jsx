...
export default function AppendixTreatmentInIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Appendix Treatment In India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The appendix is a little pouch with fingers on it that connects the small and big intestines. It is a vestigial organ, which means that throughout development, it has mostly or completely lost all of its original function. The lower right side of the abdomen usually is where the appendix is located.
                    </p>
                </Stack>
