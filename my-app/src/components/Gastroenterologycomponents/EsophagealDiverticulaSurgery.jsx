...
export default function EsophagealDiverticulaSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Esophageal Diverticula Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An esophageal diverticulum is a pouch that distends outward in a powerless part of the esophageal lining. This pocket-like design can show up anyplace in the esophageal lining between the throat and stomach. Esophageal diverticula (plural of diverticulum) are grouped by their area inside the throat: Zenker's diverticula (pharyngoesophageal) is the most widely recognized kind of diverticula of the esophagus. Zenker's diverticula are generally situated toward the rear of the throat, simply over the throat Midthoracic diverticula, in the mid-chest Epiphanic diverticula, above the diaphragm
                    </p>
                </Stack>
