            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Wrinkle Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The effectiveness of anti-wrinkle creams depends in part on the active ingredients. Retinol, antioxidants, and some peptides may result in slight to modest improvements in wrinkles. Products that contain alpha-hydroxy acids — such as glycolic acid and lactic acid — may help remove the top layer of dead skin and stimulate new skin growth. With nonprescription wrinkle creams, your results, if any, are limited and usually short-lived because these creams contain less active ingredients than do prescription creams.
                    </p>
                </Stack>
