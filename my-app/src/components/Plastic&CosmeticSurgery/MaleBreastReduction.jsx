            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Male Breast Reduction</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Hormonal imbalances sometimes develop female-like breasts in men. This condition is known as gynecomastia or commonly referred to as ‘man-boobs’ that is caused by the swelling of breast tissues in males. While regular exercise expanding several months will marginally reduce this swelling, in order to have a chiseled body, one needs to be patient to see that result naturally. However, if you want to see quick results, you can opt for gynecomastia male breast reduction surgery.
                    </p>
                </Stack>
