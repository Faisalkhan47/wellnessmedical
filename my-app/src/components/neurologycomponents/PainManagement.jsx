            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Pain Management</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The Pain Management Center puts a patient’s health and quality of life above all else. At the Pain Center, we understand that pain can affect not only a person's physical and emotional well-being but also their ability to participate in everyday activities, whether at home or at work. Our highly trained, board-certified pain management doctors are dedicated to alleviating and managing this pain by employing a multidisciplinary approach. Our team works closely with patients and their families to help them lead active, productive, and rewarding lives.
                    </p>
                </Stack>
