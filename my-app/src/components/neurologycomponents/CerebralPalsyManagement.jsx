...
export default function CerebralPalsyManagement() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Cerebral Palsy Management</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A cerebral palsy is a group of disorders that affect movement and muscle tone or posture. It's caused by damage that occurs to the immature brain as it develops, most often before birth. Signs and symptoms appear during infancy or preschool years.
                    </p>
                </Stack>
