...
export default function NeurointerventionalRadiologyTreatmentinIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Neurointerventional Radiology Treatment in India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Neurointerventional radiology, also known as interventional neuroradiology or endovascular neurosurgery, is a branch of medicine that enables medical professionals to identify and treat a wide range of conditions that affect the brain, spinal cord, and blood vessels of the central nervous system. It entails performing therapeutic interventions while using minimally invasive procedures and cutting-edge imaging tools to treat neurovascular diseases.
                    </p>
                </Stack>
