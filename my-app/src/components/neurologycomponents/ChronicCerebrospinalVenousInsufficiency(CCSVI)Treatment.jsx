...
export default function ChronicCerebrospinalVenousInsufficiencyTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Chronic Cerebrospinal Venous Insufficiency (CCSVI) Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Chronic Cerebrospinal Venous Insufficiency (CCSVI) is a term used to describe a potential reduction in blood flow in the major veins that drain blood from the brain and spinal cord over a prolonged period. The condition was first described as being a possible contributor to MS
                    </p>
                </Stack>
