...
export default function VentriculoperitonealShunting() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Ventriculoperitoneal shunting (VP)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Ventriculoperitoneal shunting is a surgery that is performed to address hydrocephalus which is characterized by an accumulation of cerebrospinal fluid in the ventricles or cavities of the brain.
                    </p>
                </Stack>
