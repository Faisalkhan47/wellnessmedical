...
export default function CaudaEquinaSyndromeTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Cauda Equina Syndrome Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The cauda equina is the sack of nerve roots (nerves that leave the spinal cord between spaces in the bones of the spine to connect to other parts of the body) at the lower end of the spinal cord. These nerve roots provide the ability to move and feel sensations in the legs and the bladder.
                    </p>
                </Stack>
