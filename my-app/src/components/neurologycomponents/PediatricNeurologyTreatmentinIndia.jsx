...
export default function PediatricNeurologyTreatmentinIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Pediatric neurology treatment in India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A medical specialty called pediatric neurology is dedicated to identifying and treating neurological conditions in young patients. It focuses on investigating, identifying, and treating illnesses that impact the neurological system of a kid or adolescent. The nervous system consists brain, spinal cord, nerves and muscles. Pediatric neurologists are specialists who have completed specialty training in both neurology and pediatrics. They are specialists in diagnosing and managing a variety of pediatric neurological conditions.
                    </p>
                </Stack>
