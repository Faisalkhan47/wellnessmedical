...
export default function EndoscopicFullThicknessResection() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Endoscopic Full-Thickness Resection</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Endoscopic full-thickness resection, or EFTR, is a minimally invasive procedure to remove (resect) benign or cancerous tumors from the gastrointestinal tract using an endoscope, a flexible, tube-like instrument. “Full-thickness” refers to how much of the gastrointestinal wall is removed. With other procedures, only the superficial layers (mucosa and submucosa) might be removed, while the EFTR procedure aims to remove deeper tissues to ensure complete tumor removal. EFTR is typically an outpatient procedure. Many patients can go home the next day. Specially trained gastroenterologists (physicians who treat the GI tract) perform EFTR. Patients who undergo EFTR may have a shorter treatment time and faster recovery than those who have more invasive surgery.
                    </p>
                </Stack>
