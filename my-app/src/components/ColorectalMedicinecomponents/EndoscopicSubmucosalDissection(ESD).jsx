...
export default function EndoscopicSubmucosalDissection() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Endoscopic Submucosal Dissection (ESD)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Endoscopic submucosal dissection (ESD) is an outpatient procedure to remove deep tumors from the gastrointestinal (GI) tract. Gastroenterologists (doctors specially trained to treat the GI tract) use flexible, tube-like imaging tools called endoscopes to perform ESD. Most people go home the same day. Only a few centers in the United States perform ESD because the procedure requires a high degree of expertise with the procedure. Our gastroenterologists have helped many patients recover faster, often with less pain than with open or laparoscopic surgical procedures.
                    </p>
                </Stack>
