...
export default function Proctoscopy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Proctoscopy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Proctoscopy is a procedure used to diagnose problems with your rectum and anus. The rectum is the end of your large intestine (colon). The anus is the opening of the rectum. The device used to perform this procedure is a hollow tube called a proctoscope. Light and lens on the device let your doctor examine the inside of your rectum. This procedure is also called rigid sigmoidoscopy. It’s different from a flexible sigmoidoscopy, which is another type of procedure used to diagnose problems with the lower portion of the colon.
                    </p>
                </Stack>
