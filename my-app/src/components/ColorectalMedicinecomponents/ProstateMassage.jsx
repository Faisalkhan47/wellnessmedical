...
export default function ProstateMassage() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Prostate Massage Therapy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Prostate massage is a way to empty fluids from your prostate ducts. This therapy might offer some health benefits, or your doctor might use it to diagnose a problem. But it’s not something doctors usually recommend or use for testing or treatment. The prostate is a small gland about the size of a golf ball between the base of the penis and the rectum. Its main job is to make the fluid, also called semen, that helps sperm travel and survives. Massaging the prostate empties that fluid out of your prostate ducts. To do the procedure, your doctor will slide a gloved finger into your rectum, then massage or press on the prostate from there. It may feel slightly uncomfortable, but it doesn’t take long.
                    </p>
                </Stack>
