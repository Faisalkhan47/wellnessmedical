...
export default function AnorectalManometry() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Anorectal Manometry</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Anorectal manometry is a test that measures how well the rectum and anal sphincter are working. The anorectal manometry test is commonly given to people who have fecal incontinence, constipation, and Hirschsprung's disease in children. Anorectal manometry is a test that measures how well the rectum and anal sphincters work together to eliminate stool (feces). The anal sphincter has an internal and external sphincter, or valve, which helps to control the continence (passing) of stool. These valves are made of muscles that control the opening and closing of the anus. The test is performed to see how well it is working.
                    </p>
                </Stack>
