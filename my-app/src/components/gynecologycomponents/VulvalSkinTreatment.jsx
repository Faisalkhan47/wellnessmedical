...
export default function VulvalSkinTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Vulval Skin Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The vulva is the area of female sex organs that lie outside of the vagina. These organs incorporate folds of delicate tissue called the (labia signifies "lips"). The labia has two sections. The furthest fold is known as the labia majora. The second arrangement of folds, called the labia minora, is encased inside the labia majora. Numerous women experience awkward, vaginal diseases (vaginitis) at some time. The area around the passage to the vagina (vulva) can likewise become irritated. Steps can be taken to mitigate and forestall vulvar uneasiness and vaginal contaminations.
                    </p>
                </Stack>
