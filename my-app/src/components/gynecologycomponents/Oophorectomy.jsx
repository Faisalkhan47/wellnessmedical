...
export default function Oophorectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Oophorectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An oophorectomy (oh-of-uh-REK-tuh-me) is a surgical procedure to remove one or both of your ovaries. Your ovaries are almond-formed organs that sit on each side of the uterus in your pelvis. Your ovaries contain eggs and produce chemicals that control your period. At the point when oophorectomy includes eliminating both ovaries, it's called bilateral oophorectomy. At the point when the medical procedure includes eliminating just a single ovary, it's called unilateral oophorectomy. An oophorectomy should likewise be possible as a feature of an activity to eliminate the uterus (hysterectomy).
                    </p>
                </Stack>
