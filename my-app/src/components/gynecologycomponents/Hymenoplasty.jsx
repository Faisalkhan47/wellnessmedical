            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hymenoplasty</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    This strategy is done to fix the tissue and restore the presence of intact hymen. The hymen gets typically torn during first intercourse, during horse riding, cycling, tampon insertion, and so on. In many cultures, intact hymen signifies virginity and is viewed as a significant factor in marriage. Restoration of hymen precisely is a straightforward, safe technique to fix the hymen and is performed on the individual’s needs. Hymenoplasty, otherwise called hymenorrhaphy. Restoration of the hymen is additionally alluded to as revirginization.
                    </p>
                </Stack>
