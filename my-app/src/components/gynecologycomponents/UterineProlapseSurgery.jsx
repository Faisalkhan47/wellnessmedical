...
export default function UterineProlapseSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Uterine Prolapse Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Uterine prolapse is a condition where the internal supports of the uterus become weak over time. The uterus is one of the organs that make up part of your regenerative framework. Additionally called the womb, the uterus is situated in your pelvis and is generally formed like a pear.
                    </p>
                </Stack>
