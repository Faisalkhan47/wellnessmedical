...
export default function IntrauterineDevicePlacement() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Intrauterine Device (IUD) Placement</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An intrauterine device (IUD) is a form of birth control. It prevents pregnancy either by damaging or killing a man’s sperm or blocking it from entering a woman’s uterus. An IUD is a little, T-shaped device with a string attached to the end. The reason for the string is to ensure the IUD remains set up. It likewise is the means by which a specialist eliminates the device.
                    </p>
                </Stack>
