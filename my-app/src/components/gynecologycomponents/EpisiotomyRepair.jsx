...
export default function EpisiotomyRepair() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Episiotomy Repair</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An episiotomy is an incision through the space between your vaginal opening and your anus. This region is known as the perineum. This surgery is done to make your vaginal opening bigger for childbirth. Regularly, when the baby's head is seen, your medical care supplier will facilitate your baby's head and chin out of your vagina. When the child's head is out, the shoulders and the remainder of the body follow.
                    </p>
                </Stack>
