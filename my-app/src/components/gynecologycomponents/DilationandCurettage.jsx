...
export default function DilationandCurettage() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Dilation and curettage</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Dilation and curettage (D&C) is a procedure to remove tissue from inside your uterus. Specialists perform dilation and curettage to analyze and treat certain uterine conditions like heavy bleeding or to clear the uterine lining after a miscarriage or abortion.
                    </p>
                </Stack>
