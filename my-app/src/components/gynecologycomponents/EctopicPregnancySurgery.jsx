...
export default function EctopicPregnancySurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Ectopic Pregnancy Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Pregnancy begins with a fertilized egg. Normally, the fertilized egg attaches to the lining of the uterus. An ectopic pregnancy occurs when a fertilized egg implants and grows outside the main cavity of the uterus. An ectopic pregnancy frequently happens in a fallopian tube, which conveys eggs from the ovaries to the uterus. This sort of ectopic pregnancy is known as tubal pregnancy. At times, an ectopic pregnancy happens in different spaces of the body, like the ovary, abdominal cavity, or the lower part of the uterus (cervix), which interfaces with the vagina. An ectopic pregnancy can't continue ordinarily. The treated egg can't endure, and the developing tissue may cause perilous draining whenever left untreated.
                    </p>
                </Stack>
