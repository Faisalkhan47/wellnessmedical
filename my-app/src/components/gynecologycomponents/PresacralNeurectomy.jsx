...
export default function PresacralNeurectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Presacral Neurectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Presacral Neurectomy is the careful evaluation of the presacral plexus, the group of nerves that directs the aggravation signal from the uterus to the mind. Demonstrated for the treatment of central pelvic pain including extreme dysmenorrhea. Laparoscopic Presacral Neurectomy (LPSN) is a similar strategy done by an insignificantly intrusive technique. It is a careful methodology in patients with focal dysmenorrheal (painful periods), adenomyosis, and endometriosis.
                    </p>
                </Stack>
