...
export default function FibroidRemoval() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Fibroid Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Fibroids are noncancerous developments of the uterus that regularly show up during childbearing years. Likewise called leiomyomas or myomas, fibroids aren't related to an expanded danger of uterine cancer and never form into cancer. Fibroids range in size from seedlings, imperceptible by the natural eye, to cumbersome masses that can contort and amplify the uterus. You can have a single fibroid or multiple ones. In outrageous cases, multiple fibroids can grow the uterus such a lot that it arrives at the rib cage and can add weight.
                    </p>
                </Stack>
