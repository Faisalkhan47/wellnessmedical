...
export default function LaparoscopySurgeryInIndia() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Laparoscopy Surgery In India</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Laparoscopy or laparoscopic surgery is a type of surgical procedure that allows a surgeon to access the inside of the abdomen (tummy area) and pelvis without having to make large incisions in the abdomen area. Laparoscopic surgery is performed for the operations of the abdomen with 6 to 12 inch long cuts, hence is also known as keyhole surgery or minimally invasive surgery.
                    </p>
                </Stack>
