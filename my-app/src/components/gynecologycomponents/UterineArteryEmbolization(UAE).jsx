...
export default function UterineArteryEmbolization() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Uterine Artery Embolization (UAE)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Uterine supply route embolization (UAE) is a negligibly obtrusive treatment used to stop genuine pelvic dying. The reason for such bleeding could be uterine fibroids (noncancerous growths inside the uterus), injury, dangerous (cancerous) gynecological cancers, or hemorrhage following childbirth, among different conditions.
                    </p>
                </Stack>
