...
export default function FemaleSterilization() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Female Sterilization</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Female sterilization provides permanent and very effective protection against pregnancy. FS is a medical procedure, yet more often than not it requires just light sedation and can be given in an outpatient office. It very well may be securely given during the quick post-pregnancy or postabortion period or as a span technique (28 days or more after last conveyance). Fresher non-surgical techniques for female sanitization, called transcervical approaches, including coming to the fallopian tubes through the vagina and uterus.
                    </p>
                </Stack>
