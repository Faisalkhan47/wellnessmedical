...
export default function Vaginectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Vaginectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Vaginectomy is a surgery used to treat vaginal cancer or as a piece of gender reassignment medical procedure. It tends to be partial or radical. It is radical if the entire vagina is taken out, or partial if by some stroke of good luck the upper piece of the organ is eliminated. More often than not, it is performed with a complete abdominal hysterectomy.
                    </p>
                </Stack>
