            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Cervical Cerclage</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Cervical cerclage is an operation where your doctor puts a single stitch around your cervix, the opening to your uterus. The stitch sews your cervix closed. Surgeons perform cerclage to forestall late (second trimester) unnatural birth cycles and preterm (early) conveyance. Women might be at risk for these complexities on account of cervical incompetence (when your cervix opens too early during pregnancy). Cervical cerclage should be possible through the vagina (transvaginal cervical cerclage) or, less formally, through the mid-region (transabdominal cervical cerclage).
                    </p>
                </Stack>
