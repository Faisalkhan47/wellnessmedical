...
export default function Cardiotocography() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Cardiotocography (CTG)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Is ceaseless cardiotocography (CTG) to electronically monitor babies. Observing babies' heartbeats is utilized to really look at prosperity during labor. Tuning in and recording the baby's pulse means recognizing infants who are turning out to be shy of oxygen and may profit from an early conveyance by cesarean segment or instrumental vaginal birth.
                    </p>
                </Stack>
