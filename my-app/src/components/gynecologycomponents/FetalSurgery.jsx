...
export default function FetalSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Fetal Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A fetal medical procedure is a strategy performed on an unborn baby (fetus) in the uterus (in utero) to assist with working on the drawn-out result of children with explicit birth defects. Since these deformities regularly deteriorate as a fetus develops, a fetal medical procedure done by a group of specialists centers around treating and working on the conditions before birth.
                    </p>
                </Stack>
