...
export default function Hymenotomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hymenotomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A Hymenotomy (some of the time alluded to as hymenotomy) is a surgery where an opening is made in the hymen. It is normally utilized when hymen that is unusually thick, septate, or in any case, block the progression of the period. At the point when the hymen just has a little opening, the medical procedure can be utilized to ease torment and uneasiness.
                    </p>
                </Stack>
