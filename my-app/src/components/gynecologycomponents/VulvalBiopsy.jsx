...
export default function VulvalBiopsy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Vulval Biopsy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A vulvar biopsy is a test used to check for vulvar cancer or another skin disease affecting the vulva. The vulva is the outer part of a woman’s genitals. During a biopsy, little tissue tests are taken from areas of skin that look changed (abnormal). The tissue is then checked in a lab for cancer and different kinds of skin infections. Your expert may need you to have a biopsy. This is the most ideal approach to see if or not you have a vulval condition or cancer.
                    </p>
                </Stack>
