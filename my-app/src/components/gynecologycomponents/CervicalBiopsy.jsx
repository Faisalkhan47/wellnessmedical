...
export default function CervicalBiopsy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Cervical Biopsy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A cervical biopsy is a procedure to remove tissue from the cervix to test for abnormal or precancerous conditions or cervical cancer. The cervix is the lower, narrow part of the uterus. It forms a canal that opens into the vagina. Cervical biopsies should be possible severally. The biopsy can eliminate an example of tissue for testing. It can likewise be utilized to totally take out abnormal tissue. It can likewise treat cells that might transform into cancer. There are three types of biopsy: punch biopsy, cone biopsy, and Endocervical curettage (ECC).
                    </p>
                </Stack>
