...
export default function VaginalVaultProlapseSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Vaginal Vault Prolapse Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The top of the vagina (known as the “vaginal vault”) droops down into the vaginal canal. This usually occurs in women who have had a hysterectomy (removal of the uterus). Prolapse happens when a woman’s pelvic floor muscles, tissues, and ligaments weaken and stretch. This can bring about organs exiting their ordinary position. Vaginal prolapse refers to when the highest point of the vagina additionally called the vaginal vault, sags and falls into the vaginal canal. In serious cases, the vagina can protrude outside of the body.
                    </p>
                </Stack>
