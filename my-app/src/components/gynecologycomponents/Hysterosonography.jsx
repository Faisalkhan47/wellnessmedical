...
export default function Hysterosonography() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hysterosonography</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Hysterosonography, additionally called sonohysterography, utilizes sound waves to create images of the inside of a women's uterus and assist with diagnosing unexplained vaginal bleeding. Hysterosonography is performed a lot like a gynecologic test and includes the inclusion of the transducer into the vagina after you void your bladder. Utilizing a little tube inserted into the vagina, your primary care physician will infuse a limited quantity of clean saline into the cavity of the uterus and study the coating of the uterus utilizing the ultrasound transducer. Ultrasound doesn't utilize ionizing radiation, has no known hurtful impacts, and gives an unmistakable image of delicate tissues that don't appear well on x-ray images.
                    </p>
                </Stack>
