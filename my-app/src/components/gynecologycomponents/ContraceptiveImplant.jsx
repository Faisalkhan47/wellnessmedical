...
export default function ContraceptiveImplant() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Contraceptive Implant</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A Contraceptive implants are a long-term birth control option for women. A contraceptive implant is an adaptable plastic rod about the size of a matchstick that is put under the skin of the upper arm. It delivers a low, consistent portion of a progestational hormone to thicken cervical mucus fluid and thin the lining of the uterus (endometrium). Contraceptive implants commonly smother ovulation too. Contraceptive implants are radio-obscure and can be seen on X-rays as valuable for recognizing the area of an implant.
                    </p>
                </Stack>
