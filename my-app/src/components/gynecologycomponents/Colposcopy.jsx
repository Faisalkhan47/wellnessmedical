...
export default function Colposcopy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Colposcopy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A colposcopy is a type of women’s health exam. It’s often performed by your family doctor or a gynecologist. He or she uses an instrument with a magnifying lens and a light called a colposcope. It focuses light on the cervix and magnifies the view. A colposcopy regularly is done in the event that you have an abnormal Pap smear. The reason for the test is to get a nearby look at the cervix. The specialist can see and determine issues not seen with the naked eye. Your medical care supplier utilizes colposcopy to see the opening to the uterus, called the cervix, and the vagina.
                    </p>
                </Stack>
