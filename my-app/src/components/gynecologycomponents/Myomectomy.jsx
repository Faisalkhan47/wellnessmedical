            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Myomectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Myomectomy is a surgery to eliminate uterine fibroids — additionally called leiomyomas (lie-o-my-O-muhs). These normal noncancerous developments show up in the uterus. Uterine fibroids normally create during childbearing years, but they can occur at any age.
                    </p>
                </Stack>
