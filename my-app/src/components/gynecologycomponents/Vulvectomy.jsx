...
export default function Vulvectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Vulvectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Vulvectomy is a medical procedure to eliminate a few or the entirety of your external genitals. The medical procedure is done to eliminate diseased areas such as cancer, precancer, or lichen sclerosis. The vulva area has a few sections. These incorporate the inward and external labia and the clitoris. The vulva area likewise incorporates the opening of the vagina and the opening of the urinary tract (urethra).
                    </p>
                </Stack>
