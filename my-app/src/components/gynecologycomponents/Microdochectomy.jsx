...
export default function Microdochectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Microdochectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A Microdochectomy is a surgery where a single duct is eliminated from the areola areolar complex. It is generally attempted when a patient has nipple discharge from a single duct. The patient will be asked not to crush the nipple before attending the operating theatre.
                    </p>
                </Stack>
