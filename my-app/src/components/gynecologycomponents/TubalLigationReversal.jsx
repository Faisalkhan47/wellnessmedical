...
export default function TubalLigationReversal() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Tubal Ligation Reversal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Women who have had their "tubes tied" can have the procedure surgically reversed. The tubes are reanastamosed (untied) through a surgery that is frequently an insignificantly intrusive, same-day medical procedure. The medical procedure can be performed minimally invasive or robotic techniques. The achievement of TLR will rely on the woman's age, type of tubal ligation originally performed, and the length of her remaining healthy tubes. About 50-80 percent of women who have TLR proceed to have a fruitful pregnancy.
                    </p>
                </Stack>
