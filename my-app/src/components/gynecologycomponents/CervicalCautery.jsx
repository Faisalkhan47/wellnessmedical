...
export default function CervicalCautery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Cervical Cautery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Cervical Cauterization means cautery of the cervix. In request to truly get it, we need to know what the cervix is and what cauterization is. The cervix is the lower part of the uterus (or the womb). It is otherwise called the uterine cervix. The unborn child or the baby fills in the upper piece of the body of the uterus. It is the cervix that associates the primary body of the uterus to the vagina lower down.
                    </p>
                </Stack>
