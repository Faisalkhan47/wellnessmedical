            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Antenatal Care (ANC)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Antenatal care is fundamental for securing the well-being of women and their unborn children. Through this type of preventive medical care, women can gain from skilled wellbeing faculty about sound practices during pregnancy, better comprehend cautioning signs during pregnancy and childbirth, and get social, passionate, and mental help at this crucial time in their lives. Through antenatal care, pregnant women can likewise get micronutrient supplementation, treatment for hypertension to forestall eclampsia, just as an inoculation against lockjaw. Antenatal consideration can likewise give HIV testing and drugs to forestall mother-to-child transmission of HIV.
                    </p>
                </Stack>
