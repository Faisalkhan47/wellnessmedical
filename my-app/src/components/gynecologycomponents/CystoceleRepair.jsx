...
export default function CystoceleRepair() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Cystocele Repair</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A cystocele is also known as a prolapsed, herniated, dropped or fallen bladder (where your urine or “water” is stored) occurs when ligaments that hold your bladder up and the muscle between a woman’s vagina and bladder stretches or weakens, allowing the bladder to sag into the vagina.
                    </p>
                </Stack>
