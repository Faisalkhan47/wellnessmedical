...
export default function UterusTransplant() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Uterus Transplant</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A uterus transplant is a promising new technique that assists a few ladies with conquering uterine factor infertility (UFI) and carry a baby. UFI is a condition wherein a lady can't get pregnant on the grounds that she was brought into the world without a uterus, had it carefully eliminated during a hysterectomy, or has a uterus that doesn't work as expected. UFI is assessed to influence as numerous as 5% of childbearing-aged ladies worldwide and used to be an irreversible type of female infertility.
                    </p>
                </Stack>
