...
export default function FetalEchocardiography() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Fetal Echocardiography</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Fetal echocardiography is an ultrasound test performed during pregnancy to evaluate the heart of the unborn baby. A little test called a transducer is set on the mother's abdomen, which emanates sound waves at a frequency too high to possibly be heard. The ultrasonic sound waves travel through the mother's and baby’s skin, to other body tissues, lastly to the baby’s heart, where the sound waves bounce off the heart designs and return to the transducer. The transducer distinguishes the reflected waves and sends them to a machine for interpretation, bringing about a created picture of the heart. This test isn't excruciating and makes no mischief to the baby. By and large, it requires around 45-an hours and a half to perform, contingent upon the intricacy of the fetus’ heart.
                    </p>
                </Stack>
