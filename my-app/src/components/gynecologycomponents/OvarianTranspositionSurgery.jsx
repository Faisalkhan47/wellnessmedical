...
export default function OvarianTranspositionSurgery() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Ovarian Transposition Surgery</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Ovarian transposition alludes to a careful repositioning of the ovaries outside the pelvic radiation treatment (RT) field to lessen ovarian exposure. Ovarian transposition is by and large performed utilizing a negligibly obtrusive surgery. The fallopian cylinders might be cut across from the uterus to guarantee satisfactory activation of the ovaries. Metal staples are set around the ovaries in their new areas to help treatment suppliers in picturing the ovaries, to try not to remember them for the RT fields. This methodology ought to be performed before RT simulation.
                    </p>
                </Stack>
