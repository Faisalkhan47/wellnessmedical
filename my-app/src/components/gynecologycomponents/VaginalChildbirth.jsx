...
export default function VaginalChildbirth() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Vaginal Child Birth</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Some women choose to give birth using no medications at all, depending rather on methods like unwinding and controlled breathing for pain. With vaginal childbirth, the mother is in charge of her body, generally with a labor aide tenderly directing and supporting her through the phases of labor. For some mothers-to-be, having vaginal childbirth isn't tied in with being "courageous" or a "saint" it's tied in with regarding labor and delivery as a natural event. Many women find the experience, despite the pain, extremely empowering and rewarding.
                    </p>
                </Stack>
