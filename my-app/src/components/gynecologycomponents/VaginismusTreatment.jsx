...
export default function VaginismusTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Vaginismus Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The vagina contains muscles that can contract, making the vaginal opening more modest. These muscles contract during orgasm and can likewise be contracted under cognizant control. Although, a few women experience rehashed, progressing compulsory constrictions of the vagina. Now and again, they don't know that this is happening until sex becomes difficult. The rehashed compressions make section during intercourse troublesome or incomprehensible. The essential indication of vaginismus is torment during intercourse, vaginal tests, and different types of vaginal penetration.
                    </p>
                </Stack>
