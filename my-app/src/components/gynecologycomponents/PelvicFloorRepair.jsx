...
export default function PelvicFloorRepair() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Pelvic Floor Repair</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The most common surgery for prolapse is pelvic floor repair, which is a broad term used to describe simple surgical repairs of the pelvic floor. More specifically, the term anterior repair refers to correction of the front wall of the vagina; and posterior repair refers to correction of the back wall of the vagina. If the uterus is prolapsing, it may be removed (hysterectomy). On the off chance that you have effectively had a hysterectomy, the highest point of the vagina (vault) can be lifted up and upheld.
                    </p>
                </Stack>
