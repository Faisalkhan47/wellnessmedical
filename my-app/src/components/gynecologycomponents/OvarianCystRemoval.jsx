...
export default function OvarianCystRemoval() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Ovarian Cyst Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Ovarian cysts are fluid-filled sacs or pockets in an ovary or on its surface. Females have two ovaries each about the size and state of almonds on each side of the uterus. Eggs (ova), which create and develop in the ovaries, are delivered in month-to-month cycles during the childbearing years. Many females have ovarian cysts sooner or later. Most ovarian cysts present practically no uneasiness and are innocuous. The larger part vanishes without treatment inside a couple of months. However, ovarian cysts particularly those that have burst can cause serious signs. To secure your health, get ordinary pelvic tests and know the symptoms that can signal a potentially serious problem.
                    </p>
                </Stack>
