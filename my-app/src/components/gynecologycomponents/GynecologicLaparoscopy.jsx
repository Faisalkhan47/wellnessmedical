...
export default function GynecologicLaparoscopy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Gynecologic Laparoscopy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Gynecologic laparoscopy is a procedure used to examine tissue or perform surgery within a female’s abdomen or pelvis. A laparoscope is utilized to see inside the body through little (cuts) in the abdomen. Laparoscopy is a sort of diagnostic surgical method that your doctor can use to peer inside your body at your stomach and reproductive organs. This technique can likewise be utilized to gather tests of tissue (biopsies) for testing.
                    </p>
                </Stack>
