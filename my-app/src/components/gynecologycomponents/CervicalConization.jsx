...
export default function CervicalConization() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Cervical Conization</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Cervical conization is the removal of a section of the cervix. The cervix is the lower part of the uterus. This procedure accesses the cervix through the vagina. A cervical cone biopsy is a medical procedure to eliminate tissue from the cervix. The cervix is the little round opening at the lower part of the uterus (womb). The cervix interfaces the uterus to the highest point of the vagina (birth canal). You may require a cervical biopsy if cells that are not ordinary are found during a Pap test. Yet, a cone biopsy may likewise be utilized to treat early disease and different issues. Now and then rather than a medical procedure to eliminate your uterus, cone biopsy should be possible so you can in any case have babies.
                    </p>
                </Stack>
