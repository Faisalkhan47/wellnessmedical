...
export default function IntrauterineDeviceRemoval() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Intrauterine Device (IUD) Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An intrauterine device or IUD is a small, T-shaped device. It is put in the uterus by your medical care supplier to forestall pregnancy, reduce heavy menstrual bleeding, or help reduce painful menstrual cramps or pelvic pain.
                    </p>
                </Stack>
