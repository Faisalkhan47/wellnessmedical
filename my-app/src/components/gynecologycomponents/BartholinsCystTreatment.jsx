...
export default function BartholinsCystTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Bartholin's Cyst Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    The Bartholin's (BAHR-toe-Linz) glands are located on each side of the vaginal opening. These glands discharge liquid that lubricates up the vagina. Now and then the openings of these glands become blocked, making liquid back up into the gland. The outcome is moderately effortless growing called a Bartholin's cyst. In case the liquid inside the cyst gets contaminated, you may foster an assortment of discharge encompassed by aggravated tissue (abscess). A Bartholin's cyst or abscess is common.
                    </p>
                </Stack>
