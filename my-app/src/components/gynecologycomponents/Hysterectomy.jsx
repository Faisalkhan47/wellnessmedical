            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hysterectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Hysterectomy, or expulsion of your uterus, can treat different female clinical issues. Our experienced gynecological specialists perform the procedure to treat a scope of noncancerous, precancerous, and carcinogenic conditions that can influence your reproductive system. During the activity, your specialist may likewise eliminate different pieces of your conceptive framework, like the cervix, ovaries, or fallopian tubes, contingent upon the justification of your hysterectomy. After surgery, you will no longer have menstrual periods and will not be able to become pregnant.
                    </p>
                </Stack>
