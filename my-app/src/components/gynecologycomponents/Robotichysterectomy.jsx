...
export default function Robotichysterectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Robotic Hysterectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A hysterectomy is a medical procedure to eliminate your uterus or your uterus plus your cervix. On the off chance that you need a hysterectomy, your doctor may suggest a robot-assisted medical procedure. During robotic surgery, your primary care physician plays out the hysterectomy with instruments that are gone through little stomach cuts. The amplified, 3D view makes incredible accuracy, adaptability, and control.
                    </p>
                </Stack>
