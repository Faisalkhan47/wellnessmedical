...
export default function MolarPregnancyTreatment() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Molar Pregnancy Treatment</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A molar pregnancy is otherwise called a hydatidiform mole is a rare complication of pregnancy described by the unusual development of trophoblasts, the cells that ordinarily form into the placenta. There are two sorts of molar pregnancy, complete molar pregnancy, and partial molar pregnancy. In a complete molar pregnancy, the placental tissue is abnormal and swollen and appears to form fluid-filled cysts. There's additionally no arrangement of fetal tissue. In a partial molar pregnancy, there might be ordinary placental tissue alongside unusually shaping placental tissue. There may likewise be the development of a fetus yet the fetus can't endure and is usually miscarried early in the pregnancy.
                    </p>
                </Stack>
