...
export default function Vaginoplasty() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Vaginoplasty</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Vaginoplasty is a surgical procedure during which surgeons remove the penis and testicles and create a functional vagina. This accomplishes a goal of gender dysphoria and considers sexual movement with compatible genitalia. The exceptionally touchy skin and tissues from the penis are protected and used to develop the vaginal covering and assemble a clitoris, bringing about private parts with suitable sensations. Scrotal skin is utilized to build the profundity of the vaginal canal. Penile, scrotal, and groin skin are refashioned to make the labia majora and minora, and the urethral opening is migrated to a suitable female position. The end-product is an anatomically congruent, aesthetically appealing, and functionally intact vagina. Except if there is a clinical motivation to do as such, the prostate organ isn't eliminated.
                    </p>
                </Stack>
