...
export default function EndometrialAblation() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Endometrial Ablation</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Endometrial ablation is a procedure that surgically destroys (ablates) the lining of your uterus (endometrium). The objective of endometrial removal is to diminish the menstrual flow. In certain ladies, the menstrual flow might stop totally. No cuts are required for endometrial ablation. Your surgeon inserts slim devices through the path between your vagina and uterus (cervix). The instruments differ, contingent upon the technique used to remove the endometrium. Strategies may incorporate extreme cold, warmed liquids, microwave energy, or high-energy radio frequencies.
                    </p>
                </Stack>
