...
export default function PelvicFloorElectricalStimulator() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Pelvic Floor Electrical Stimulator</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Electrical incitement of the pelvic floor is an easy and powerful method that treats urinary incontinence, frequency, and urgency. During pelvic floor electrical incitement, a second rate electrical flow invigorates the muscles to an agreement to make a strong reaction like Kegels (an activity for your pelvic floor muscles). This movement strengthens your pelvic floor muscles, which can improve urgency, urinary frequency, and incontinence, and increase the strength of the pelvic floor and vaginal muscles.
                    </p>
                </Stack>
