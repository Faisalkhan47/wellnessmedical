...
export default function CervicalPolypRemoval() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Cervical Polyp Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Cervical polyps are benign growths that can form on the cervix, the lower part of the uterus that connects with the vagina. Frequently they influence women who are more than 20 and have given birth to more than one child. Their motivation is obscure in spite of the fact that inflammation, infection, or abnormal response to estrogen are possible. Most polyps are distinguished during routine pelvic tests of pre-menopausal women. Regularly there are no side effects showing polyps.
                    </p>
                </Stack>
