...
export default function PessaryPlacement() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Pessary Placement</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A pessary is a prosthetic gadget that can be embedded into the vagina to help its inside structure. It's normally utilized in the case of urinary incontinence and a vaginal or pelvic organ prolapse. A prolapse happens when the vagina or another organ in the pelvis gets out of its standard spot. The help a pessary gives can assist a woman with staying away from a pelvic medical procedure. This device can likewise be utilized as a vessel for directing medicine gradually.
                    </p>
                </Stack>
