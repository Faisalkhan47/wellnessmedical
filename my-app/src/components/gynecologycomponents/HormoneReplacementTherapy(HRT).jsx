            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Hormone Replacement Therapy (HRT)</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Hormone replacement therapy (HRT) is a type of treatment that involves taking hormones to prevent or treat certain medical conditions. The common uses for HRT incorporate treating menopause in females and forestalling osteoporosis. The hormones utilized in HRT have synthetic hormones. This implies they are created in a laboratory. When these hormones are inside the body, they behave like natural hormones. HRT could assist with forestalling osteoporosis, heart disease, and cancer.
                    </p>
                </Stack>
