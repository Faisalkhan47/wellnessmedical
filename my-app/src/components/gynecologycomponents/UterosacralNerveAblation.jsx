...
export default function UterosacralNerveAblation() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Uterosacral Nerve Ablation</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Uterosacral Nerve Ablation is a pain in the area below your belly button and between your hips that lasts six months or longer. Uterosacral nerve removal can have numerous causes. It tends to be an indication of another sickness, or it very well may be a condition by its own doing.
                    </p>
                </Stack>
