...
export default function Vaginalhysterectomy() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Vaginal Hysterectomy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A vaginal hysterectomy is a surgery to eliminate the uterus through the vagina. During a vaginal hysterectomy, the specialist confines the uterus from the ovaries, fallopian cylinders, and upper vagina, just as from the blood vessels and connective tissue that help it, prior to eliminating the uterus. Vaginal hysterectomy includes a more limited time in the medical hospital, lower cost, and quicker recuperation than an abdominal hysterectomy, which requires an incision in your lower abdomen.
                    </p>
                </Stack>
