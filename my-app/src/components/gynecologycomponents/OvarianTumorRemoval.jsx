...
export default function OvarianTumorRemoval() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Ovarian Tumor Removal</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Ovarian tumor is a type of cancer that begins in the ovaries. The female reproductive system contains two ovaries, one on each side of the uterus. The ovaries each about the size of an almond produce eggs (ova) just as the hormones estrogen and progesterone.
                    </p>
                </Stack>
