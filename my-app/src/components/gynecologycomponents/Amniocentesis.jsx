            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Amniocentesis</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    An amniocentesis is a method used to get a small sample of the amniotic liquid that encompasses the fetus to analyze chromosomal disorders and open neural tube defects like spina bifida. Testing is accessible for other genetic defects and disorders relying upon the family ancestry and accessibility of research center testing at the hour of the technique. Those who have had an unusual maternal serum screening test, showing an expanded danger for a chromosomal anomaly or neural tube defect.
                    </p>
                </Stack>
