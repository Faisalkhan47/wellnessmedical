...
export default function UrodynamicEvaluation() {
    return (
        <>
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Urodynamic Evaluation</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    Urodynamic evaluation tests are utilized to analyze patients who have urinary incontinence or other lower urinary tract manifestations. These tests are given to all kinds of people.
                    </p>
                </Stack>
