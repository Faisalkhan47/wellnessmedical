            ...
            <Stack >
                <Stack sx={{ marginTop: '14rem', color: 'rgb(20, 154, 137)', position: 'relative', backgroundColor: "rgb(231, 252, 255)" }}>
                    <img
                        ...
                        srcSet=""
                    />
                    <h2 style={{ marginLeft: '3rem', fontWeight: 'bold', marginTop: '2rem' }}>Breast Biopsy</h2>
                    <p style={{ width: '45rem', marginLeft: '3rem', textAlign: 'start', marginTop: '1rem' }}>
                    A breast biopsy is a procedure to remove a small sample of breast tissue for laboratory testing. A breast biopsy is a way to evaluate a suspicious area in your breast to determine whether it is breast cancer. There are a few kinds of breast biopsy procedures.
                    </p>
                </Stack>
